...
;GCODE.c,327 :: 		return status_code;
LH	R2, Offset(-1610602986)(GP)
J	L_end_Check_group_multiple_violations
NOP	
;GCODE.c,328 :: 		}
L_Check_group_multiple_violations100:
;GCODE.c,335 :: 		if(group_number == MODAL_GROUP_1){
LH	R3, Offset(-1610602988)(GP)
ORI	R2, R0, 2
...
;GCODE.c,337 :: 		switch (motion_mode) {
J	L_Check_group_multiple_violations103
NOP	
;GCODE.c,338 :: 		case MOTION_MODE_SEEK:
L_Check_group_multiple_violations105:
;GCODE.c,339 :: 		gc.frequency = lround(settings.default_seek_rate);
...
NOP	
;GCODE.c,343 :: 		case MOTION_MODE_CW_ARC: case MOTION_MODE_CCW_ARC:
L_Check_group_multiple_violations107:
L_Check_group_multiple_violations108:
;GCODE.c,344 :: 		FAIL(STATUS_OK);
MOVZ	R25, R0, R0
JAL	_FAIL+0
NOP	
;GCODE.c,349 :: 		for(i=0;i<=3;i++)
...
J	L_Check_group_multiple_violations104
NOP	
;GCODE.c,365 :: 		case MOTION_MODE_CANCEL:
L_Check_group_multiple_violations112:
;GCODE.c,366 :: 		FAIL(STATUS_OK);
MOVZ	R25, R0, R0
JAL	_FAIL+0
NOP	
;GCODE.c,368 :: 		if (axis_words) { FAIL(STATUS_INVALID_STATEMENT); }
LH	R2, Offset(-1610603006)(GP)
...
JAL	_FAIL+0
NOP	
;GCODE.c,382 :: 		if(axis_xyz > NO_OF_PLANES){
...
;GCODE.c,383 :: 		status_code = STATUS_INVALID_STATEMENT;
ORI	R2, R0, 6
SH	R2, Offset(-1610602986)(GP)
;GCODE.c,384 :: 		FAIL(STATUS_INVALID_STATEMENT);
ORI	R25, R0, 6
JAL	_FAIL+0
NOP	
;GCODE.c,385 :: 		}
L_Check_group_multiple_violations118:
;GCODE.c,387 :: 		return status_code;
LH	R2, Offset(-1610602986)(GP)
J	L_end_Check_group_multiple_violations
NOP	
;GCODE.c,388 :: 		}
L_Check_group_multiple_violations117:
;GCODE.c,391 :: 		if (group_number == MODAL_GROUP_3){
LH	R3, Offset(-1610602988)(GP)
ORI	R2, R0, 4
...
;GCODE.c,392 :: 		FAIL(STATUS_OK);
MOVZ	R25, R0, R0
JAL	_FAIL+0
NOP	
;GCODE.c,393 :: 		return status_code;
LH	R2, Offset(-1610602986)(GP)
J	L_end_Check_group_multiple_violations
NOP	
;GCODE.c,394 :: 		}
L_Check_group_multiple_violations119:
;GCODE.c,397 :: 		if (group_number == MODAL_GROUP_5){
LH	R3, Offset(-1610602988)(GP)
ORI	R2, R0, 6
...
;GCODE.c,398 :: 		FAIL(STATUS_OK);
MOVZ	R25, R0, R0
JAL	_FAIL+0
NOP	
;GCODE.c,399 :: 		return status_code;
LH	R2, Offset(-1610602986)(GP)
J	L_end_Check_group_multiple_violations
NOP	
;GCODE.c,400 :: 		}
L_Check_group_multiple_violations120:
;GCODE.c,403 :: 		if (group_number == MODAL_GROUP_6){
LH	R3, Offset(-1610602988)(GP)
ORI	R2, R0, 7
...
;GCODE.c,409 :: 		if (group_number == MODAL_GROUP_12){
LH	R3, Offset(-1610602988)(GP)
ORI	R2, R0, 9
...
;GCODE.c,410 :: 		FAIL(STATUS_OK);
MOVZ	R25, R0, R0
JAL	_FAIL+0
NOP	
;GCODE.c,412 :: 		if(gc.coord_select < 0 || gc.coord_select > 7)
...
;GCODE.c,413 :: 		FAIL(STATUS_BAD_NUMBER_FORMAT);
ORI	R25, R0, 1
JAL	_FAIL+0
NOP	
L_Check_group_multiple_violations125:
;GCODE.c,415 :: 		return status_code;
LH	R2, Offset(-1610602986)(GP)
J	L_end_Check_group_multiple_violations
NOP	
;GCODE.c,416 :: 		}
...
_Instruction_Values:
;GCODE.c,428 :: 		int Instruction_Values(char *c,void *any){
ADDIU	SP, SP, -12
SW	RA, 0(SP)
;GCODE.c,432 :: 		switch(c[0]){
SW	R25, 4(SP)
MOVZ	R2, R25, R0
SW	R2, 8(SP)
J	L_Instruction_Values126
NOP	
;GCODE.c,433 :: 		case 'X':case 'x':
L_Instruction_Values128:
L_Instruction_Values129:
;GCODE.c,435 :: 		gc.next_position[X] = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+76)(GP)
;GCODE.c,436 :: 		bit_true(axis_words,bit(X));
LH	R2, Offset(-1610603006)(GP)
ORI	R2, R2, 1
SH	R2, Offset(-1610603006)(GP)
;GCODE.c,441 :: 		break;
...
;GCODE.c,444 :: 		gc.next_position[Y] = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+80)(GP)
;GCODE.c,445 :: 		bit_true(axis_words,bit(Y));
LH	R2, Offset(-1610603006)(GP)
ORI	R2, R2, 2
SH	R2, Offset(-1610603006)(GP)
;GCODE.c,446 :: 		break;
...
;GCODE.c,449 :: 		gc.next_position[Z] = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+84)(GP)
;GCODE.c,450 :: 		bit_true(axis_words,bit(Z));
LH	R2, Offset(-1610603006)(GP)
ORI	R2, R2, 4
SH	R2, Offset(-1610603006)(GP)
;GCODE.c,451 :: 		break;
...
;GCODE.c,454 :: 		gc.next_position[A] = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+88)(GP)
;GCODE.c,455 :: 		bit_true(axis_words,bit(A));
LH	R2, Offset(-1610603006)(GP)
ORI	R2, R2, 8
SH	R2, Offset(-1610603006)(GP)
;GCODE.c,456 :: 		break;
...
;GCODE.c,459 :: 		gc.next_position[B] = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+92)(GP)
;GCODE.c,460 :: 		bit_true(axis_words,bit(B));
LH	R2, Offset(-1610603006)(GP)
ORI	R2, R2, 16
SH	R2, Offset(-1610603006)(GP)
;GCODE.c,461 :: 		break;
...
;GCODE.c,464 :: 		gc.R = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
...
;GCODE.c,469 :: 		XYZ_Val = *(float*)any;
LWC1	S0, 0(R26)
;GCODE.c,470 :: 		gc.I = XYZ_Val;
SWC1	S0, Offset(_gc+108)(GP)
;GCODE.c,471 :: 		gc.offset[I] = To_Millimeters(XYZ_Val);
MOV.S 	S12, S0
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+92)(GP)
...
LWC1	S0, 0(R26)
;GCODE.c,475 :: 		gc.J = XYZ_Val;
SWC1	S0, Offset(_gc+112)(GP)
;GCODE.c,476 :: 		gc.offset[J] = To_Millimeters(XYZ_Val);
MOV.S 	S12, S0
JAL	GCODE_To_Millimeters+0
NOP	
...
LWC1	S0, 0(R26)
;GCODE.c,480 :: 		gc.K = XYZ_Val;
SWC1	S0, Offset(_gc+116)(GP)
;GCODE.c,481 :: 		gc.offset[K] = To_Millimeters(XYZ_Val);
MOV.S 	S12, S0
JAL	GCODE_To_Millimeters+0
NOP	
...
;GCODE.c,486 :: 		FAIL(STATUS_SPEED_ERROR);
ORI	R25, R0, 13
JAL	_FAIL+0
NOP	
;GCODE.c,487 :: 		}
L_Instruction_Values139:
;GCODE.c,489 :: 		if (gc.inverse_feed_rate_mode) {
LBU	R2, Offset(_gc+2)(GP)
...
;GCODE.c,490 :: 		inverse_feed_rate = To_Millimeters(XYZ_Val); // seconds per motion for this motion only
MOV.S 	S12, S2
JAL	GCODE_To_Millimeters+0
NOP	
...
;GCODE.c,492 :: 		gc.feed_rate = To_Millimeters(XYZ_Val); // millimeters per minute
MOV.S 	S12, S2
JAL	GCODE_To_Millimeters+0
NOP	
...
;GCODE.c,494 :: 		gc.frequency = (unsigned long)XYZ_Val;
MOV.S 	S0, S2
