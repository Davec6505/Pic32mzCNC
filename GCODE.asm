...
;GCODE.c,335 :: 		void gc_set_current_position(unsigned long x, unsigned long y, unsigned long z){
ADDIU	SP, SP, -36
SW	RA, 0(SP)
;GCODE.c,338 :: 		for(i=0;i<3;i++){
; i start address is: 20 (R5)
MOVZ	R5, R0, R0
; i end address is: 20 (R5)
...
;GCODE.c,339 :: 		temp[i] = ulong2flt(settings.steps_per_mm[i]);
ADDIU	R4, SP, 20
SEH	R2, R5
SLL	R3, R2, 2
ADDU	R2, R4, R3
...
;GCODE.c,341 :: 		gc.position[X] = x/temp[X];
ADDIU	R3, SP, 20
MTC1	R25, S0
MTHC1	R0, S0
CVT32.L 	S1, S0
...
;GCODE.c,342 :: 		gc.position[Y] = y/temp[Y];
ADDIU	R2, R3, 4
MTC1	R26, S0
MTHC1	R0, S0
CVT32.L 	S1, S0
...
;GCODE.c,343 :: 		gc.position[Z] = z/temp[Z];
ADDIU	R2, R3, 8
MTC1	R27, S0
MTHC1	R0, S0
CVT32.L 	S1, S0
...
;GCODE.c,349 :: 		static float To_Millimeters(float value){
;GCODE.c,350 :: 		return(gc.inches_mode) ? (value * MM_PER_INCH) : value;
...
GCODE_Select_Plane:
;GCODE.c,354 :: 		static void Select_Plane(int axis_combo){
;GCODE.c,355 :: 		axis_xyz = axis_combo;
...
;GCODE.c,359 :: 		static int Set_Modal_Groups(int mode){
ADDIU	SP, SP, -4
;GCODE.c,361 :: 		switch(mode) {
J	L_GCODE_Set_Modal_Groups65
NOP	
;GCODE.c,362 :: 		case 4: case 10: case 280:case 281: case 300:case 301: case 53: case 92:
...
;GCODE.c,363 :: 		gp_num = MODAL_GROUP_0; break;
ORI	R2, R0, 1
SH	R2, 0(SP)
J	L_GCODE_Set_Modal_Groups66
NOP	
;GCODE.c,364 :: 		case 0: case 1: case 2: case 3: case 80: gp_num = MODAL_GROUP_1; break;
...
J	L_GCODE_Set_Modal_Groups66
NOP	
;GCODE.c,365 :: 		case 17: case 18: case 19: gp_num = MODAL_GROUP_2; break;
...
J	L_GCODE_Set_Modal_Groups66
NOP	
;GCODE.c,366 :: 		case 90: case 91: gp_num = MODAL_GROUP_3; break;
...
J	L_GCODE_Set_Modal_Groups66
NOP	
;GCODE.c,367 :: 		case 93: case 94: gp_num = MODAL_GROUP_5; break;
...
J	L_GCODE_Set_Modal_Groups66
NOP	
;GCODE.c,368 :: 		case 20: case 21: gp_num = MODAL_GROUP_6; break;
...
J	L_GCODE_Set_Modal_Groups66
NOP	
;GCODE.c,369 :: 		case 54: case 55: case 56: case 57: case 58: case 59: gp_num = MODAL_GROUP_12; break;
...
;GCODE.c,375 :: 		static int Set_Motion_Mode(int mode){
ADDIU	SP, SP, -36
SW	RA, 0(SP)
;GCODE.c,377 :: 		switch(mode){
SW	R25, 4(SP)
J	L_GCODE_Set_Motion_Mode95
NOP	
;GCODE.c,378 :: 		case 0: motion_mode    = MOTION_MODE_SEEK;    break;
L_GCODE_Set_Motion_Mode97:
SH	R0, Offset(GCODE_motion_mode+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,379 :: 		case 1: motion_mode    = MOTION_MODE_LINEAR;  break;
L_GCODE_Set_Motion_Mode98:
ORI	R2, R0, 1
SH	R2, Offset(GCODE_motion_mode+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,380 :: 		case 2: motion_mode    = MOTION_MODE_CW_ARC;  break;
L_GCODE_Set_Motion_Mode99:
ORI	R2, R0, 2
SH	R2, Offset(GCODE_motion_mode+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,381 :: 		case 3: motion_mode    = MOTION_MODE_CCW_ARC; break;
L_GCODE_Set_Motion_Mode100:
ORI	R2, R0, 3
SH	R2, Offset(GCODE_motion_mode+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,382 :: 		case 4: non_modal_action  = NON_MODAL_DWELL;     break;
L_GCODE_Set_Motion_Mode101:
ORI	R2, R0, 1
SH	R2, Offset(_non_modal_action+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,383 :: 		case 10: non_modal_action = NON_MODAL_SET_COORDINATE_DATA; break;
L_GCODE_Set_Motion_Mode102:
ORI	R2, R0, 2
SH	R2, Offset(_non_modal_action+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,384 :: 		case 17: Select_Plane(xy); break;
...
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,385 :: 		case 18: Select_Plane(xz); break;
...
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,386 :: 		case 19: Select_Plane(yz); break;
...
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,387 :: 		case 20: gc.inches_mode = 1; break;
L_GCODE_Set_Motion_Mode106:
ORI	R2, R0, 1
SB	R2, Offset(_gc+2)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,388 :: 		case 21: gc.inches_mode = 0; break;
L_GCODE_Set_Motion_Mode107:
SB	R0, Offset(_gc+2)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,389 :: 		case 53: absolute_override = true; break;
L_GCODE_Set_Motion_Mode108:
ORI	R2, R0, 1
SB	R2, Offset(GCODE_absolute_override+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,390 :: 		case 54: case 55: case 56: case 57: case 58: case 59:
...
;GCODE.c,391 :: 		gc.coord_select = (mode - 54)+1;//int_value-54;
ADDIU	R2, R25, -54
ADDIU	R2, R2, 1
...
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,393 :: 		case 80: motion_mode = MOTION_MODE_CANCEL; break;
L_GCODE_Set_Motion_Mode115:
ORI	R2, R0, 4
SH	R2, Offset(GCODE_motion_mode+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,394 :: 		case 90: gc.absolute_mode = true; break;
L_GCODE_Set_Motion_Mode116:
ORI	R2, R0, 1
SB	R2, Offset(_gc+3)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,395 :: 		case 91: gc.absolute_mode = false; break;
L_GCODE_Set_Motion_Mode117:
SB	R0, Offset(_gc+3)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,396 :: 		case 93: gc.inverse_feed_rate_mode = true; break;
L_GCODE_Set_Motion_Mode118:
ORI	R2, R0, 1
SB	R2, Offset(_gc+1)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,397 :: 		case 94: gc.inverse_feed_rate_mode = false; break;
L_GCODE_Set_Motion_Mode119:
SB	R0, Offset(_gc+1)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,398 :: 		case 280: non_modal_action = NON_MODAL_GO_HOME_0; break;
L_GCODE_Set_Motion_Mode120:
ORI	R2, R0, 3
SH	R2, Offset(_non_modal_action+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,399 :: 		case 281: non_modal_action = NON_MODAL_SET_HOME_0; break;
L_GCODE_Set_Motion_Mode121:
ORI	R2, R0, 4
SH	R2, Offset(_non_modal_action+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,400 :: 		case 300: non_modal_action = NON_MODAL_GO_HOME_1; break;
L_GCODE_Set_Motion_Mode122:
ORI	R2, R0, 5
SH	R2, Offset(_non_modal_action+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,401 :: 		case 301: non_modal_action = NON_MODAL_SET_HOME_1; break;
L_GCODE_Set_Motion_Mode123:
ORI	R2, R0, 6
SH	R2, Offset(_non_modal_action+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,402 :: 		case 920: non_modal_action = NON_MODAL_SET_COORDINATE_OFFSET; break;
L_GCODE_Set_Motion_Mode124:
ORI	R2, R0, 7
SH	R2, Offset(_non_modal_action+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,403 :: 		case 921: non_modal_action = NON_MODAL_RESET_COORDINATE_OFFSET; break;
L_GCODE_Set_Motion_Mode125:
ORI	R2, R0, 8
SH	R2, Offset(_non_modal_action+0)(GP)
J	L_GCODE_Set_Motion_Mode96
NOP	
;GCODE.c,404 :: 		default: FAIL(STATUS_UNSUPPORTED_STATEMENT);break;
...
;GCODE.c,406 :: 		FAIL(STATUS_OK);
SH	R0, Offset(GCODE_status_code+0)(GP)
;GCODE.c,411 :: 		if ( bit_istrue(modal_group_words,bit(MODAL_GROUP_1)) || axis_words ) {
LH	R2, Offset(GCODE_modal_group_words+0)(GP)
ANDI	R2, R2, 4
SEH	R2, R2
...
;GCODE.c,413 :: 		if ( gc.inverse_feed_rate_mode ) {
...
;GCODE.c,414 :: 		if (inverse_feed_rate < 0 && motion_mode != MOTION_MODE_CANCEL) {
...
;GCODE.c,415 :: 		FAIL(STATUS_INVALID_STATEMENT);
ORI	R2, R0, 6
SH	R2, Offset(GCODE_status_code+0)(GP)
;GCODE.c,414 :: 		if (inverse_feed_rate < 0 && motion_mode != MOTION_MODE_CANCEL) {
...
;GCODE.c,419 :: 		if ( absolute_override && !(motion_mode == MOTION_MODE_SEEK || motion_mode == MOTION_MODE_LINEAR)) {
LBU	R2, Offset(GCODE_absolute_override+0)(GP)
...
;GCODE.c,420 :: 		FAIL(STATUS_INVALID_STATEMENT);
ORI	R2, R0, 6
SH	R2, Offset(GCODE_status_code+0)(GP)
;GCODE.c,419 :: 		if ( absolute_override && !(motion_mode == MOTION_MODE_SEEK || motion_mode == MOTION_MODE_LINEAR)) {
L_GCODE_Set_Motion_Mode171:
L_GCODE_Set_Motion_Mode170:
;GCODE.c,423 :: 		if (status_code) { return(status_code); }
LH	R2, Offset(GCODE_status_code+0)(GP)
...
;GCODE.c,428 :: 		dma_printf("non_modal_action:= %d\n",non_modal_action);
ADDIU	R23, SP, 10
ADDIU	R22, R23, 23
...
ADDIU	SP, SP, 8
LH	R25, 8(SP)
;GCODE.c,430 :: 		return motion_mode;
LH	R2, Offset(GCODE_motion_mode+0)(GP)
;GCODE.c,431 :: 		}
;GCODE.c,430 :: 		return motion_mode;
;GCODE.c,431 :: 		}
...
;GCODE.c,433 :: 		static void Set_M_Modal_Commands(int flow){
;GCODE.c,435 :: 		switch(flow) {
J	L_GCODE_Set_M_Modal_Commands142
NOP	
;GCODE.c,436 :: 		case 0: case 1: case 2: case 30: group_number = MODAL_GROUP_4; break;
...
NOP	
;GCODE.c,437 :: 		case 3: case 4: case 5: group_number = MODAL_GROUP_7; break;
...
;GCODE.c,442 :: 		static int Set_M_Commands(int flow){
;GCODE.c,444 :: 		switch(flow) {
J	L_GCODE_Set_M_Commands151
NOP	
;GCODE.c,445 :: 		case 0: gc.program_flow = PROGRAM_FLOW_PAUSED; break; // Program pause
L_GCODE_Set_M_Commands153:
ORI	R2, R0, 1
SB	R2, Offset(_gc+4)(GP)
J	L_GCODE_Set_M_Commands152
NOP	
;GCODE.c,446 :: 		case 1: break; // Optional stop not supported. Ignore.
L_GCODE_Set_M_Commands154:
J	L_GCODE_Set_M_Commands152
NOP	
;GCODE.c,447 :: 		case 2:
L_GCODE_Set_M_Commands155:
;GCODE.c,448 :: 		case 30: gc.program_flow = PROGRAM_FLOW_COMPLETED; break; // Program end and reset
L_GCODE_Set_M_Commands156:
ORI	R2, R0, 2
SB	R2, Offset(_gc+4)(GP)
J	L_GCODE_Set_M_Commands152
NOP	
;GCODE.c,449 :: 		case 3: gc.spindle_direction = 1; break;
L_GCODE_Set_M_Commands157:
ORI	R2, R0, 1
SB	R2, Offset(_gc+5)(GP)
J	L_GCODE_Set_M_Commands152
NOP	
;GCODE.c,450 :: 		case 4: gc.spindle_direction = -1; break;
L_GCODE_Set_M_Commands158:
ORI	R2, R0, 255
SB	R2, Offset(_gc+5)(GP)
J	L_GCODE_Set_M_Commands152
NOP	
;GCODE.c,451 :: 		case 5: gc.spindle_direction = 0; break;
L_GCODE_Set_M_Commands159:
SB	R0, Offset(_gc+5)(GP)
J	L_GCODE_Set_M_Commands152
NOP	
;GCODE.c,455 :: 		case 8: gc.coolant_mode = COOLANT_FLOOD_ENABLE; break;
L_GCODE_Set_M_Commands160:
ORI	R2, R0, 1
SB	R2, Offset(_gc+6)(GP)
J	L_GCODE_Set_M_Commands152
NOP	
;GCODE.c,456 :: 		case 9: gc.coolant_mode = COOLANT_DISABLE; break;
L_GCODE_Set_M_Commands161:
SB	R0, Offset(_gc+6)(GP)
J	L_GCODE_Set_M_Commands152
NOP	
;GCODE.c,457 :: 		default: FAIL(STATUS_UNSUPPORTED_STATEMENT);break;
...
;GCODE.c,459 :: 		return status_code;
LH	R2, Offset(GCODE_status_code+0)(GP)
;GCODE.c,460 :: 		}
