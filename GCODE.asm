...
; end of _G_Mode
_M_Mode:
;GCODE.c,153 :: 		int M_Mode(int flow){
ADDIU	SP, SP, -20
SW	RA, 0(SP)
...
NOP	
;GCODE.c,251 :: 		case 0: case 1: case 2: case 30: gp_num = MODAL_GROUP_4; break;
...
NOP	
;GCODE.c,252 :: 		case 3: case 4: case 5: gp_num = MODAL_GROUP_7; break;
...
;GCODE.c,276 :: 		return status_code;
...
;GCODE.c,538 :: 		inverse_feed_rate = To_Millimeters(F_Val); // seconds per motion for this motion only
LH	R2, 16(SP)
MTC1	R2, S0
CVT32.W 	S0, S0
MOV.S 	S12, S0
...
;GCODE.c,540 :: 		gc.feed_rate = To_Millimeters(F_Val); // millimeters per minute
LH	R2, 16(SP)
MTC1	R2, S0
CVT32.W 	S0, S0
MOV.S 	S12, S0
...
;GCODE.c,545 :: 		dma_printf("gc.frequency:= %l\n",gc.frequency);
ADDIU	R23, SP, 20
ADDIU	R22, R23, 19
...
;GCODE.c,575 :: 		if(c[0] == 'X' || c[0] == 'Y' || c[0] == 'Z' || c[0] == 'R' || c[0] == 'I' || c[0] == 'J')
LBU	R2, 0(R25)
ANDI	R3, R2, 255
ORI	R2, R0, 88
...
;GCODE.c,579 :: 		else if(c[0] == 'S' ||  c[0] == 'P' || c[0] == 'L')
LBU	R2, 0(R25)
ANDI	R3, R2, 255
ORI	R2, R0, 83
