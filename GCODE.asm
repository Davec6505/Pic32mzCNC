...
;GCODE.c,199 :: 		[modal_group_words:= %d]\n[non_modal_action:= %d]\r\n"
ADDIU	R23, SP, 10
ADDIU	R22, R23, 115
...
NOP	
ADDIU	R3, SP, 10
;GCODE.c,201 :: 		,motion_mode,non_modal_action);
...
LH	R2, Offset(GCODE_motion_mode+0)(GP)
SH	R2, 12(SP)
;GCODE.c,200 :: 		,status_code,modal_group_words
LH	R2, Offset(GCODE_modal_group_words+0)(GP)
SH	R2, 8(SP)
...
;GCODE.c,209 :: 		static int Set_M_Modal_Commands(int flow){
ADDIU	SP, SP, -4
;GCODE.c,212 :: 		switch(flow) {
J	L_GCODE_Set_M_Modal_Commands78
NOP	
;GCODE.c,213 :: 		case 0: case 1: case 2: case 30: gp_num = MODAL_GROUP_4; break;
...
NOP	
;GCODE.c,214 :: 		case 3: case 4: case 5: gp_num = MODAL_GROUP_7; break;
...
;GCODE.c,220 :: 		static int Set_M_Commands(int flow){
;GCODE.c,221 :: 		FAIL(STATUS_OK);
SH	R0, Offset(_status_code+0)(GP)
;GCODE.c,223 :: 		switch(flow) {
J	L_GCODE_Set_M_Commands87
NOP	
;GCODE.c,224 :: 		case 0: gc.program_flow = PROGRAM_FLOW_PAUSED; break; // Program pause
L_GCODE_Set_M_Commands89:
ORI	R2, R0, 1
SB	R2, Offset(_gc+9)(GP)
J	L_GCODE_Set_M_Commands88
NOP	
;GCODE.c,225 :: 		case 1: break; // Optional stop not supported. Ignore.
L_GCODE_Set_M_Commands90:
J	L_GCODE_Set_M_Commands88
NOP	
;GCODE.c,226 :: 		case 2:
L_GCODE_Set_M_Commands91:
;GCODE.c,227 :: 		case 30: gc.program_flow = PROGRAM_FLOW_COMPLETED; break; // Program end and reset
L_GCODE_Set_M_Commands92:
ORI	R2, R0, 2
SB	R2, Offset(_gc+9)(GP)
J	L_GCODE_Set_M_Commands88
NOP	
;GCODE.c,228 :: 		case 3: gc.spindle_direction = 1; break;
L_GCODE_Set_M_Commands93:
ORI	R2, R0, 1
SB	R2, Offset(_gc+6)(GP)
J	L_GCODE_Set_M_Commands88
NOP	
;GCODE.c,229 :: 		case 4: gc.spindle_direction = -1; break;
L_GCODE_Set_M_Commands94:
ORI	R2, R0, 255
SB	R2, Offset(_gc+6)(GP)
J	L_GCODE_Set_M_Commands88
NOP	
;GCODE.c,230 :: 		case 5: gc.spindle_direction = 0; break;
L_GCODE_Set_M_Commands95:
SB	R0, Offset(_gc+6)(GP)
J	L_GCODE_Set_M_Commands88
NOP	
;GCODE.c,234 :: 		case 8: gc.coolant_mode = COOLANT_FLOOD_ENABLE; break;
L_GCODE_Set_M_Commands96:
ORI	R2, R0, 1
SB	R2, Offset(_gc+7)(GP)
J	L_GCODE_Set_M_Commands88
NOP	
;GCODE.c,235 :: 		case 9: gc.coolant_mode = COOLANT_DISABLE; break;
L_GCODE_Set_M_Commands97:
SB	R0, Offset(_gc+7)(GP)
J	L_GCODE_Set_M_Commands88
NOP	
;GCODE.c,236 :: 		default: FAIL(STATUS_UNSUPPORTED_STATEMENT);break;
...
;GCODE.c,238 :: 		return status_code;
LH	R2, Offset(_status_code+0)(GP)
;GCODE.c,239 :: 		}
...
;GCODE.c,247 :: 		int Check_group_multiple_violations(){
ADDIU	SP, SP, -28
SW	RA, 0(SP)
;GCODE.c,249 :: 		int i = 0;
SW	R25, 4(SP)
;GCODE.c,254 :: 		if(group_number > 0) {
...
;GCODE.c,256 :: 		if(group_number == MODAL_GROUP_NONE)
LH	R2, Offset(_group_number+0)(GP)
...
;GCODE.c,257 :: 		FAIL(STATUS_MODAL_GROUP_VIOLATION);
ORI	R2, R0, 5
SH	R2, Offset(_status_code+0)(GP)
...
;GCODE.c,299 :: 		if (axis_words) { FAIL(STATUS_INVALID_STATEMENT); } // No axis words allowed while active.
LBU	R2, Offset(GCODE_axis_words+0)(GP)
...
NOP	
;GCODE.c,301 :: 		case MOTION_MODE_SEEK:
L_Check_group_multiple_violations109:
;GCODE.c,302 :: 		if (axis_words == 0) {
LBU	R2, Offset(GCODE_axis_words+0)(GP)
...
;GCODE.c,303 :: 		FAIL(STATUS_INVALID_STATEMENT);
ORI	R2, R0, 6
SH	R2, Offset(_status_code+0)(GP)
;GCODE.c,304 :: 		}else {
...
;GCODE.c,307 :: 		gc.frequency = 5000;//settings.default_seek_rate;
ORI	R2, R0, 5000
SH	R2, Offset(_gc+16)(GP)
;GCODE.c,308 :: 		FAIL(STATUS_OK);
SH	R0, Offset(_status_code+0)(GP)
;GCODE.c,309 :: 		}
...
J	L_Check_group_multiple_violations106
NOP	
;GCODE.c,311 :: 		case MOTION_MODE_LINEAR:
...
;GCODE.c,318 :: 		dma_printf("axis_words:= %d\n",(int)axis_words & 0x00FF);
LBU	R2, Offset(GCODE_axis_words+0)(GP)
ANDI	R3, R2, 255
ADDIU	R23, SP, 8
ADDIU	R22, R23, 17
...
;GCODE.c,321 :: 		FAIL(STATUS_INVALID_STATEMENT);
ORI	R2, R0, 6
SH	R2, Offset(_status_code+0)(GP)
;GCODE.c,322 :: 		}else {
...
J	L_Check_group_multiple_violations106
NOP	
;GCODE.c,327 :: 		case MOTION_MODE_CW_ARC: case MOTION_MODE_CCW_ARC:
L_Check_group_multiple_violations117:
L_Check_group_multiple_violations118:
;GCODE.c,330 :: 		if ( !( bit_false(axis_words,bit(gc.plane_axis_2)) ) ||
...
;GCODE.c,331 :: 		( !gc.r && gc.offset[gc.plane_axis_0] == 0.0 && gc.offset[gc.plane_axis_1] == 0.0 )){
LBU	R2, Offset(GCODE_axis_words+0)(GP)
...
;GCODE.c,342 :: 		for(i=0;i<NoOfAxis;i++){
...
;GCODE.c,343 :: 		gc.position[i] =  gc.next_position[i];
SEH	R2, R5
SLL	R4, R2, 2
...
;GCODE.c,348 :: 		if (group_number == MODAL_GROUP_2){
LH	R3, Offset(_group_number+0)(GP)
ORI	R2, R0, 3
...
;GCODE.c,350 :: 		if(axis_xyz > NO_OF_PLANES)
...
;GCODE.c,351 :: 		status_code = STATUS_INVALID_STATEMENT;
ORI	R2, R0, 6
SH	R2, Offset(_status_code+0)(GP)
J	L_Check_group_multiple_violations131
NOP	
L_Check_group_multiple_violations130:
;GCODE.c,352 :: 		else status_code = STATUS_OK;
SH	R0, Offset(_status_code+0)(GP)
L_Check_group_multiple_violations131:
;GCODE.c,360 :: 		return status_code;
LH	R2, Offset(_status_code+0)(GP)
J	L_end_Check_group_multiple_violations
NOP	
;GCODE.c,361 :: 		}
L_Check_group_multiple_violations129:
;GCODE.c,364 :: 		if (group_number == MODAL_GROUP_3){
LH	R3, Offset(_group_number+0)(GP)
ORI	R2, R0, 4
...
;GCODE.c,372 :: 		return status_code;
LH	R2, Offset(_status_code+0)(GP)
J	L_end_Check_group_multiple_violations
NOP	
;GCODE.c,373 :: 		}
L_Check_group_multiple_violations132:
;GCODE.c,376 :: 		if (group_number == MODAL_GROUP_5){
LH	R3, Offset(_group_number+0)(GP)
ORI	R2, R0, 6
...
;GCODE.c,384 :: 		return status_code;
LH	R2, Offset(_status_code+0)(GP)
J	L_end_Check_group_multiple_violations
NOP	
;GCODE.c,385 :: 		}
L_Check_group_multiple_violations133:
;GCODE.c,388 :: 		if (group_number == MODAL_GROUP_6){
LH	R3, Offset(_group_number+0)(GP)
ORI	R2, R0, 7
...
;GCODE.c,396 :: 		return status_code;
LH	R2, Offset(_status_code+0)(GP)
J	L_end_Check_group_multiple_violations
NOP	
;GCODE.c,397 :: 		}
L_Check_group_multiple_violations134:
;GCODE.c,400 :: 		if (group_number == MODAL_GROUP_12){
LH	R3, Offset(_group_number+0)(GP)
ORI	R2, R0, 9
...
;GCODE.c,402 :: 		if(gc.coord_select < 0|| gc.coord_select > 7)
...
;GCODE.c,403 :: 		status_code = STATUS_BAD_NUMBER_FORMAT;
ORI	R2, R0, 1
SH	R2, Offset(_status_code+0)(GP)
J	L_Check_group_multiple_violations139
NOP	
L_Check_group_multiple_violations138:
;GCODE.c,405 :: 		status_code = STATUS_OK;
SH	R0, Offset(_status_code+0)(GP)
...
;GCODE.c,423 :: 		return status_code;
LH	R2, Offset(_status_code+0)(GP)
;GCODE.c,424 :: 		}
;GCODE.c,423 :: 		return status_code;
;GCODE.c,424 :: 		}
...
_Instruction_Values:
;GCODE.c,429 :: 		int Instruction_Values(char *c,void *any){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;GCODE.c,433 :: 		switch(c[0]){
MOVZ	R2, R25, R0
SW	R2, 4(SP)
...
;GCODE.c,436 :: 		gc.next_position[X] = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+72)(GP)
;GCODE.c,437 :: 		bit_true(axis_words,bit(X));
LBU	R2, Offset(GCODE_axis_words+0)(GP)
ORI	R2, R2, 1
SB	R2, Offset(GCODE_axis_words+0)(GP)
;GCODE.c,438 :: 		break;
...
;GCODE.c,441 :: 		gc.next_position[Y] = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+76)(GP)
;GCODE.c,442 :: 		bit_true(axis_words,bit(Y));
LBU	R2, Offset(GCODE_axis_words+0)(GP)
ORI	R2, R2, 2
SB	R2, Offset(GCODE_axis_words+0)(GP)
;GCODE.c,443 :: 		break;
...
;GCODE.c,446 :: 		gc.next_position[Z] = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+80)(GP)
;GCODE.c,447 :: 		bit_true(axis_words,bit(Z));
LBU	R2, Offset(GCODE_axis_words+0)(GP)
ORI	R2, R2, 4
SB	R2, Offset(GCODE_axis_words+0)(GP)
;GCODE.c,448 :: 		break;
...
;GCODE.c,451 :: 		gc.next_position[A] = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+84)(GP)
;GCODE.c,452 :: 		bit_true(axis_words,bit(A));
LBU	R2, Offset(GCODE_axis_words+0)(GP)
ORI	R2, R2, 8
SB	R2, Offset(GCODE_axis_words+0)(GP)
;GCODE.c,453 :: 		break;
...
;GCODE.c,456 :: 		gc.next_position[B] = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+88)(GP)
;GCODE.c,457 :: 		bit_true(axis_words,bit(B));
LBU	R2, Offset(GCODE_axis_words+0)(GP)
ORI	R2, R2, 16
SB	R2, Offset(GCODE_axis_words+0)(GP)
;GCODE.c,458 :: 		break;
...
;GCODE.c,461 :: 		gc.R = To_Millimeters(XYZ_Val);
LWC1	S12, 0(R26)
JAL	GCODE_To_Millimeters+0
NOP	
...
;GCODE.c,466 :: 		XYZ_Val = *(float*)any;
LWC1	S0, 0(R26)
;GCODE.c,467 :: 		gc.I = XYZ_Val;
SWC1	S0, Offset(_gc+104)(GP)
;GCODE.c,468 :: 		gc.offset[I] = To_Millimeters(XYZ_Val);
MOV.S 	S12, S0
JAL	GCODE_To_Millimeters+0
NOP	
SWC1	S0, Offset(_gc+88)(GP)
...
;GCODE.c,471 :: 		XYZ_Val = *(float*)any;
LWC1	S0, 0(R26)
;GCODE.c,472 :: 		gc.J = XYZ_Val;
SWC1	S0, Offset(_gc+108)(GP)
;GCODE.c,473 :: 		gc.offset[J] = To_Millimeters(XYZ_Val);
MOV.S 	S12, S0
JAL	GCODE_To_Millimeters+0
NOP	
...
;GCODE.c,476 :: 		XYZ_Val = *(float*)any;
LWC1	S0, 0(R26)
;GCODE.c,477 :: 		gc.K = XYZ_Val;
SWC1	S0, Offset(_gc+112)(GP)
;GCODE.c,478 :: 		gc.offset[K] = To_Millimeters(XYZ_Val);
MOV.S 	S12, S0
JAL	GCODE_To_Millimeters+0
NOP	
...
;GCODE.c,481 :: 		F_Val = *(int*)any;
LH	R2, 0(R26)
; F_Val start address is: 12 (R3)
SEH	R3, R2
;GCODE.c,482 :: 		if(F_Val < 0){
SEH	R2, R2
SLTI	R2, R2, 0
...
;GCODE.c,483 :: 		FAIL(STATUS_SPEED_ERROR);
ORI	R2, R0, 13
SH	R2, Offset(_status_code+0)(GP)
;GCODE.c,484 :: 		}
L_Instruction_Values152:
;GCODE.c,491 :: 		gc.frequency = F_Val;
...
;GCODE.c,494 :: 		O_Val = *(int*)any;
LH	R2, 0(R26)
; O_Val start address is: 12 (R3)
SEH	R3, R2
;GCODE.c,495 :: 		if(O_Val < 0){
SEH	R2, R2
SLTI	R2, R2, 0
...
;GCODE.c,496 :: 		FAIL(STATUS_SPEED_ERROR);
ORI	R2, R0, 13
SH	R2, Offset(_status_code+0)(GP)
;GCODE.c,497 :: 		}
L_Instruction_Values154:
;GCODE.c,498 :: 		gc.P = O_Val;
...
;GCODE.c,514 :: 		gc.L = O_Val;
SH	R3, Offset(_gc+18)(GP)
; O_Val end address is: 12 (R3)
;GCODE.c,515 :: 		break; //L2 tells the G10 we’re setting standard work offsets
J	L_Instruction_Values141
NOP	
;GCODE.c,516 :: 		default:FAIL(STATUS_UNSUPPORTED_STATEMENT);break;
...
;GCODE.c,527 :: 		return status_code;
LH	R2, Offset(_status_code+0)(GP)
;GCODE.c,528 :: 		}
...
;GCODE.c,534 :: 		void gc_set_current_position(unsigned long x, unsigned long y, unsigned long z){
ADDIU	SP, SP, -36
SW	RA, 0(SP)
;GCODE.c,537 :: 		for(i=0;i<3;i++){
; i start address is: 20 (R5)
MOVZ	R5, R0, R0
; i end address is: 20 (R5)
...
;GCODE.c,538 :: 		temp[i] = ulong2flt(settings.steps_per_mm[i]);
ADDIU	R4, SP, 20
SEH	R2, R5
SLL	R3, R2, 2
ADDU	R2, R4, R3
...
;GCODE.c,540 :: 		gc.position[X] = x/temp[X];
ADDIU	R3, SP, 20
MTC1	R25, S0
MTHC1	R0, S0
CVT32.L 	S1, S0
...
;GCODE.c,541 :: 		gc.position[Y] = y/temp[Y];
ADDIU	R2, R3, 4
MTC1	R26, S0
MTHC1	R0, S0
CVT32.L 	S1, S0
...
;GCODE.c,542 :: 		gc.position[Z] = z/temp[Z];
ADDIU	R2, R3, 8
MTC1	R27, S0
MTHC1	R0, S0
CVT32.L 	S1, S0
