...
ORI	R2, R0, 1
BEQ	R25, R2, L__speed_cntr_Move52
NOP	
...
L_speed_cntr_Move3:
; abs_mmSteps start address is: 28 (R7)
BNE	R25, R0, L__speed_cntr_Move54
NOP	
J	L__speed_cntr_Move46
NOP	
L__speed_cntr_Move54:
ORI	R2, R0, 1
BNE	R7, R2, L__speed_cntr_Move56
NOP	
...
;Planner.c,307 :: 		while(DMA_IsOn(1));
