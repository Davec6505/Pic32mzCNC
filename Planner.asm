...
_speed_cntr_Move:
;Planner.c,61 :: 		void speed_cntr_Move(long mmSteps, float speed, int axis_No){
ADDIU	SP, SP, -212
SW	RA, 0(SP)
...
ORI	R2, R0, 1
BEQ	R25, R2, L__speed_cntr_Move61
NOP	
...
NOP	
L_speed_cntr_Move6:
BNE	R25, R0, L__speed_cntr_Move63
NOP	
J	L__speed_cntr_Move53
NOP	
L__speed_cntr_Move63:
ORI	R2, R0, 1
BNE	R7, R2, L__speed_cntr_Move65
NOP	
...
; temp_speed end address is: 128 (R32)
L_speed_cntr_Move12:
;Planner.c,92 :: 		STPS[axis_No].min_delay =  lround(a_t_x100[axis_No] / temp_speed);
; temp_speed start address is: 128 (R32)
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
...
LW	R3, 208(SP)
SW	R2, 0(R3)
;Planner.c,98 :: 		STPS[axis_No].step_delay = labs((long)T1_FREQ_148 * ((sqrt_(a_sq[axis_No] / STPS[axis_No].acc))/100));
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R3, 208(SP)
SW	R2, 0(R3)
;Planner.c,100 :: 		if(STPS[axis_No].step_delay > minSpeed)
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,101 :: 		STPS[axis_No].StartUp_delay = minSpeed;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
NOP	
L_speed_cntr_Move13:
;Planner.c,103 :: 		STPS[axis_No].StartUp_delay = STPS[axis_No].step_delay ;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
SW	R2, 0(R3)
L_speed_cntr_Move14:
;Planner.c,106 :: 		STPS[axis_No].max_step_lim =(long)(temp_speed*temp_speed)/(2.0*alpha[axis_No]*100.0*(float)STPS[axis_No].acc);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
MFC1	R2, S0
SW	R2, 0(R5)
;Planner.c,113 :: 		if(STPS[axis_No].max_step_lim == 0){
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,114 :: 		STPS[axis_No].max_step_lim = 1;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,115 :: 		}
L_speed_cntr_Move15:
;Planner.c,119 :: 		STPS[axis_No].accel_lim = (abs_mmSteps * STPS[axis_No].dec) / (STPS[axis_No].acc + STPS[axis_No].dec);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
MFLO	R2
SW	R2, 0(R5)
;Planner.c,122 :: 		if(STPS[axis_No].accel_lim == 0){
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,123 :: 		STPS[axis_No].accel_lim = 1;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,124 :: 		}
L_speed_cntr_Move16:
;Planner.c,127 :: 		if(STPS[axis_No].accel_lim < STPS[axis_No].max_step_lim){
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,128 :: 		STPS[axis_No].decel_val = STPS[axis_No].accel_lim - mmSteps;//-(abs_mmSteps - STPS[axis_No].max_step_lim);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
NOP	
L_speed_cntr_Move17:
;Planner.c,130 :: 		STPS[axis_No].decel_val = -((STPS[axis_No].max_step_lim * STPS[axis_No].acc)/STPS[axis_No].dec);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,131 :: 		}
L_speed_cntr_Move18:
;Planner.c,133 :: 		if(STPS[axis_No].decel_val == 0)
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,134 :: 		STPS[axis_No].decel_val = -1;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,138 :: 		STPS[axis_No].decel_start = -(mmSteps - STPS[axis_No].decel_val);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
NOP	
L_speed_cntr_Move20:
;Planner.c,141 :: 		STPS[axis_No].decel_start = mmSteps + STPS[axis_No].decel_val;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,142 :: 		}
L_speed_cntr_Move21:
;Planner.c,146 :: 		if(STPS[axis_No].StartUp_delay <= STPS[axis_No].min_delay){
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,147 :: 		STPS[axis_No].step_delay = labs(STPS[axis_No].min_delay);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R3, 208(SP)
SW	R2, 0(R3)
;Planner.c,148 :: 		STPS[axis_No].run_state = RUN;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
NOP	
L_speed_cntr_Move22:
;Planner.c,150 :: 		STPS[axis_No].step_delay = labs(STPS[axis_No].StartUp_delay);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R3, 208(SP)
SW	R2, 0(R3)
;Planner.c,151 :: 		STPS[axis_No].run_state = ACCEL;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Planner.c,154 :: 		}
L_speed_cntr_Move7:
;Planner.c,156 :: 		STPS[axis_No].step_count  = 0;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 44
SW	R0, 0(R2)
;Planner.c,157 :: 		STPS[axis_No].rest        = 0;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 72
SW	R0, 0(R2)
;Planner.c,158 :: 		STPS[axis_No].accel_count = 1;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ORI	R2, R0, 1
SW	R2, 0(R3)
;Planner.c,159 :: 		SV.mode_complete          = 0;
LBU	R2, Offset(_SV+0)(GP)
INS	R2, R0, 6, 2
SB	R2, Offset(_SV+0)(GP)
;Planner.c,160 :: 		SV.running                = 1;
LBU	R2, Offset(_SV+0)(GP)
ORI	R2, R2, 1
SB	R2, Offset(_SV+0)(GP)
;Planner.c,161 :: 		last_speed                = speed;
SWC1	S12, Offset(speed_cntr_Move_last_speed_L0+0)(GP)
; abs_mmSteps end address is: 28 (R7)
MOVZ	R10, R7, R0
;Planner.c,166 :: 		while(DMA_IsOn(1));
L_speed_cntr_Move24:
...
LH	R26, 12(SP)
LW	R10, 8(SP)
BNE	R2, R0, L__speed_cntr_Move76
NOP	
...
NOP	
L_speed_cntr_Move25:
;Planner.c,192 :: 		,STPS[axis_No].min_delay);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R3, 24
LW	R9, 0(R2)
;Planner.c,191 :: 		,STPS[axis_No].decel_start
ADDIU	R2, R3, 16
LW	R8, 0(R2)
;Planner.c,190 :: 		,STPS[axis_No].decel_val
ADDIU	R2, R3, 20
LW	R7, 0(R2)
;Planner.c,189 :: 		,STPS[axis_No].accel_lim
ADDIU	R2, R3, 64
LW	R6, 0(R2)
;Planner.c,187 :: 		,STPS[axis_No].dec
ADDIU	R2, R3, 40
LW	R5, 0(R2)
;Planner.c,186 :: 		,STPS[axis_No].max_step_lim
ADDIU	R2, R3, 68
LW	R4, 0(R2)
;Planner.c,185 :: 		,a_t_x100[axis_No]
SEH	R2, R26
SLL	R3, R2, 2
LUI	R2, 40960
ORI	R2, R2, 9792
ADDU	R2, R2, R3
LWC1	S1, 0(R2)
;Planner.c,183 :: 		,alpha[axis_No]
LUI	R2, 40960
ORI	R2, R2, 10016
ADDU	R2, R2, R3
LWC1	S0, 0(R2)
;Planner.c,181 :: 		,a_sq[axis_No]
LUI	R2, 40960
ORI	R2, R2, 9856
ADDU	R2, R2, R3
LW	R3, 0(R2)
;Planner.c,178 :: 		min_dly:= %l\n\n"
ADDIU	R23, SP, 28
ADDIU	R22, R23, 180
...
;Planner.c,185 :: 		,a_t_x100[axis_No]
SWC1	S1, 28(SP)
;Planner.c,184 :: 		,axis_No
SH	R26, 24(SP)
;Planner.c,183 :: 		,alpha[axis_No]
SWC1	S0, 20(SP)
;Planner.c,182 :: 		,axis_No
SH	R26, 16(SP)
;Planner.c,181 :: 		,a_sq[axis_No]
SW	R3, 12(SP)
;Planner.c,180 :: 		,axis_No
SH	R26, 8(SP)
;Planner.c,179 :: 		,speed
SWC1	S12, 4(SP)
;Planner.c,178 :: 		min_dly:= %l\n\n"
...
_r_or_ijk:
;Planner.c,208 :: 		float r, float i, float j, float k, int axis_A,int axis_B,int dir){
ADDIU	SP, SP, -168
SW	RA, 0(SP)
SW	R28, 4(SP)
LWC1	S0, 168(SP)
...
;Planner.c,209 :: 		char isclockwise = 0;
;Planner.c,210 :: 		float inverse_feed_rate = -1; // negative inverse_feed_rate means no inverse_feed_rate specified
;Planner.c,211 :: 		float position[NoOfAxis]={0.0};
ADDIU	R23, SP, 100
ADDIU	R22, R23, 48
...
JAL	___CC2DW+0
NOP	
;Planner.c,212 :: 		float target[NoOfAxis]={0.0};
;Planner.c,213 :: 		float offset[NoOfAxis]={0.0};
;Planner.c,214 :: 		float x = 0.00;
;Planner.c,215 :: 		float y = 0.00;
;Planner.c,216 :: 		float h_x2_div_d = 0.00;
;Planner.c,221 :: 		position[axis_A] = Cur_axis_a;
ADDIU	R3, SP, 100
SEH	R2, R25
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S12, 0(R2)
;Planner.c,222 :: 		position[axis_B] = Cur_axis_b;
SEH	R2, R26
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S13, 0(R2)
;Planner.c,223 :: 		position[2] = 0;
ADDIU	R2, R3, 8
SW	R0, 0(R2)
;Planner.c,224 :: 		target[axis_A] = Fin_axis_a;
ADDIU	R3, SP, 116
SEH	R2, R25
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S14, 0(R2)
;Planner.c,225 :: 		target[axis_B] = Fin_axis_b;
SEH	R2, R26
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S15, 0(R2)
;Planner.c,226 :: 		target[2] = 0;
ADDIU	R2, R3, 8
SW	R0, 0(R2)
;Planner.c,227 :: 		offset[axis_A] = i;
ADDIU	R3, SP, 132
SEH	R2, R25
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S2, 0(R2)
;Planner.c,228 :: 		offset[axis_B] = j;
SEH	R2, R26
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S3, 0(R2)
;Planner.c,230 :: 		if (r != 0.00) { // Arc Radius Mode
LWC1	S1, 168(SP)
MOVZ	R2, R0, R0
MTC1	R2, S0
C.EQ.S 	0, S1, S0
...
;Planner.c,294 :: 		x = target[axis_plane_a] - position[axis_plane_a];
ADDIU	R5, SP, 116
LH	R2, 18(SP)
SLL	R3, R2, 2
ADDU	R2, R5, R3
...
SUB.S 	S3, S1, S0
SWC1	S3, 152(SP)
;Planner.c,296 :: 		y = target[axis_plane_b] - position[axis_plane_b];
LH	R2, 20(SP)
SLL	R3, R2, 2
ADDU	R2, R5, R3
LWC1	S1, 0(R2)
...
SUB.S 	S2, S1, S0
SWC1	S2, 156(SP)
;Planner.c,300 :: 		h_x2_div_d = 4 * r*r - x*x - y*y;
LWC1	S1, 168(SP)
LUI	R2, 16512
ORI	R2, R2, 0
MTC1	R2, S0
...
MUL.S 	S0, S2, S2
SUB.S 	S0, S1, S0
;Planner.c,303 :: 		h_x2_div_d = -sqrt(h_x2_div_d)/hypot(x,y); // == -(h * 2 / d)
SH	R25, 8(SP)
MOV.S 	S12, S0
JAL	_sqrt+0
NOP	
...
MOV.S 	S16, S0
;Planner.c,305 :: 		if (Get_motionmode() == MOTION_MODE_CCW_ARC) { h_x2_div_d = -h_x2_div_d; }
SWC1	S16, 8(SP)
SH	R27, 12(SP)
SH	R26, 14(SP)
SH	R25, 16(SP)
...
NOP	
L__r_or_ijk80:
;Planner.c,329 :: 		h_x2_div_d = -h_x2_div_d;
MOVZ	R2, R0, R0
MTC1	R2, S0
SUB.S 	S0, S0, S3
...
MOV.S 	S2, S0
;Planner.c,330 :: 		r = -r; // Finished with r. Set to positive for mc_arc
LWC1	S1, 168(SP)
MOVZ	R2, R0, R0
MTC1	R2, S0
SUB.S 	S0, S0, S1
...
;Planner.c,331 :: 		}
L_r_or_ijk28:
;Planner.c,334 :: 		i =  0.5*(x-(y*h_x2_div_d));
; h_x2_div_d start address is: 16 (R4)
LWC1	S0, 156(SP)
MUL.S 	S1, S0, S2
LWC1	S0, 152(SP)
...
;Planner.c,336 :: 		j =  0.5*(y+(x*h_x2_div_d));
LWC1	S0, 152(SP)
MUL.S 	S1, S0, S2
; h_x2_div_d end address is: 16 (R4)
LWC1	S0, 156(SP)
...
NOP	
L_r_or_ijk26:
;Planner.c,340 :: 		r = hypot(i, j); // Compute arc radius for mc_arc
; j start address is: 24 (R6)
; i start address is: 16 (R4)
SH	R27, 8(SP)
; j end address is: 24 (R6)
...
;Planner.c,341 :: 		}
L_r_or_ijk29:
;Planner.c,343 :: 		isclockwise = 0;
SB	R0, 148(SP)
;Planner.c,344 :: 		if (dir == CW) { isclockwise = 1; }
SEH	R2, R27
BEQ	R2, R0, L__r_or_ijk81
NOP	
J	L_r_or_ijk30
NOP	
L__r_or_ijk81:
...
SB	R2, 148(SP)
L_r_or_ijk30:
;Planner.c,346 :: 		while(DMA_IsOn(1));
L_r_or_ijk31:
SH	R27, 8(SP)
SH	R26, 10(SP)
SH	R25, 12(SP)
...
NOP	
L_r_or_ijk32:
;Planner.c,349 :: 		,position[X],position[Y],position[Z],target[X],target[Y],target[Z]);
ADDIU	R3, SP, 116
ADDIU	R2, R3, 8
LWC1	S5, 0(R2)
ADDIU	R2, R3, 4
...
LWC1	S1, 0(R2)
LWC1	S0, 0(R3)
;Planner.c,348 :: 		[pos[X]:= %f\tpos[Y]:= %f\tpos[Z]:= %f][tar[X]:= %f\ttar[Y]:= %f\ttar[Z]:= %f]\n\n"
ADDIU	R23, SP, 22
ADDIU	R22, R23, 78
...
LH	R25, 12(SP)
LH	R26, 10(SP)
;Planner.c,353 :: 		mc_arc(position, target, offset, axis_A, axis_B, Z,
ADDIU	R4, SP, 132
ADDIU	R3, SP, 116
ADDIU	R2, SP, 100
;Planner.c,354 :: 		gc.feed_rate, gc.inverse_feed_rate_mode,r, isclockwise);
SH	R26, 10(SP)
SH	R25, 12(SP)
LBU	R5, 148(SP)
ADDIU	SP, SP, -8
...
;Planner.c,360 :: 		void sys_sync_current_position(){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Planner.c,362 :: 		plan_set_current_position();
...
;Planner.c,366 :: 		void plan_set_current_position(){
ADDIU	SP, SP, -40
SW	RA, 0(SP)
;Planner.c,367 :: 		int i = 0;
SW	R25, 4(SP)
SW	R26, 8(SP)
;Planner.c,368 :: 		for(i=0;i<NoOfAxis;i++)
; i start address is: 16 (R4)
MOVZ	R4, R0, R0
; i end address is: 16 (R4)
...
;Planner.c,369 :: 		gc.position[i] = beltsteps2mm(STPS[i].steps_abs_position,i);
SEH	R2, R4
SLL	R3, R2, 2
...
;Planner.c,372 :: 		while(DMA_IsOn(1));
...
;Planner.c,379 :: 		void plan_reset_absolute_position(){
...
;Planner.c,382 :: 		STPS[X].steps_abs_position = 0;
...
_sqrt_:
;Planner.c,400 :: 		long sqrt_(long x){
;Planner.c,406 :: 		xr = 0;                     // clear result
; xr start address is: 20 (R5)
MOVZ	R5, R0, R0
;Planner.c,407 :: 		q2 = 0x40000000L;           // higest possible result bit
...
NOP	
L__sqrt_49:
;Planner.c,422 :: 		} while(q2 >>= 2);          // shift twice
MOVZ	R3, R2, R0
MOVZ	R5, R4, R0
;Planner.c,408 :: 		do
L_sqrt_41:
;Planner.c,410 :: 		if((xr + q2) <= x)
; q2 start address is: 12 (R3)
; xr start address is: 20 (R5)
ADDU	R2, R5, R3
SLTU	R2, R25, R2
...
NOP	
L__sqrt_92:
;Planner.c,412 :: 		x -= xr + q2;
ADDU	R2, R5, R3
SUBU	R2, R25, R2
MOVZ	R25, R2, R0
;Planner.c,413 :: 		f = 1;                  // set flag
...
NOP	
L__sqrt_96:
;Planner.c,424 :: 		return xr +1;             // add for rounding
ADDIU	R2, R4, 1
; xr end address is: 16 (R4)
J	L_end_sqrt_
NOP	
