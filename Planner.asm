...
SW	R2, 0(R3)
L_speed_cntr_Move14:
;Planner.c,104 :: 		STPS[axis_No].max_step_lim =(temp_speed*temp_speed)/(lround)(2.0*alpha[axis_No]*100.0*(double)STPS[axis_No].acc);
SEH	R3, R27
ORI	R2, R0, 100
MULTU	R2, R3
MFLO	R3
...
;Planner.c,360 :: 		while(DMA_IsOn(1));
