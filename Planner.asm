...
NOP	
L_speed_cntr_Move25:
;Planner.c,180 :: 		,STPS[axis_No].min_delay);
SEH	R3, R27
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R3, 24
LW	R9, 0(R2)
;Planner.c,179 :: 		,STPS[axis_No].decel_start
ADDIU	R2, R3, 16
LW	R8, 0(R2)
;Planner.c,178 :: 		,STPS[axis_No].decel_val
ADDIU	R2, R3, 20
LW	R7, 0(R2)
;Planner.c,177 :: 		,STPS[axis_No].max_step_lim
ADDIU	R2, R3, 68
LW	R6, 0(R2)
;Planner.c,176 :: 		,STPS[axis_No].dist
ADDIU	R2, R3, 48
LW	R5, 0(R2)
;Planner.c,175 :: 		,STPS[axis_No].axis_dir
ADDIU	R2, R3, 2
LH	R4, 0(R2)
;Planner.c,174 :: 		,(STPS[axis_No].run_state&0xff)
ADDIU	R2, R3, 4
LH	R2, 0(R2)
ANDI	R3, R2, 255
;Planner.c,172 :: 		min_dly:= %l\n\n"
ADDIU	R23, SP, 24
ADDIU	R22, R23, 107
...
ADDIU	R3, SP, 64
ADDIU	R2, SP, 48
;Planner.c,343 :: 		gc.frequency, gc.inverse_feed_rate_mode,r, isclockwise);
ADDIU	SP, SP, -12
SB	R5, 9(SP)
...
;Planner.c,349 :: 		void sys_sync_current_position(){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Planner.c,351 :: 		plan_set_current_position();
...
;Planner.c,368 :: 		void plan_reset_absolute_position(){
;Planner.c,369 :: 		int i = 0;
...
_sqrt_:
;Planner.c,389 :: 		long sqrt_(long x){
;Planner.c,395 :: 		xr = 0;                     // clear result
; xr start address is: 20 (R5)
MOVZ	R5, R0, R0
;Planner.c,396 :: 		q2 = 0x40000000L;           // higest possible result bit
