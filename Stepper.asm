...
SEH	R2, R25
SLT	R2, R3, R2
BNE	R2, R0, L__EnableSteppers112
NOP	
J	L_EnableSteppers1
NOP	
...
SEH	R2, R4
BEQ	R2, R0, L__EnableSteppers113
NOP	
J	L_EnableSteppers3
NOP	
...
SEH	R3, R4
ORI	R2, R0, 3
BEQ	R3, R2, L__EnableSteppers116
NOP	
J	L_EnableSteppers6
NOP	
L__EnableSteppers116:
_LX	
INS	R2, R0, BitPos(EN_StepA+0), 1
_SX	
L_EnableSteppers6:
...
; state start address is: 16 (R4)
SEH	R2, R25
BNE	R2, R0, L__Get_AxisStatus130
NOP	
J	L_Get_AxisStatus15
NOP	
L__Get_AxisStatus130:
SEH	R3, R25
ORI	R2, R0, 1
BNE	R3, R2, L__Get_AxisStatus132
NOP	
J	L_Get_AxisStatus16
NOP	
L__Get_AxisStatus132:
SEH	R3, R25
ORI	R2, R0, 2
BNE	R3, R2, L__Get_AxisStatus134
NOP	
J	L_Get_AxisStatus17
NOP	
L__Get_AxisStatus134:
SEH	R3, R25
ORI	R2, R0, 3
BNE	R3, R2, L__Get_AxisStatus136
NOP	
J	L_Get_AxisStatus18
NOP	
L__Get_AxisStatus136:
; state end address is: 16 (R4)
SEH	R2, R4
L_Get_AxisStatus14:
...
ANDI	R2, R25, 255
BNE	R2, R0, L__Single_Axis_Enable140
NOP	
...
ANDI	R3, R25, 255
ORI	R2, R0, 5
BNE	R3, R2, L__Single_Axis_Enable150
NOP	
J	L_Single_Axis_Enable26
NOP	
L__Single_Axis_Enable150:
...
; end of _StopAxis
_disableOCx:
;Stepper.c,190 :: 		void disableOCx(){
;Stepper.c,191 :: 		OC5IE_bit = 0;OC5CONbits.ON = 0; //X
LUI	R2, BitMask(OC5IE_bit+0)
ORI	R2, R2, BitMask(OC5IE_bit+0)
_SX	
ORI	R3, R0, 32768
SW	R3, Offset(OC5CONbits+4)(GP)
;Stepper.c,192 :: 		OC2IE_bit = 0;OC2CONbits.ON = 0; //Y
LUI	R2, BitMask(OC2IE_bit+0)
ORI	R2, R2, BitMask(OC2IE_bit+0)
_SX	
SW	R3, Offset(OC2CONbits+4)(GP)
;Stepper.c,193 :: 		OC7IE_bit = 0;OC7CONbits.ON = 0; //Z
LUI	R2, BitMask(OC7IE_bit+0)
ORI	R2, R2, BitMask(OC7IE_bit+0)
_SX	
SW	R3, Offset(OC7CONbits+4)(GP)
;Stepper.c,195 :: 		OC3IE_bit = 0;OC3CONbits.ON = 0; //A
LUI	R2, BitMask(OC3IE_bit+0)
ORI	R2, R2, BitMask(OC3IE_bit+0)
_SX	
SW	R3, Offset(OC3CONbits+4)(GP)
;Stepper.c,196 :: 		OC6IE_bit = 0;OC6CONbits.ON = 0; //B
LUI	R2, BitMask(OC6IE_bit+0)
ORI	R2, R2, BitMask(OC6IE_bit+0)
_SX	
SW	R3, Offset(OC6CONbits+4)(GP)
;Stepper.c,197 :: 		OC8IE_bit = 0;OC8CONbits.ON = 0; //Z
LUI	R2, BitMask(OC8IE_bit+0)
ORI	R2, R2, BitMask(OC8IE_bit+0)
_SX	
...
; end of _disableOCx
_toggleOCx:
;Stepper.c,202 :: 		void toggleOCx(int axis_No){
;Stepper.c,203 :: 		switch(axis_No){
J	L_toggleOCx35
NOP	
;Stepper.c,204 :: 		case X:
L_toggleOCx37:
;Stepper.c,205 :: 		OC5IF_bit = 0;
LUI	R2, BitMask(OC5IF_bit+0)
ORI	R2, R2, BitMask(OC5IF_bit+0)
_SX	
;Stepper.c,206 :: 		OC5R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC5R+0)(GP)
;Stepper.c,207 :: 		OC5RS  = STPS[X].step_delay & 0xFFFF;//0x234;
LW	R2, Offset(_STPS+12)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC5RS+0)(GP)
;Stepper.c,208 :: 		TMR2   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR2+0)(GP)
;Stepper.c,209 :: 		OC5CON =  0x8004; //restart the output compare module
ORI	R2, R0, 32772
SW	R2, Offset(OC5CON+0)(GP)
;Stepper.c,210 :: 		break;
J	L_toggleOCx36
NOP	
;Stepper.c,211 :: 		case Y:
L_toggleOCx38:
;Stepper.c,212 :: 		OC2IF_bit = 0;
LUI	R2, BitMask(OC2IF_bit+0)
ORI	R2, R2, BitMask(OC2IF_bit+0)
_SX	
;Stepper.c,213 :: 		OC2R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC2R+0)(GP)
;Stepper.c,214 :: 		OC2RS  = STPS[Y].step_delay & 0xFFFF;
LW	R2, Offset(_STPS+104)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC2RS+0)(GP)
;Stepper.c,215 :: 		TMR4   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR4+0)(GP)
;Stepper.c,216 :: 		OC2CON =  0x8004; //restart the output compare module
ORI	R2, R0, 32772
SW	R2, Offset(OC2CON+0)(GP)
;Stepper.c,217 :: 		break;
J	L_toggleOCx36
NOP	
;Stepper.c,218 :: 		case Z:
L_toggleOCx39:
;Stepper.c,219 :: 		OC7R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC7R+0)(GP)
;Stepper.c,220 :: 		OC7RS  = STPS[Z].step_delay & 0xFFFF;
LW	R2, Offset(_STPS+196)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC7RS+0)(GP)
;Stepper.c,221 :: 		TMR6   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR6+0)(GP)
;Stepper.c,222 :: 		OC7CON =  0x8004; //restart the output compare module
ORI	R2, R0, 32772
SW	R2, Offset(OC7CON+0)(GP)
;Stepper.c,223 :: 		break;
J	L_toggleOCx36
NOP	
;Stepper.c,224 :: 		case A:
L_toggleOCx40:
;Stepper.c,225 :: 		OC3R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC3R+0)(GP)
;Stepper.c,226 :: 		OC3RS  = STPS[A].step_delay & 0xFFFF;
LW	R2, Offset(_STPS+288)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC3RS+0)(GP)
;Stepper.c,227 :: 		TMR5   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR5+0)(GP)
;Stepper.c,228 :: 		OC3CON =  0x800C; //restart the output compare module
ORI	R2, R0, 32780
SW	R2, Offset(OC3CON+0)(GP)
;Stepper.c,229 :: 		break;
J	L_toggleOCx36
NOP	
;Stepper.c,230 :: 		case B:
L_toggleOCx41:
;Stepper.c,231 :: 		OC6R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC6R+0)(GP)
;Stepper.c,232 :: 		OC6RS  = STPS[B].step_delay & 0xFFFF;
LW	R2, Offset(_STPS+380)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC6RS+0)(GP)
;Stepper.c,233 :: 		TMR3   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR3+0)(GP)
;Stepper.c,234 :: 		OC6CON =  0x800C; //restart the output compare module
ORI	R2, R0, 32780
SW	R2, Offset(OC6CON+0)(GP)
;Stepper.c,235 :: 		break;
J	L_toggleOCx36
NOP	
;Stepper.c,236 :: 		case C:
L_toggleOCx42:
;Stepper.c,237 :: 		OC8R   = 0x5;
ORI	R2, R0, 5
...
; end of _toggleOCx
_Step_Cycle:
;Stepper.c,253 :: 		void Step_Cycle(int axis_No){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Stepper.c,254 :: 		toggleOCx(axis_No);
JAL	_toggleOCx+0
NOP	
...
; end of _Step_Cycle
Stepper_Pulse:
;Stepper.c,263 :: 		static int Pulse(int axis_No){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Stepper.c,265 :: 		switch(STPS[axis_No].run_state) {
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 4
SH	R0, 0(R2)
;Stepper.c,268 :: 		StopAxis(axis_No);
JAL	_StopAxis+0
NOP	
;Stepper.c,269 :: 		bit_true(SV.mode_complete,bit(axis_No));
SEH	R3, R25
ORI	R2, R0, 1
SLLV	R3, R2, R3
...
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Stepper.c,407 :: 		if(bit_istrue(SV.mode_complete,axis))return;
LBU	R2, Offset(_SV+0)(GP)
EXT	R2, R2, 6, 2
ANDI	R2, R2, 255
AND	R2, R2, R25
SEH	R2, R2
BNE	R2, R0, L__SingleStepAxis220
NOP	
J	L_SingleStepAxis88
NOP	
L__SingleStepAxis220:
J	L_end_SingleStepAxis
NOP	
L_SingleStepAxis88:
;Stepper.c,408 :: 		Step_Cycle(axis);
JAL	_Step_Cycle+0
NOP	
;Stepper.c,409 :: 		Pulse(axis);
JAL	Stepper_Pulse+0
NOP	
;Stepper.c,410 :: 		}
...
_Axis_Interpolate:
;Stepper.c,417 :: 		void Axis_Interpolate(int axisA,int axisB){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Stepper.c,420 :: 		cnt++;
...
;Stepper.c,427 :: 		STPS[axisB].step_delay  = STPS[axisA].step_delay;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,428 :: 		STPS[axisB].accel_count = STPS[axisA].accel_count;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,430 :: 		if(STPS[axisA].step_count < STPS[axisA].dist)
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,431 :: 		Step_Cycle(axisA);
JAL	_Step_Cycle+0
NOP	
J	L_Axis_Interpolate92
NOP	
L_Axis_Interpolate91:
;Stepper.c,433 :: 		if(SV.cir)
LBU	R2, Offset(_SV+0)(GP)
EXT	R2, R2, 4, 1
...
;Stepper.c,434 :: 		StopAxis(axisA);
JAL	_StopAxis+0
NOP	
L_Axis_Interpolate93:
;Stepper.c,435 :: 		}
L_Axis_Interpolate92:
;Stepper.c,437 :: 		if(!SV.cir)
LBU	R2, Offset(_SV+0)(GP)
EXT	R2, R2, 4, 1
...
;Stepper.c,438 :: 		Pulse(axisA);
JAL	Stepper_Pulse+0
NOP	
L_Axis_Interpolate94:
;Stepper.c,440 :: 		if(SV.dif < 0){
...
;Stepper.c,441 :: 		SV.dif += BresIncVal(SV.dB);//2*SV.dy;//
...
;Stepper.c,443 :: 		Step_Cycle(axisB);
SH	R25, 4(SP)
SEH	R25, R26
JAL	_Step_Cycle+0
NOP	
LH	R25, 4(SP)
;Stepper.c,444 :: 		SV.dif += BresDiffVal(SV.dB,SV.dA);//2 * (SV.dy - SV.dx);//
...
;Stepper.c,448 :: 		if(STPS[axisA].run_state == STOP | STPS[axisA].step_count >= STPS[axisA].dist){
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
XORI	R2, R2, 1
OR	R2, R5, R2
BNE	R2, R0, L__Axis_Interpolate232
NOP	
J	L_Axis_Interpolate97
NOP	
L__Axis_Interpolate232:
;Stepper.c,449 :: 		StopAxis(axisB);
SH	R25, 4(SP)
SEH	R25, R26
JAL	_StopAxis+0
NOP	
LH	R25, 4(SP)
;Stepper.c,450 :: 		STPS[axisA].run_state = STOP;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 4
SH	R0, 0(R2)
;Stepper.c,451 :: 		STPS[axisB].run_state = STOP;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,455 :: 		STPS[axisA].step_delay  = STPS[axisB].step_delay;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,456 :: 		STPS[axisA].accel_count = STPS[axisB].accel_count;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,458 :: 		if(STPS[axisB].step_count < STPS[axisB].dist)
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SLT	R2, R3, R2
BNE	R2, R0, L__Axis_Interpolate233
NOP	
J	L_Axis_Interpolate99
NOP	
L__Axis_Interpolate233:
;Stepper.c,459 :: 		Step_Cycle(axisB);
SH	R25, 4(SP)
SEH	R25, R26
JAL	_Step_Cycle+0
NOP	
...
;Stepper.c,461 :: 		if(SV.cir)
LBU	R2, Offset(_SV+0)(GP)
EXT	R2, R2, 4, 1
BNE	R2, R0, L__Axis_Interpolate235
NOP	
J	L_Axis_Interpolate101
NOP	
L__Axis_Interpolate235:
...
;Stepper.c,465 :: 		if(!SV.cir)
LBU	R2, Offset(_SV+0)(GP)
EXT	R2, R2, 4, 1
BEQ	R2, R0, L__Axis_Interpolate236
NOP	
J	L_Axis_Interpolate102
NOP	
L__Axis_Interpolate236:
;Stepper.c,466 :: 		Pulse(axisB);
SH	R25, 4(SP)
SEH	R25, R26
JAL	Stepper_Pulse+0
NOP	
...
;Stepper.c,469 :: 		if(SV.dif < 0){
LW	R2, Offset(_SV+16)(GP)
SLTI	R2, R2, 0
BNE	R2, R0, L__Axis_Interpolate237
NOP	
J	L_Axis_Interpolate103
NOP	
L__Axis_Interpolate237:
;Stepper.c,470 :: 		SV.dif += BresIncVal(SV.dA);//2 * SV.dx;//
LW	R2, Offset(_SV+20)(GP)
SLL	R3, R2, 1
LW	R2, Offset(_SV+16)(GP)
ADDU	R2, R2, R3
...
;Stepper.c,472 :: 		Step_Cycle(axisA);
JAL	_Step_Cycle+0
NOP	
;Stepper.c,473 :: 		SV.dif += BresDiffVal(SV.dA,SV.dB);//2 * (SV.dx - SV.dy);//
LW	R3, Offset(_SV+24)(GP)
LW	R2, Offset(_SV+20)(GP)
SUBU	R2, R2, R3
SLL	R3, R2, 1
...
;Stepper.c,476 :: 		if(STPS[axisB].run_state == STOP | STPS[axisB].step_count >= STPS[axisB].dist){
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
XORI	R2, R2, 1
OR	R2, R5, R2
BNE	R2, R0, L__Axis_Interpolate241
NOP	
J	L_Axis_Interpolate105
NOP	
L__Axis_Interpolate241:
;Stepper.c,477 :: 		StopAxis(axisA);
JAL	_StopAxis+0
NOP	
;Stepper.c,478 :: 		STPS[axisA].run_state = STOP;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 4
SH	R0, 0(R2)
;Stepper.c,479 :: 		STPS[axisB].run_state = STOP;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
