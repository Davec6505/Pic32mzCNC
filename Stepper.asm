...
NOP	
L_Stepper_Pulse175:
;Stepper.c,276 :: 		STPS[axis_No].step_delay = STPS[axis_No].min_delay;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,278 :: 		}
L_Stepper_Pulse48:
;Stepper.c,279 :: 		if(STPS[axis_No].step_count > STPS[axis_No].max_step_lim){
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R3)
;Stepper.c,294 :: 		if(STPS[axis_No].step_count >= STPS[axis_No].decel_start) {
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
NOP	
L_Stepper_Pulse178:
;Stepper.c,295 :: 		STPS[axis_No].accel_count = STPS[axis_No].decel_val;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R3)
;Stepper.c,296 :: 		STPS[axis_No].rest        = 0;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
J	L_Stepper_Pulse45
NOP	
;Stepper.c,300 :: 		case DECEL:
L_Stepper_Pulse53:
;Stepper.c,302 :: 		AccDec(axis_No);
JAL	Stepper_AccDec+0
NOP	
;Stepper.c,304 :: 		if(STPS[axis_No].accel_count >= -1 ){
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
NOP	
L_Stepper_Pulse179:
;Stepper.c,305 :: 		STPS[axis_No].run_state = STOP;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
Stepper_AccDec:
;Stepper.c,315 :: 		static void AccDec(int axis_No){
;Stepper.c,316 :: 		STPS[axis_No].accel_count++;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 1
SW	R2, 0(R3)
;Stepper.c,317 :: 		STPS[axis_No].new_step_delay = STPS[axis_No].step_delay - (( STPS[axis_No].step_delay << 1) + STPS[axis_No].rest)/((STPS[axis_No].accel_count << 2) + 1);
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
SUBU	R2, R4, R2
SW	R2, 0(R5)
;Stepper.c,318 :: 		STPS[axis_No].rest = ((STPS[axis_No].step_delay << 1)+STPS[axis_No].rest)%((STPS[axis_No].accel_count << 2 ) + 1);
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
MFHI	R2
SW	R2, 0(R4)
;Stepper.c,319 :: 		STPS[axis_No].step_delay = STPS[axis_No].new_step_delay;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
_StepX:
;Stepper.c,328 :: 		void StepX() iv IVT_OUTPUT_COMPARE_5 ilevel 3 ics ICS_SRS {
RDPGPR	SP, SP
ADDIU	SP, SP, -12
MFC0	R30, 12, 2
SW	R30, 8(SP)
...
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Stepper.c,329 :: 		OC5IF_bit = 0;
LUI	R2, BitMask(OC5IF_bit+0)
ORI	R2, R2, BitMask(OC5IF_bit+0)
_SX	
;Stepper.c,331 :: 		if(SV.Single_Dual == 0){
...
NOP	
L__StepX190:
;Stepper.c,332 :: 		SingleStepAxis(X);
MOVZ	R25, R0, R0
...
NOP	
L_StepX56:
;Stepper.c,334 :: 		if(STPS[X].master = 1){
...
NOP	
L__StepX193:
;Stepper.c,336 :: 		Axis_Interpolate(X,Y);
ORI	R26, R0, 1
MOVZ	R25, R0, R0
...
NOP	
L_StepX59:
;Stepper.c,337 :: 		else if(axis_xyz == xz)
...
; end of _StepX
_StepY:
;Stepper.c,347 :: 		void StepY() iv IVT_OUTPUT_COMPARE_2 ilevel 3 ics ICS_SRS {
RDPGPR	SP, SP
ADDIU	SP, SP, -12
MFC0	R30, 12, 2
SW	R30, 8(SP)
...
NOP	
L__StepY197:
;Stepper.c,351 :: 		SingleStepAxis(Y);
ORI	R25, R0, 1
JAL	_SingleStepAxis+0
NOP	
;Stepper.c,352 :: 		}else {
...
NOP	
L_StepY64:
;Stepper.c,353 :: 		if(STPS[Y].master = 1){
...
NOP	
L__StepY200:
;Stepper.c,355 :: 		Axis_Interpolate(X,Y);
ORI	R26, R0, 1
MOVZ	R25, R0, R0
JAL	_Axis_Interpolate+0
NOP	
...
NOP	
L_StepY67:
;Stepper.c,356 :: 		else if(axis_xyz == yz)
LBU	R3, Offset(_axis_xyz+0)(GP)
ORI	R2, R0, 2
...
NOP	
L__StepY201:
;Stepper.c,357 :: 		Axis_Interpolate(Y,Z);
ORI	R26, R0, 2
ORI	R25, R0, 1
JAL	_Axis_Interpolate+0
NOP	
...
NOP	
L_StepY69:
;Stepper.c,358 :: 		else if(axis_xyz == ya)
LBU	R3, Offset(_axis_xyz+0)(GP)
ORI	R2, R0, 4
...
NOP	
L__StepY202:
;Stepper.c,359 :: 		Axis_Interpolate(Y,A);
ORI	R26, R0, 3
ORI	R25, R0, 1
JAL	_Axis_Interpolate+0
NOP	
...
; end of _StepY
_StepZ:
;Stepper.c,365 :: 		void StepZ() iv IVT_OUTPUT_COMPARE_7 ilevel 3 ics ICS_SRS {
RDPGPR	SP, SP
ADDIU	SP, SP, -12
MFC0	R30, 12, 2
SW	R30, 8(SP)
...
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Stepper.c,366 :: 		OC7IF_bit = 0;
LUI	R2, BitMask(OC7IF_bit+0)
ORI	R2, R2, BitMask(OC7IF_bit+0)
_SX	
;Stepper.c,368 :: 		if(SV.Single_Dual == 0){
LH	R2, Offset(_SV+2)(GP)
...
NOP	
L__StepZ204:
;Stepper.c,369 :: 		SingleStepAxis(Z);
ORI	R25, R0, 2
JAL	_SingleStepAxis+0
NOP	
;Stepper.c,370 :: 		}else{
...
NOP	
L_StepZ72:
;Stepper.c,371 :: 		if(STPS[Z].master = 1){
...
NOP	
L__StepZ207:
;Stepper.c,373 :: 		Axis_Interpolate(X,Z);
ORI	R26, R0, 2
MOVZ	R25, R0, R0
JAL	_Axis_Interpolate+0
NOP	
...
NOP	
L_StepZ75:
;Stepper.c,374 :: 		else if(axis_xyz == yz)
LBU	R3, Offset(_axis_xyz+0)(GP)
ORI	R2, R0, 2
...
NOP	
L__StepZ208:
;Stepper.c,375 :: 		Axis_Interpolate(Y,Z);
ORI	R26, R0, 2
ORI	R25, R0, 1
JAL	_Axis_Interpolate+0
NOP	
...
NOP	
L_StepZ77:
;Stepper.c,376 :: 		else if(axis_xyz == za)
LBU	R3, Offset(_axis_xyz+0)(GP)
ORI	R2, R0, 5
...
NOP	
L__StepZ209:
;Stepper.c,377 :: 		Axis_Interpolate(Z,A);
ORI	R26, R0, 3
ORI	R25, R0, 2
JAL	_Axis_Interpolate+0
NOP	
...
; end of _StepZ
_StepA:
;Stepper.c,385 :: 		void StepA() iv IVT_OUTPUT_COMPARE_3 ilevel 3 ics ICS_SRS {
RDPGPR	SP, SP
ADDIU	SP, SP, -12
MFC0	R30, 12, 2
SW	R30, 8(SP)
...
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Stepper.c,386 :: 		OC3IF_bit = 0;
LUI	R2, BitMask(OC3IF_bit+0)
ORI	R2, R2, BitMask(OC3IF_bit+0)
_SX	
;Stepper.c,388 :: 		if(SV.Single_Dual == 0){
LH	R2, Offset(_SV+2)(GP)
...
NOP	
L__StepA211:
;Stepper.c,389 :: 		SingleStepAxis(A);
ORI	R25, R0, 3
JAL	_SingleStepAxis+0
NOP	
;Stepper.c,390 :: 		}else{
...
NOP	
L_StepA80:
;Stepper.c,391 :: 		if(STPS[A].master = 1){
...
NOP	
L__StepA214:
;Stepper.c,393 :: 		Axis_Interpolate(X,A);
ORI	R26, R0, 3
MOVZ	R25, R0, R0
JAL	_Axis_Interpolate+0
NOP	
...
NOP	
L_StepA83:
;Stepper.c,394 :: 		else if(axis_xyz == ya)
LBU	R3, Offset(_axis_xyz+0)(GP)
ORI	R2, R0, 4
...
NOP	
L__StepA215:
;Stepper.c,395 :: 		Axis_Interpolate(Y,A);
ORI	R26, R0, 3
ORI	R25, R0, 1
JAL	_Axis_Interpolate+0
NOP	
...
NOP	
L_StepA85:
;Stepper.c,396 :: 		else if(axis_xyz == za)
LBU	R3, Offset(_axis_xyz+0)(GP)
ORI	R2, R0, 5
...
NOP	
L__StepA216:
;Stepper.c,397 :: 		Axis_Interpolate(Z,A);
ORI	R26, R0, 3
ORI	R25, R0, 2
JAL	_Axis_Interpolate+0
NOP	
...
; end of _StepA
_SingleStepAxis:
;Stepper.c,407 :: 		void SingleStepAxis(int axis){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Stepper.c,413 :: 		Step_Cycle(axis);
JAL	_Step_Cycle+0
NOP	
;Stepper.c,414 :: 		Pulse(axis);
JAL	Stepper_Pulse+0
NOP	
;Stepper.c,416 :: 		}
...
_Axis_Interpolate:
;Stepper.c,423 :: 		void Axis_Interpolate(int axisA,int axisB){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Stepper.c,426 :: 		cnt++;
...
;Stepper.c,433 :: 		STPS[axisB].step_delay  = STPS[axisA].step_delay;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,434 :: 		STPS[axisB].accel_count = STPS[axisA].accel_count;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,436 :: 		if(STPS[axisA].step_count < STPS[axisA].dist)
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,448 :: 		SV.dif += BresIncVal(SV.dB);//2*SV.dy;//
...
;Stepper.c,450 :: 		Step_Cycle(axisB);
SH	R25, 4(SP)
SEH	R25, R26
JAL	_Step_Cycle+0
NOP	
LH	R25, 4(SP)
;Stepper.c,451 :: 		SV.dif += BresDiffVal(SV.dB,SV.dA);//2 * (SV.dy - SV.dx);//
...
;Stepper.c,454 :: 		if(STPS[axisA].run_state == STOP | STPS[axisA].step_count >= STPS[axisA].dist){
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,455 :: 		StopAxis(axisB);
SH	R25, 4(SP)
SEH	R25, R26
JAL	_StopAxis+0
NOP	
LH	R25, 4(SP)
;Stepper.c,456 :: 		STPS[axisA].run_state = STOP;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 4
SH	R0, 0(R2)
;Stepper.c,457 :: 		STPS[axisB].run_state = STOP;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,461 :: 		STPS[axisA].step_delay  = STPS[axisB].step_delay;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,462 :: 		STPS[axisA].accel_count = STPS[axisB].accel_count;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,464 :: 		if(STPS[axisB].step_count < STPS[axisB].dist)
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SLT	R2, R3, R2
BNE	R2, R0, L__Axis_Interpolate230
NOP	
J	L_Axis_Interpolate98
NOP	
L__Axis_Interpolate230:
;Stepper.c,465 :: 		Step_Cycle(axisB);
SH	R25, 4(SP)
SEH	R25, R26
JAL	_Step_Cycle+0
NOP	
...
;Stepper.c,471 :: 		if(!SV.cir)
LBU	R2, Offset(_SV+0)(GP)
EXT	R2, R2, 4, 1
BEQ	R2, R0, L__Axis_Interpolate233
NOP	
J	L_Axis_Interpolate101
NOP	
L__Axis_Interpolate233:
;Stepper.c,472 :: 		Pulse(axisB);
SH	R25, 4(SP)
SEH	R25, R26
JAL	Stepper_Pulse+0
NOP	
...
LW	R2, Offset(_SV+20)(GP)
SLTI	R2, R2, 0
BNE	R2, R0, L__Axis_Interpolate234
NOP	
J	L_Axis_Interpolate102
NOP	
L__Axis_Interpolate234:
...
;Stepper.c,478 :: 		Step_Cycle(axisA);
JAL	_Step_Cycle+0
NOP	
;Stepper.c,479 :: 		SV.dif += BresDiffVal(SV.dA,SV.dB);//2 * (SV.dx - SV.dy);//
LW	R3, Offset(_SV+28)(GP)
LW	R2, Offset(_SV+24)(GP)
SUBU	R2, R2, R3
SLL	R3, R2, 1
...
;Stepper.c,482 :: 		if(STPS[axisB].run_state == STOP | STPS[axisB].step_count >= STPS[axisB].dist){
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
XORI	R2, R2, 1
OR	R2, R5, R2
BNE	R2, R0, L__Axis_Interpolate238
NOP	
J	L_Axis_Interpolate104
NOP	
L__Axis_Interpolate238:
;Stepper.c,483 :: 		StopAxis(axisA);
JAL	_StopAxis+0
NOP	
;Stepper.c,484 :: 		STPS[axisA].run_state = STOP;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 4
SH	R0, 0(R2)
;Stepper.c,485 :: 		STPS[axisB].run_state = STOP;
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
