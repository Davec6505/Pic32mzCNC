...
L_StopAxis39:
;Stepper.c,187 :: 		OC5IE_bit = 0; OC5CONbits.ON = 0;
LUI	R2, BitMask(OC5IE_bit+0)
ORI	R2, R2, BitMask(OC5IE_bit+0)
_SX	
ORI	R2, R0, 32768
...
L_StopAxis40:
;Stepper.c,190 :: 		OC2IE_bit = 0; OC2CONbits.ON = 0;
LUI	R2, BitMask(OC2IE_bit+0)
ORI	R2, R2, BitMask(OC2IE_bit+0)
_SX	
ORI	R2, R0, 32768
...
J	L_StopAxis38
NOP	
;Stepper.c,192 :: 		case Z:
L_StopAxis41:
;Stepper.c,193 :: 		OC7IE_bit = 0; OC7CONbits.ON = 0;
LUI	R2, BitMask(OC7IE_bit+0)
ORI	R2, R2, BitMask(OC7IE_bit+0)
_SX	
ORI	R2, R0, 32768
...
J	L_StopAxis38
NOP	
;Stepper.c,195 :: 		case A:
L_StopAxis42:
;Stepper.c,196 :: 		OC3IE_bit = 0; OC3CONbits.ON = 0;
LUI	R2, BitMask(OC3IE_bit+0)
ORI	R2, R2, BitMask(OC3IE_bit+0)
_SX	
ORI	R2, R0, 32768
...
NOP	
L_StopAxis38:
;Stepper.c,200 :: 		STPS[axis].run_state = STOP;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 4
SH	R0, 0(R2)
;Stepper.c,202 :: 		bit_false(SV.mode_complete,bit(axis));
SEH	R3, R25
ORI	R2, R0, 1
SLLV	R2, R2, R3
NOR	R3, R2, R0
...
; end of _StopAxis
_disableOCx:
;Stepper.c,206 :: 		void disableOCx(){
;Stepper.c,207 :: 		OC5IE_bit = 0;OC5CONbits.ON = 0; //X
LUI	R2, BitMask(OC5IE_bit+0)
ORI	R2, R2, BitMask(OC5IE_bit+0)
_SX	
ORI	R3, R0, 32768
SW	R3, Offset(OC5CONbits+4)(GP)
;Stepper.c,208 :: 		OC2IE_bit = 0;OC2CONbits.ON = 0; //Y
LUI	R2, BitMask(OC2IE_bit+0)
ORI	R2, R2, BitMask(OC2IE_bit+0)
_SX	
SW	R3, Offset(OC2CONbits+4)(GP)
;Stepper.c,209 :: 		OC7IE_bit = 0;OC7CONbits.ON = 0; //Z
LUI	R2, BitMask(OC7IE_bit+0)
ORI	R2, R2, BitMask(OC7IE_bit+0)
_SX	
SW	R3, Offset(OC7CONbits+4)(GP)
;Stepper.c,211 :: 		OC3IE_bit = 0;OC3CONbits.ON = 0; //A
LUI	R2, BitMask(OC3IE_bit+0)
ORI	R2, R2, BitMask(OC3IE_bit+0)
_SX	
SW	R3, Offset(OC3CONbits+4)(GP)
;Stepper.c,212 :: 		OC6IE_bit = 0;OC6CONbits.ON = 0; //B
LUI	R2, BitMask(OC6IE_bit+0)
ORI	R2, R2, BitMask(OC6IE_bit+0)
_SX	
SW	R3, Offset(OC6CONbits+4)(GP)
;Stepper.c,213 :: 		OC8IE_bit = 0;OC8CONbits.ON = 0; //Z
LUI	R2, BitMask(OC8IE_bit+0)
ORI	R2, R2, BitMask(OC8IE_bit+0)
_SX	
...
; end of _disableOCx
Stepper_toggleOCx:
;Stepper.c,218 :: 		static void toggleOCx(int axis_No){
;Stepper.c,219 :: 		switch(axis_No){
J	L_Stepper_toggleOCx44
NOP	
;Stepper.c,220 :: 		case X:
L_Stepper_toggleOCx46:
;Stepper.c,221 :: 		OC5IF_bit = 0;
LUI	R2, BitMask(OC5IF_bit+0)
ORI	R2, R2, BitMask(OC5IF_bit+0)
_SX	
;Stepper.c,222 :: 		OC5R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC5R+0)(GP)
;Stepper.c,223 :: 		OC5RS  = STPS[X].step_delay & 0xFFFF;//0x234;
LW	R2, Offset(_STPS+8)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC5RS+0)(GP)
;Stepper.c,224 :: 		TMR2   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR2+0)(GP)
;Stepper.c,225 :: 		OC5CON =  0x8004; //restart the output compare module
ORI	R2, R0, 32772
...
;Stepper.c,228 :: 		OC2IF_bit = 0;
LUI	R2, BitMask(OC2IF_bit+0)
ORI	R2, R2, BitMask(OC2IF_bit+0)
_SX	
;Stepper.c,229 :: 		OC2R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC2R+0)(GP)
;Stepper.c,230 :: 		OC2RS  = STPS[Y].step_delay & 0xFFFF;
LW	R2, Offset(_STPS+76)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC2RS+0)(GP)
;Stepper.c,231 :: 		TMR4   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR4+0)(GP)
;Stepper.c,232 :: 		OC2CON =  0x8004; //restart the output compare module
ORI	R2, R0, 32772
SW	R2, Offset(OC2CON+0)(GP)
;Stepper.c,233 :: 		break;
J	L_Stepper_toggleOCx45
NOP	
;Stepper.c,234 :: 		case Z:
L_Stepper_toggleOCx48:
;Stepper.c,235 :: 		OC7R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC7R+0)(GP)
;Stepper.c,236 :: 		OC7RS  = STPS[Z].step_delay & 0xFFFF;
LW	R2, Offset(_STPS+144)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC7RS+0)(GP)
;Stepper.c,237 :: 		TMR6   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR6+0)(GP)
;Stepper.c,238 :: 		OC7CON =  0x8004; //restart the output compare module
ORI	R2, R0, 32772
...
;Stepper.c,241 :: 		OC3R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC3R+0)(GP)
;Stepper.c,242 :: 		OC3RS  = STPS[A].step_delay & 0xFFFF;
LW	R2, Offset(_STPS+212)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC3RS+0)(GP)
;Stepper.c,243 :: 		TMR5   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR5+0)(GP)
;Stepper.c,244 :: 		OC3CON =  0x800C; //restart the output compare module
ORI	R2, R0, 32780
SW	R2, Offset(OC3CON+0)(GP)
;Stepper.c,245 :: 		break;
J	L_Stepper_toggleOCx45
NOP	
;Stepper.c,246 :: 		case B:
L_Stepper_toggleOCx50:
;Stepper.c,247 :: 		OC6R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC6R+0)(GP)
;Stepper.c,248 :: 		OC6RS  = STPS[B].step_delay & 0xFFFF;
LW	R2, Offset(_STPS+280)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC6RS+0)(GP)
;Stepper.c,249 :: 		TMR3   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR3+0)(GP)
;Stepper.c,250 :: 		OC6CON =  0x800C; //restart the output compare module
ORI	R2, R0, 32780
SW	R2, Offset(OC6CON+0)(GP)
;Stepper.c,251 :: 		break;
J	L_Stepper_toggleOCx45
NOP	
;Stepper.c,252 :: 		case C:
L_Stepper_toggleOCx51:
;Stepper.c,253 :: 		OC8R   = 0x5;
ORI	R2, R0, 5
SW	R2, Offset(OC8R+0)(GP)
;Stepper.c,254 :: 		OC8RS  = STPS[C].step_delay & 0xFFFF;
LW	R2, Offset(_STPS+348)(GP)
ANDI	R2, R2, 65535
SW	R2, Offset(OC8RS+0)(GP)
;Stepper.c,255 :: 		TMR7   =  0xFFFF;
ORI	R2, R0, 65535
SW	R2, Offset(TMR7+0)(GP)
;Stepper.c,256 :: 		OC8CON =  0x800C; //restart the output compare module
ORI	R2, R0, 32780
SW	R2, Offset(OC8CON+0)(GP)
;Stepper.c,257 :: 		break;
J	L_Stepper_toggleOCx45
NOP	
;Stepper.c,258 :: 		default:
...
_Step_Cycle:
;Stepper.c,269 :: 		void Step_Cycle(int axis_No){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Stepper.c,270 :: 		toggleOCx(axis_No);
JAL	Stepper_toggleOCx+0
NOP	
;Stepper.c,272 :: 		STPS[axis_No].step_count++;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 1
SW	R2, 0(R3)
;Stepper.c,274 :: 		STPS[axis_No].steps_abs_position += STPS[axis_No].axis_dir;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
; end of _Step_Cycle
Stepper_Pulse:
;Stepper.c,279 :: 		static int Pulse(int axis_No){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Stepper.c,281 :: 		switch(STPS[axis_No].run_state) {
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
J	L_Stepper_Pulse53
NOP	
;Stepper.c,282 :: 		case STOP:
L_Stepper_Pulse55:
;Stepper.c,284 :: 		StopAxis(axis_No);
JAL	_StopAxis+0
NOP	
;Stepper.c,287 :: 		bit_false(SV.mode_complete,bit(axis_No));
SEH	R3, R25
ORI	R2, R0, 1
SLLV	R2, R2, R3
NOR	R3, R2, R0
...
J	L_Stepper_Pulse54
NOP	
;Stepper.c,289 :: 		case ACCEL:
L_Stepper_Pulse56:
;Stepper.c,291 :: 		AccDec(axis_No);
JAL	Stepper_AccDec+0
NOP	
;Stepper.c,293 :: 		if(STPS[axis_No].step_delay <= STPS[axis_No].min_delay){
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R3)
;Stepper.c,295 :: 		STPS[axis_No].run_state  = RUN;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,296 :: 		}
L_Stepper_Pulse57:
;Stepper.c,298 :: 		if(STPS[axis_No].step_count > STPS[axis_No].max_step_lim){
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,300 :: 		}
L_Stepper_Pulse58:
;Stepper.c,304 :: 		if(STPS[axis_No].step_count >= STPS[axis_No].decel_start) {
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
NOP	
L_Stepper_Pulse207:
;Stepper.c,305 :: 		STPS[axis_No].accel_count = STPS[axis_No].decel_val;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R3)
;Stepper.c,306 :: 		STPS[axis_No].rest        = 0;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 52
SW	R0, 0(R2)
;Stepper.c,307 :: 		STPS[axis_No].run_state   = DECEL;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
J	L_Stepper_Pulse54
NOP	
;Stepper.c,310 :: 		case RUN:
L_Stepper_Pulse60:
;Stepper.c,311 :: 		STPS[axis_No].step_delay = STPS[axis_No].min_delay;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R3)
;Stepper.c,314 :: 		if(STPS[axis_No].step_count >= STPS[axis_No].decel_start) {
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
NOP	
L_Stepper_Pulse208:
;Stepper.c,315 :: 		STPS[axis_No].accel_count = STPS[axis_No].decel_val;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R3)
;Stepper.c,316 :: 		STPS[axis_No].rest        = 0;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 52
SW	R0, 0(R2)
;Stepper.c,317 :: 		STPS[axis_No].run_state =  DECEL;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
NOP	
L_Stepper_Pulse61:
;Stepper.c,319 :: 		else  if(STPS[axis_No].step_count >= STPS[axis_No].dist) {
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
NOP	
L_Stepper_Pulse209:
;Stepper.c,320 :: 		STPS[axis_No].run_state =  STOP;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
J	L_Stepper_Pulse54
NOP	
;Stepper.c,323 :: 		case DECEL:
L_Stepper_Pulse64:
;Stepper.c,325 :: 		AccDec(axis_No);
JAL	Stepper_AccDec+0
NOP	
;Stepper.c,327 :: 		if(STPS[axis_No].accel_count >= -1 || STPS[axis_No].step_count >= STPS[axis_No].dist ){
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
L_Stepper_Pulse123:
L_Stepper_Pulse122:
;Stepper.c,328 :: 		STPS[axis_No].run_state = STOP;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
Stepper_AccDec:
;Stepper.c,338 :: 		static void AccDec(int axis_No){
;Stepper.c,339 :: 		STPS[axis_No].accel_count++;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 1
SW	R2, 0(R3)
;Stepper.c,340 :: 		STPS[axis_No].step_delay = STPS[axis_No].step_delay - (( STPS[axis_No].step_delay << 1) + STPS[axis_No].rest)/((STPS[axis_No].accel_count << 2) + 1);
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
SUBU	R2, R4, R2
SW	R2, 0(R5)
;Stepper.c,341 :: 		STPS[axis_No].rest = ((STPS[axis_No].step_delay << 1)+STPS[axis_No].rest)%((STPS[axis_No].accel_count << 2 ) + 1);
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
JAL	Stepper_Pulse+0
NOP	
;Stepper.c,432 :: 		if(STPS[axis].step_count >= STPS[axis].dist)
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,441 :: 		void Start_Interpolation(int axisA,int axisB){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Stepper.c,442 :: 		Axis_Interpolate(axisA,axisB);
JAL	Stepper_Axis_Interpolate+0
NOP	
;Stepper.c,443 :: 		}
...
;Stepper.c,445 :: 		static void Axis_Interpolate(int axisA,int axisB){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Stepper.c,448 :: 		cnt++;
...
;Stepper.c,454 :: 		if(STPS[axisA].dist >= STPS[axisB].dist){//SV.dA >= SV.dB){
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,455 :: 		if(STPS[axisA].step_count < STPS[axisA].dist){
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,456 :: 		Step_Cycle(axisA);
JAL	_Step_Cycle+0
NOP	
;Stepper.c,457 :: 		if(STPS[axisB].step_count >= STPS[axisB].dist)
SEH	R3, R26
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,462 :: 		if(!SV.cir)Pulse(axisA);
LBU	R2, Offset(_SV+0)(GP)
EXT	R2, R2, 1, 1
...
;Stepper.c,464 :: 		if(STPS[axisA].step_count >= STPS[axisA].dist)
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,469 :: 		SV.dif += BresIncVal(STPS[axisB].dist);//SV.dB);//2*SV.dy;//
SEH	R3, R26
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,471 :: 		if(STPS[axisB].step_count < STPS[axisB].dist){
SEH	R3, R26
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,472 :: 		STPS[axisB].step_delay = STPS[axisA].step_delay;
SEH	R3, R26
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,473 :: 		STPS[axisB].accel_count = STPS[axisA].accel_count;
SEH	R3, R26
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,474 :: 		Step_Cycle(axisB);
SH	R25, 4(SP)
SEH	R25, R26
JAL	_Step_Cycle+0
NOP	
LH	R25, 4(SP)
;Stepper.c,475 :: 		SV.dif += BresDiffVal(STPS[axisB].dist,STPS[axisA].dist);//SV.dB,SV.dA);//2 * (SV.dy - SV.dx);//
SEH	R3, R26
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,479 :: 		if(STPS[axisB].step_count < STPS[axisB].dist){
SEH	R3, R26
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,480 :: 		Step_Cycle(axisB);
SH	R25, 4(SP)
SEH	R25, R26
JAL	_Step_Cycle+0
NOP	
LH	R25, 4(SP)
;Stepper.c,481 :: 		if(STPS[axisA].step_count >= STPS[axisA].dist)
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,482 :: 		StopAxis(axisA);
JAL	_StopAxis+0
NOP	
L_Stepper_Axis_Interpolate114:
;Stepper.c,483 :: 		}
L_Stepper_Axis_Interpolate113:
;Stepper.c,486 :: 		if(!SV.cir)Pulse(axisB);
LBU	R2, Offset(_SV+0)(GP)
EXT	R2, R2, 1, 1
...
;Stepper.c,488 :: 		if(STPS[axisB].step_count >= STPS[axisB].dist)
SEH	R3, R26
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,493 :: 		SV.dif += BresIncVal(STPS[axisA].dist);//SV.dA);//2 * SV.dx;//
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,495 :: 		if(STPS[axisA].step_count < STPS[axisA].dist){
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Stepper.c,496 :: 		STPS[axisA].step_delay = STPS[axisB].step_delay;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,497 :: 		STPS[axisA].accel_count = STPS[axisB].accel_count;
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Stepper.c,498 :: 		Step_Cycle(axisA);
JAL	_Step_Cycle+0
NOP	
;Stepper.c,499 :: 		SV.dif += BresDiffVal(STPS[axisA].dist,STPS[axisB].dist);//SV.dA,SV.dB);//2 * (SV.dx - SV.dy);//
SEH	R3, R25
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
