...
L_dma_printf11:
;Serial_Dma.c,261 :: 		buff[j] = (char)va_arg(va,char);
ADDIU	R3, SP, 44
SEH	R2, R8
ADDU	R5, R3, R2
ADDIU	R4, SP, 40
...
L_dma_printf12:
;Serial_Dma.c,266 :: 		IntToStr(va_arg(va,int),tmp);
; j start address is: 32 (R8)
ADDIU	R5, SP, 16
ADDIU	R4, SP, 40
LW	R3, 0(R4)
...
JAL	_IntToStr+0
NOP	
;Serial_Dma.c,267 :: 		strcat(&buff[j], tmp);
ADDIU	R4, SP, 16
ADDIU	R3, SP, 44
SEH	R2, R8
ADDU	R2, R3, R2
...
; j end address is: 32 (R8)
; j start address is: 8 (R2)
;Serial_Dma.c,269 :: 		break;
SEH	R8, R2
; j end address is: 8 (R2)
J	L_dma_printf10
NOP	
;Serial_Dma.c,270 :: 		case 'l':
L_dma_printf13:
;Serial_Dma.c,272 :: 		LongToStr(va_arg(va,long),tmp);
; j start address is: 32 (R8)
ADDIU	R5, SP, 16
ADDIU	R4, SP, 40
LW	R3, 0(R4)
...
L_dma_printf14:
;Serial_Dma.c,277 :: 		IntToHex(va_arg(va,int),tmp);
; j start address is: 32 (R8)
ADDIU	R5, SP, 16
ADDIU	R4, SP, 40
LW	R3, 0(R4)
...
JAL	_IntToHex+0
NOP	
;Serial_Dma.c,278 :: 		strcat(&buff[j], tmp);
ADDIU	R4, SP, 16
ADDIU	R3, SP, 44
SEH	R2, R8
ADDU	R2, R3, R2
...
; j end address is: 32 (R8)
; j start address is: 8 (R2)
;Serial_Dma.c,280 :: 		break;
SEH	R8, R2
; j end address is: 8 (R2)
J	L_dma_printf10
NOP	
;Serial_Dma.c,281 :: 		case 'X':
L_dma_printf15:
;Serial_Dma.c,283 :: 		LongIntToHex(va_arg(va,long),tmp);
; j start address is: 32 (R8)
ADDIU	R5, SP, 16
ADDIU	R4, SP, 40
LW	R3, 0(R4)
...
JAL	_LongIntToHex+0
NOP	
;Serial_Dma.c,284 :: 		strcat(&buff[j], tmp);
ADDIU	R4, SP, 16
ADDIU	R3, SP, 44
SEH	R2, R8
ADDU	R2, R3, R2
...
; j end address is: 32 (R8)
; j start address is: 8 (R2)
;Serial_Dma.c,286 :: 		break;
SEH	R8, R2
; j end address is: 8 (R2)
J	L_dma_printf10
NOP	
;Serial_Dma.c,287 :: 		case 'f':
L_dma_printf16:
;Serial_Dma.c,288 :: 		case 'F':
; j start address is: 32 (R8)
L_dma_printf17:
;Serial_Dma.c,290 :: 		FloatToStr(va_arg(va,double),tmp);
ADDIU	R5, SP, 16
ADDIU	R4, SP, 40
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
JAL	_FloatToStr+0
NOP	
;Serial_Dma.c,291 :: 		strcat(&buff[j], tmp);
ADDIU	R4, SP, 16
ADDIU	R3, SP, 44
SEH	R2, R8
ADDU	R2, R3, R2
...
; j end address is: 32 (R8)
; j start address is: 8 (R2)
;Serial_Dma.c,293 :: 		break;
SEH	R8, R2
; j end address is: 8 (R2)
J	L_dma_printf10
NOP	
;Serial_Dma.c,294 :: 		case 's':
L_dma_printf18:
;Serial_Dma.c,296 :: 		str_arg = va_arg( va, char* );
; j start address is: 32 (R8)
ADDIU	R4, SP, 40
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
LW	R4, 0(R3)
SW	R4, 36(SP)
;Serial_Dma.c,297 :: 		strcat(&buff[j], str_arg);
ADDIU	R3, SP, 44
SEH	R2, R8
ADDU	R2, R3, R2
MOVZ	R26, R4, R0
...
JAL	_strcat+0
NOP	
;Serial_Dma.c,298 :: 		j += strlen(str_arg);
LW	R25, 36(SP)
JAL	_strlen+0
NOP	
ADDU	R2, R8, R2
...
L__dma_printf22:
L__dma_printf21:
;Serial_Dma.c,307 :: 		buff[j] = 0;
ADDIU	R3, SP, 44
SEH	R2, R8
ADDU	R2, R3, R2
SB	R0, 0(R2)
;Serial_Dma.c,308 :: 		strncpy(txBuf,buff,j);
SEH	R27, R8
MOVZ	R26, R3, R0
LUI	R25, 40960
ORI	R25, R25, 8704
JAL	_strncpy+0
NOP	
;Serial_Dma.c,309 :: 		DCH1SSIZ    = j ;
SEH	R2, R8
SW	R2, Offset(DCH1SSIZ+0)(GP)
;Serial_Dma.c,310 :: 		DMA1_Enable();
JAL	_DMA1_Enable+0
NOP	
;Serial_Dma.c,311 :: 		return j;
SEH	R2, R8
; j end address is: 32 (R8)
;Serial_Dma.c,313 :: 		}
;Serial_Dma.c,311 :: 		return j;
