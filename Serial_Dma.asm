...
;Serial_Dma.c,52 :: 		DCH0DAT       =  0x0D;//'\r';
ORI	R2, R0, 13
...
ADDIU	SP, SP, -260
SW	RA, 0(SP)
;Serial_Dma.c,316 :: 		int i = 0, j = 0;
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
;Serial_Dma.c,317 :: 		char buff[200]={0},tmp[20],tmp1[9];
ADDIU	R23, SP, 56
ADDIU	R22, R23, 200
...
NOP	
L__dma_printf79:
;Serial_Dma.c,338 :: 		i++;  //step over % char
ADDIU	R2, R5, 1
; i end address is: 20 (R5)
...
; j end address is: 48 (R12)
; j start address is: 8 (R2)
;Serial_Dma.c,350 :: 		break;
SEH	R12, R2
; j end address is: 8 (R2)
J	L_dma_printf19
NOP	
;Serial_Dma.c,351 :: 		case 'u':
L_dma_printf22:
;Serial_Dma.c,353 :: 		sprintf(tmp1,"%u",va_arg(va,unsigned int));
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
NOP	
ADDIU	SP, SP, 12
;Serial_Dma.c,354 :: 		strcat(buff+j, tmp1);
ADDIU	R4, SP, 40
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
JAL	_strcat+0
NOP	
;Serial_Dma.c,355 :: 		j += strlen(tmp1);
ADDIU	R2, SP, 40
MOVZ	R25, R2, R0
JAL	_strlen+0
NOP	
...
;Serial_Dma.c,356 :: 		case 'l':
L_dma_printf23:
;Serial_Dma.c,358 :: 		sprintf(tmp,"%ld",va_arg(va,long));
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
NOP	
ADDIU	SP, SP, 12
;Serial_Dma.c,360 :: 		strcat(buff+j, tmp);
ADDIU	R4, SP, 20
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
; j end address is: 48 (R12)
; j start address is: 8 (R2)
;Serial_Dma.c,362 :: 		break;
SEH	R12, R2
; j end address is: 8 (R2)
J	L_dma_printf19
NOP	
;Serial_Dma.c,363 :: 		case 'X':
L_dma_printf24:
;Serial_Dma.c,365 :: 		sprintf(tmp,"%X",va_arg(va,int));
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
NOP	
ADDIU	SP, SP, 12
;Serial_Dma.c,366 :: 		strcat(buff+j, tmp);
ADDIU	R4, SP, 20
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
; j end address is: 48 (R12)
; j start address is: 8 (R2)
;Serial_Dma.c,368 :: 		break;
SEH	R12, R2
; j end address is: 8 (R2)
J	L_dma_printf19
NOP	
;Serial_Dma.c,369 :: 		case 'X':
L_dma_printf25:
;Serial_Dma.c,371 :: 		sprintf(tmp,"%lX",va_arg(va,long));
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
NOP	
ADDIU	SP, SP, 12
;Serial_Dma.c,372 :: 		strcat(buff+j, tmp);
ADDIU	R4, SP, 20
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
; j end address is: 48 (R12)
; j start address is: 8 (R2)
;Serial_Dma.c,374 :: 		break;
SEH	R12, R2
; j end address is: 8 (R2)
J	L_dma_printf19
NOP	
;Serial_Dma.c,375 :: 		case 'f':
L_dma_printf26:
;Serial_Dma.c,376 :: 		sprintf(tmp,"%f",va_arg(va,float));
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
NOP	
ADDIU	SP, SP, 12
;Serial_Dma.c,377 :: 		strcat(buff+j, tmp);
ADDIU	R4, SP, 20
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
; j end address is: 48 (R12)
; j start address is: 8 (R2)
;Serial_Dma.c,379 :: 		break;
SEH	R12, R2
; j end address is: 8 (R2)
J	L_dma_printf19
NOP	
;Serial_Dma.c,380 :: 		case 'F':
L_dma_printf27:
;Serial_Dma.c,381 :: 		sprintf(tmp,"%E",va_arg(va,double));
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
NOP	
ADDIU	SP, SP, 12
;Serial_Dma.c,382 :: 		strcat(buff+j, tmp);
ADDIU	R4, SP, 20
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
; j end address is: 48 (R12)
; j start address is: 8 (R2)
;Serial_Dma.c,384 :: 		break;
SEH	R12, R2
; j end address is: 8 (R2)
J	L_dma_printf19
NOP	
;Serial_Dma.c,385 :: 		case 'p':
L_dma_printf28:
;Serial_Dma.c,386 :: 		sprintf(tmp,"%p",va_arg(va,void*));
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
NOP	
ADDIU	SP, SP, 12
;Serial_Dma.c,387 :: 		strcat(buff+j, tmp);
ADDIU	R4, SP, 20
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
; j end address is: 48 (R12)
; j start address is: 8 (R2)
;Serial_Dma.c,389 :: 		break;
SEH	R12, R2
; j end address is: 8 (R2)
J	L_dma_printf19
NOP	
;Serial_Dma.c,390 :: 		case 's':
L_dma_printf29:
;Serial_Dma.c,392 :: 		str_arg = va_arg( va, char* );
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
LW	R4, 0(R3)
SW	R4, 52(SP)
;Serial_Dma.c,393 :: 		strcat(buff+j, str_arg);
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
MOVZ	R26, R4, R0
...
JAL	_strcat+0
NOP	
;Serial_Dma.c,394 :: 		j += strlen(str_arg);
LW	R25, 52(SP)
JAL	_strlen+0
NOP	
ADDU	R2, R12, R2
...
NOP	
L_dma_printf16:
;Serial_Dma.c,403 :: 		*(buff+j+1) = 0;
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
ADDIU	R2, R2, 1
SB	R0, 0(R2)
;Serial_Dma.c,404 :: 		strncpy(txBuf,buff,j+1);
ADDIU	R2, R12, 1
SEH	R27, R2
MOVZ	R26, R3, R0
LUI	R25, 40960
...
JAL	_strncpy+0
NOP	
;Serial_Dma.c,405 :: 		DCH1SSIZ    = j ;
SEH	R2, R12
SW	R2, Offset(DCH1SSIZ+0)(GP)
;Serial_Dma.c,406 :: 		DMA1_Enable();
JAL	_DMA1_Enable+0
NOP	
;Serial_Dma.c,407 :: 		return j;
SEH	R2, R12
; j end address is: 48 (R12)
;Serial_Dma.c,409 :: 		}
;Serial_Dma.c,407 :: 		return j;
...
; end of _dma_printf
_lTrim:
;Serial_Dma.c,413 :: 		void lTrim(char *d,char* s){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Serial_Dma.c,415 :: 		int i=0,j,k;
; i start address is: 20 (R5)
MOVZ	R5, R0, R0
;Serial_Dma.c,416 :: 		k = i;
; k start address is: 24 (R6)
SEH	R6, R5
;Serial_Dma.c,417 :: 		j = strlen(s);
SW	R25, 4(SP)
MOVZ	R25, R26, R0
JAL	_strlen+0
NOP	
...
NOP	
L__lTrim102:
;Serial_Dma.c,419 :: 		if((*s > 0x30)||(k>0)){
LBU	R2, 0(R26)
ANDI	R2, R2, 255
SLTIU	R2, R2, 49
...
L__lTrim42:
L__lTrim41:
;Serial_Dma.c,420 :: 		k = 1;
; k start address is: 12 (R3)
ORI	R3, R0, 1
;Serial_Dma.c,421 :: 		*d = *s;
LBU	R2, 0(R26)
SB	R2, 0(R25)
;Serial_Dma.c,422 :: 		d++;
ADDIU	R2, R25, 1
MOVZ	R25, R2, R0
;Serial_Dma.c,423 :: 		}else
J	L_lTrim36
NOP	
L_lTrim35:
;Serial_Dma.c,424 :: 		i++;
