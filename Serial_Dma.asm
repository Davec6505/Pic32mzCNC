...
L_dma_printf15:
;Serial_Dma.c,290 :: 		sprintf(tmp1,"%d",va_arg(va,unsigned int));
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
NOP	
ADDIU	SP, SP, 12
;Serial_Dma.c,291 :: 		strcat(buff+j, tmp1);
ADDIU	R4, SP, 40
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
JAL	_strcat+0
NOP	
;Serial_Dma.c,292 :: 		j += strlen(tmp1);
ADDIU	R2, SP, 40
MOVZ	R25, R2, R0
JAL	_strlen+0
NOP	
...
;Serial_Dma.c,293 :: 		case 'l':
L_dma_printf16:
;Serial_Dma.c,295 :: 		sprintl(tmp,"%d",va_arg(va,long));
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
NOP	
ADDIU	SP, SP, 12
;Serial_Dma.c,298 :: 		strcat(buff+j, tmp_);
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
LW	R26, 52(SP)
...
JAL	_strcat+0
NOP	
;Serial_Dma.c,299 :: 		j += strlen(tmp_);
LW	R25, 52(SP)
JAL	_strlen+0
NOP	
ADDU	R2, R12, R2
...
L_dma_printf17:
;Serial_Dma.c,302 :: 		IntToHex(va_arg(va,int),tmp);
; j start address is: 48 (R12)
ADDIU	R5, SP, 20
ADDIU	R4, SP, 16
LW	R3, 0(R4)
...
JAL	_IntToHex+0
NOP	
;Serial_Dma.c,303 :: 		strcat(buff+j, tmp);
ADDIU	R4, SP, 20
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
; j end address is: 48 (R12)
; j start address is: 8 (R2)
;Serial_Dma.c,305 :: 		break;
SEH	R12, R2
; j end address is: 8 (R2)
J	L_dma_printf12
NOP	
;Serial_Dma.c,306 :: 		case 'X':
L_dma_printf18:
;Serial_Dma.c,308 :: 		LongIntToHex(va_arg(va,long),tmp);
; j start address is: 48 (R12)
ADDIU	R5, SP, 20
ADDIU	R4, SP, 16
LW	R3, 0(R4)
...
JAL	_LongIntToHex+0
NOP	
;Serial_Dma.c,309 :: 		strcat(buff+j, tmp);
ADDIU	R4, SP, 20
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
; j end address is: 48 (R12)
; j start address is: 8 (R2)
;Serial_Dma.c,311 :: 		break;
SEH	R12, R2
; j end address is: 8 (R2)
J	L_dma_printf12
NOP	
;Serial_Dma.c,312 :: 		case 'f':
L_dma_printf19:
;Serial_Dma.c,313 :: 		FloatToStr(va_arg(va,float),tmp);
; j start address is: 48 (R12)
ADDIU	R5, SP, 20
ADDIU	R4, SP, 16
LW	R3, 0(R4)
...
JAL	_FloatToStr+0
NOP	
;Serial_Dma.c,314 :: 		strcat(buff+j, tmp);
ADDIU	R4, SP, 20
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
...
; j end address is: 48 (R12)
; j start address is: 8 (R2)
;Serial_Dma.c,316 :: 		break;
SEH	R12, R2
; j end address is: 8 (R2)
J	L_dma_printf12
NOP	
;Serial_Dma.c,317 :: 		case 'F':
L_dma_printf20:
;Serial_Dma.c,319 :: 		FloatToStr(va_arg(va,double),tmp);
; j start address is: 48 (R12)
ADDIU	R5, SP, 20
ADDIU	R4, SP, 16
LW	R3, 0(R4)
...
J	L_dma_printf12
NOP	
;Serial_Dma.c,323 :: 		case 's':
L_dma_printf21:
;Serial_Dma.c,325 :: 		str_arg = va_arg( va, char* );
; j start address is: 48 (R12)
ADDIU	R4, SP, 16
LW	R3, 0(R4)
ADDIU	R2, R3, 4
...
LW	R4, 0(R3)
SW	R4, 48(SP)
;Serial_Dma.c,326 :: 		strcat(buff+j, str_arg);
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
MOVZ	R26, R4, R0
...
JAL	_strcat+0
NOP	
;Serial_Dma.c,327 :: 		j += strlen(str_arg);
LW	R25, 48(SP)
JAL	_strlen+0
NOP	
ADDU	R2, R12, R2
...
NOP	
L_dma_printf9:
;Serial_Dma.c,336 :: 		*(buff+j) = 0;
ADDIU	R3, SP, 56
SEH	R2, R12
ADDU	R2, R3, R2
SB	R0, 0(R2)
;Serial_Dma.c,337 :: 		strncpy(txBuf,buff,j);
SEH	R27, R12
MOVZ	R26, R3, R0
LUI	R25, 40960
ORI	R25, R25, 8704
JAL	_strncpy+0
NOP	
;Serial_Dma.c,338 :: 		DCH1SSIZ    = j ;
SEH	R2, R12
SW	R2, Offset(-1082060432)(GP)
;Serial_Dma.c,339 :: 		DMA1_Enable();
JAL	_DMA1_Enable+0
NOP	
;Serial_Dma.c,340 :: 		return j;
SEH	R2, R12
; j end address is: 48 (R12)
;Serial_Dma.c,342 :: 		}
;Serial_Dma.c,340 :: 		return j;
...
; end of _dma_printf
_lTrim:
;Serial_Dma.c,346 :: 		void lTrim(char *d,char* s){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Serial_Dma.c,348 :: 		int i=0,j,k;
; i start address is: 20 (R5)
MOVZ	R5, R0, R0
;Serial_Dma.c,349 :: 		k = i;
; k start address is: 24 (R6)
SEH	R6, R5
;Serial_Dma.c,350 :: 		j = strlen(s);
SW	R25, 4(SP)
MOVZ	R25, R26, R0
JAL	_strlen+0
NOP	
...
NOP	
L__lTrim80:
;Serial_Dma.c,352 :: 		if((*s > 0x30)||(k>0)){
LBU	R2, 0(R26)
ANDI	R2, R2, 255
SLTIU	R2, R2, 49
...
L__lTrim33:
L__lTrim32:
;Serial_Dma.c,353 :: 		k = 1;
; k start address is: 12 (R3)
ORI	R3, R0, 1
;Serial_Dma.c,354 :: 		*d = *s;
LBU	R2, 0(R26)
SB	R2, 0(R25)
;Serial_Dma.c,355 :: 		d++;
ADDIU	R2, R25, 1
MOVZ	R25, R2, R0
;Serial_Dma.c,356 :: 		}else
J	L_lTrim28
NOP	
L_lTrim27:
;Serial_Dma.c,357 :: 		i++;
...
NOP	
L_lTrim24:
;Serial_Dma.c,360 :: 		if(i == j){
SEH	R3, R5
; i end address is: 20 (R5)
SEH	R2, R4
; j end address is: 16 (R4)
BEQ	R3, R2, L__lTrim83
NOP	
J	L_lTrim29
NOP	
L__lTrim83:
;Serial_Dma.c,361 :: 		*d = '0';
ORI	R2, R0, 48
SB	R2, 0(R25)
;Serial_Dma.c,362 :: 		d++;
ADDIU	R2, R25, 1
