...
; ?FLOC___Sample_Ringbuffer?T223 start address is: 12 (R3)
ORI	R3, R0, 1
; ?FLOC___Sample_Ringbuffer?T223 end address is: 12 (R3)
...
; ?FLOC___Sample_Ringbuffer?T352 start address is: 12 (R3)
ORI	R3, R0, 1
; ?FLOC___Sample_Ringbuffer?T352 end address is: 12 (R3)
...
; ?FLOC___Sample_Ringbuffer?T458 start address is: 8 (R2)
ORI	R2, R0, 20
; ?FLOC___Sample_Ringbuffer?T458 end address is: 8 (R2)
...
; ?FLOC___Sample_Ringbuffer?T571 start address is: 8 (R2)
SEH	R2, R3
; modal_response end address is: 12 (R3)
; ?FLOC___Sample_Ringbuffer?T571 end address is: 8 (R2)
