...
;Globals.c,79 :: 		settings.default_feed_rate = DEFAULT_FEEDRATE;
LUI	R2, 17274
ORI	R2, R2, 0
SW	R2, Offset(_settings+8)(GP)
;Globals.c,80 :: 		buffA[D_FEED_RATE_OFFSET]  = flt2ulong(settings.default_feed_rate);
LUI	R2, 17274
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_flt2ulong+0
...
;Globals.c,82 :: 		settings.default_seek_rate = DEFAULT_RAPID_FEEDRATE;
LUI	R2, 17402
ORI	R2, R2, 0
SW	R2, Offset(_settings+12)(GP)
;Globals.c,83 :: 		buffA[D_SEEK_RATE_OFFSET]  = flt2ulong(settings.default_seek_rate);
LUI	R2, 17402
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_flt2ulong+0
...
;Globals.c,85 :: 		settings.homing_feed_rate   = DEFAULT_HOMING_FEEDRATE;
LUI	R2, 16840
ORI	R2, R2, 0
...
;Globals.c,88 :: 		settings.homing_seek_rate   = DEFAULT_HOMING_RAPID_FEEDRATE ;
LUI	R2, 17274
ORI	R2, R2, 0
...
;Globals.c,91 :: 		settings.homing_pulloff     = DEFAULT_HOMING_PULLOFF;
LUI	R2, 16256
ORI	R2, R2, 0
...
;Globals.c,94 :: 		settings.mm_per_arc_segment = DEFAULT_MM_PER_ARC_SEGMENT;
LUI	R2, 15820
ORI	R2, R2, 52429
...
;Globals.c,97 :: 		settings.acceleration      = DEFAULT_ACCELERATION;
LUI	R2, 18188
ORI	R2, R2, 40960
...
;Globals.c,100 :: 		settings.junction_deviation = DEFAULT_JUNCTION_DEVIATION;
LUI	R2, 15692
ORI	R2, R2, 52429
...
;Globals.c,104 :: 		settings.n_arc_correction   = DEFAULT_N_ARC_CORRECTION;
ORI	R2, R0, 25
SH	R2, Offset(_settings+40)(GP)
;Globals.c,105 :: 		buffA[N_ARC_CORREC_OFFSET]  = (unsigned long)N_ARC_CORREC_OFFSET;
ORI	R2, R0, 79
SW	R2, Offset(-1610612420)(GP)
;Globals.c,107 :: 		settings.stepper_idle_lock_time = DEFAULT_STEPPER_IDLE_LOCK_TIME; // If max value 255, steppers do not disable.
ORI	R2, R0, 25
...
;Globals.c,126 :: 		if (DEFAULT_REPORT_INCHES)    {settings.flags |= BITFLAG_REPORT_INCHES;}
L_settings_init3:
;Globals.c,131 :: 		if (DEFAULT_AUTO_START)       { settings.flags |= (BITFLAG_AUTO_START);}
...
L__settings_init129:
; has_data end address is: 8 (R2)
;Globals.c,170 :: 		has_data = (unsigned long)NVMWriteRow(&add,buffA);
SB	R25, 12(SP)
LUI	R26, 40960
ORI	R26, R26, 0
LUI	R25, hi_addr(Globals_add+0)
...
; has_data start address is: 12 (R3)
MOVZ	R3, R2, R0
;Globals.c,171 :: 		retry_flash_write++;
LH	R2, 14(SP)
ADDIU	R2, R2, 1
SH	R2, 14(SP)
;Globals.c,178 :: 		if(retry_flash_write > FLASH_RETRY_COUNT)break;
SEH	R2, R2
SLTI	R2, R2, 3
...
L__settings_init132:
; has_data end address is: 8 (R2)
;Globals.c,184 :: 		set_ram_loaded_indicator(read_row_from_flash(add));
...
;Globals.c,185 :: 		}
L_settings_init11:
;Globals.c,187 :: 		settings.steps_per_mm[X]        = ulong2flt(buffA[SPMMX_OFFSET]);
LW	R25, Offset(-1610612480)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+0)(GP)
;Globals.c,188 :: 		settings.steps_per_mm[Y]        = ulong2flt(buffA[SPMMY_OFFSET]);
LW	R25, Offset(-1610612476)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+4)(GP)
;Globals.c,189 :: 		settings.steps_per_mm[Z]        = ulong2flt(buffA[SPMMZ_OFFSET]);
LW	R25, Offset(-1610612472)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+8)(GP)
;Globals.c,191 :: 		settings.default_feed_rate      = ulong2flt(buffA[D_FEED_RATE_OFFSET]);
LW	R25, Offset(-1610612452)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+8)(GP)
;Globals.c,192 :: 		settings.default_seek_rate      = ulong2flt(buffA[D_SEEK_RATE_OFFSET]);
LW	R25, Offset(-1610612448)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+12)(GP)
;Globals.c,193 :: 		settings.homing_feed_rate       = ulong2flt(buffA[H_FEED_RATE_OFFSET]);
LW	R25, Offset(-1610612444)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+16)(GP)
;Globals.c,194 :: 		settings.homing_seek_rate       = ulong2flt(buffA[H_SEEK_RATE_OFFSET]);
LW	R25, Offset(-1610612440)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+20)(GP)
;Globals.c,195 :: 		settings.homing_pulloff         = ulong2flt(buffA[H_PULL_OFF_OFFSET]);
LW	R25, Offset(-1610612436)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+24)(GP)
;Globals.c,196 :: 		settings.mm_per_arc_segment     = ulong2flt(buffA[MM_ARC_SEG_OFFSET]);
LW	R25, Offset(-1610612432)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+28)(GP)
;Globals.c,197 :: 		settings.acceleration           = ulong2flt(buffA[ACCELERATION_OFFSET]);
LW	R25, Offset(-1610612428)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+32)(GP)
;Globals.c,198 :: 		settings.junction_deviation     = ulong2flt(buffA[JUNCTION_DEV_OFFSET]);
LW	R25, Offset(-1610612424)(GP)
JAL	_ulong2flt+0
NOP	
SWC1	S0, Offset(_settings+36)(GP)
;Globals.c,199 :: 		settings.n_arc_correction       = (unsigned int)buffA[N_ARC_CORREC_OFFSET];
LW	R2, Offset(-1610612420)(GP)
SH	R2, Offset(_settings+40)(GP)
;Globals.c,200 :: 		settings.flags                  = ((unsigned int)buffA[0x50]);//FLAGS_OFFSET]);
LW	R2, Offset(-1610612416)(GP)
SH	R2, Offset(_settings+42)(GP)
;Globals.c,201 :: 		settings.stepper_idle_lock_time = (unsigned int)buffA[STEP_IDLE_DLY_OFFSET];// If max value 255, steppers do not disable.
LW	R2, Offset(-1610612412)(GP)
SH	R2, Offset(_settings+48)(GP)
;Globals.c,202 :: 		settings.microsteps             = (unsigned int)buffA[MICROSTEPS_OFFSET];
LW	R2, Offset(-1610612400)(GP)
SH	R2, Offset(_settings+50)(GP)
;Globals.c,203 :: 		settings.p_usec                 = (unsigned int)buffA[P_USEC_OFFSET];
LW	R2, Offset(-1610612456)(GP)
SH	R2, Offset(_settings+52)(GP)
;Globals.c,204 :: 		settings.decimal_places         = (unsigned int)buffA[DEC_PLACES_OFFSET];
LW	R2, Offset(-1610612392)(GP)
SH	R2, Offset(_settings+54)(GP)
;Globals.c,205 :: 		settings.homing_debounce_delay  = (unsigned int)buffA[H_DEBNC_DLY_OFFSET];
LW	R2, Offset(-1610612408)(GP)
SH	R2, Offset(_settings+46)(GP)
;Globals.c,206 :: 		settings.homing_dir_mask        = (unsigned int)buffA[HOME_DIR_MASK_OFFSET];
LW	R2, Offset(-1610612388)(GP)
SH	R2, Offset(_settings+56)(GP)
;Globals.c,207 :: 		settings.invert_mask            = (unsigned int)buffA[INVERT_MASK_OFFSET];
...
;Globals.c,222 :: 		static int set_ram_loaded_indicator(int val){
;Globals.c,223 :: 		ram_loaded = val;
SH	R25, Offset(Globals_ram_loaded+0)(GP)
;Globals.c,224 :: 		return ram_loaded;
...
;Globals.c,228 :: 		static void zero_ram_loaded_indicator(){
;Globals.c,229 :: 		ram_loaded = 0;
...
;Globals.c,233 :: 		int read_ram_loaded_indicator(){
;Globals.c,234 :: 		return ram_loaded;
LH	R2, Offset(Globals_ram_loaded+0)(GP)
;Globals.c,235 :: 		}
...
;Globals.c,241 :: 		static void set_coord_data_read_indicator(int flag){
;Globals.c,242 :: 		bit_true(coord_read,flag);
...
;Globals.c,246 :: 		static void rst_single_coord_read_indicators(int flag){
;Globals.c,247 :: 		bit_false(coord_read,flag);
NOR	R3, R25, R0
LH	R2, Offset(Globals_coord_read+0)(GP)
AND	R2, R2, R3
SH	R2, Offset(Globals_coord_read+0)(GP)
...
;Globals.c,251 :: 		static void rst_coord_read_indicator(){
;Globals.c,252 :: 		coord_read = 0;
...
;Globals.c,256 :: 		int read_coord_data_indicator(){
;Globals.c,257 :: 		return coord_read;
LH	R2, Offset(Globals_coord_read+0)(GP)
;Globals.c,258 :: 		}
...
;Globals.c,268 :: 		int read_row_from_flash(unsigned long addr){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Globals.c,272 :: 		ptr = addr;
; ptr start address is: 16 (R4)
MOVZ	R4, R25, R0
;Globals.c,273 :: 		data_count = 0;
; data_count start address is: 20 (R5)
MOVZ	R5, R0, R0
;Globals.c,274 :: 		for(j = 0;j < 512;j++){
...
LW	R2, 0(R2)
SW	R2, 0(R3)
;Globals.c,276 :: 		if(buffA[j] != -1)data_count++;
LW	R2, Offset(_j+0)(GP)
SLL	R3, R2, 2
LUI	R2, 40960
ORI	R2, R2, 0
...
;Globals.c,285 :: 		set_ram_loaded_indicator(data_count);
SW	R25, 4(SP)
SEH	R25, R5
JAL	Globals_set_ram_loaded_indicator+0
NOP	
LW	R25, 4(SP)
;Globals.c,288 :: 		return data_count;
SEH	R2, R5
; data_count end address is: 20 (R5)
;Globals.c,289 :: 		}
...
;Globals.c,318 :: 		unsigned int settings_write_coord_data(int coord_select,float *coord){
ADDIU	SP, SP, -40
SW	RA, 0(SP)
;Globals.c,320 :: 		int res=0,recipe = 0;
SW	R25, 4(SP)
;Globals.c,321 :: 		unsigned long wdata[4]={0};
ADDIU	R23, SP, 20
ADDIU	R22, R23, 16
...
JAL	___CC2DW+0
NOP	
;Globals.c,322 :: 		unsigned long temp[4] = {0};
;Globals.c,324 :: 		add = (unsigned long)FLASH_Settings_VAddr_P1;
LUI	R2, 48411
ORI	R2, R2, 49152
SW	R2, Offset(Globals_add+0)(GP)
;Globals.c,327 :: 		recipe = coord_select;
; recipe start address is: 16 (R4)
SEH	R4, R25
;Globals.c,329 :: 		if(!read_ram_loaded_indicator()){
...
;Globals.c,331 :: 		set_ram_loaded_indicator(read_row_from_flash(add));
SH	R4, 8(SP)
LW	R25, Offset(Globals_add+0)(GP)
JAL	_read_row_from_flash+0
NOP	
...
JAL	Globals_set_ram_loaded_indicator+0
NOP	
;Globals.c,335 :: 		error = (int)NVMErasePage(&add);
SH	R4, 8(SP)
SW	R26, 12(SP)
LUI	R25, hi_addr(Globals_add+0)
ORI	R25, R25, lo_addr(Globals_add+0)
...
J	L_settings_write_coord_data19
NOP	
;Globals.c,352 :: 		case 2: add = (unsigned long)FLASH_Settings_VAddr_P2;break;
...
J	L_settings_write_coord_data19
NOP	
;Globals.c,353 :: 		case 3: add = (unsigned long)FLASH_Settings_VAddr_P3;break;
...
J	L_settings_write_coord_data19
NOP	
;Globals.c,354 :: 		case 4: add = (unsigned long)FLASH_Settings_VAddr_P4;break;
...
J	L_settings_write_coord_data19
NOP	
;Globals.c,355 :: 		case 5: add = (unsigned long)FLASH_Settings_VAddr_P5;break;
...
J	L_settings_write_coord_data19
NOP	
;Globals.c,356 :: 		case 6: add = (unsigned long)FLASH_Settings_VAddr_P6;break;
...
J	L_settings_write_coord_data19
NOP	
;Globals.c,357 :: 		case 7: add = (unsigned long)FLASH_Settings_VAddr_P7;break;
...
J	L_settings_write_coord_data19
NOP	
;Globals.c,358 :: 		case 8: add = (unsigned long)FLASH_Settings_VAddr_P8;break;
...
J	L_settings_write_coord_data19
NOP	
;Globals.c,359 :: 		case 9: add = (unsigned long)FLASH_Settings_VAddr_P9;break;
...
J	L_settings_write_coord_data19
NOP	
;Globals.c,361 :: 		case 10: add = (unsigned long)FLASH_Settings_VAddr_G281;break;
...
J	L_settings_write_coord_data19
NOP	
;Globals.c,362 :: 		case 11: add = (unsigned long)FLASH_Settings_VAddr_G301;break;
...
;Globals.c,367 :: 		wdata[i] = flt2ulong(coord[i]);
ADDIU	R3, SP, 20
LW	R2, Offset(_i+0)(GP)
SLL	R2, R2, 2
ADDU	R2, R3, R2
...
;Globals.c,384 :: 		res = NVMWriteRow(&add,buffA);
SW	R26, 8(SP)
SH	R25, 12(SP)
LUI	R26, 40960
ORI	R26, R26, 0
...
ANDI	R3, R2, 65535
;Globals.c,385 :: 		set_ram_loaded_indicator(res);
SH	R25, 8(SP)
SEH	R25, R2
JAL	Globals_set_ram_loaded_indicator+0
NOP	
LH	R25, 8(SP)
;Globals.c,401 :: 		return res;
SEH	R2, R3
...
;Globals.c,409 :: 		void settings_read_coord_data(){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Globals.c,412 :: 		if(!read_ram_loaded_indicator()){
SW	R25, 4(SP)
JAL	_read_ram_loaded_indicator+0
NOP	
...
;Globals.c,413 :: 		add = (unsigned long)FLASH_Settings_VAddr_P1;
LUI	R2, 48411
ORI	R2, R2, 49152
SW	R2, Offset(Globals_add+0)(GP)
;Globals.c,414 :: 		read_row_from_flash(add);
LW	R25, Offset(Globals_add+0)(GP)
JAL	_read_row_from_flash+0
NOP	
;Globals.c,415 :: 		}
L_settings_read_coord_data38:
;Globals.c,417 :: 		if(!read_coord_data_indicator()){
...
;Globals.c,418 :: 		unsigned long temp = 0UL;
;Globals.c,419 :: 		float value = 0.00;
;Globals.c,420 :: 		for(i = 0; i < 9; i++){
SW	R0, Offset(_i+0)(GP)
...
;Globals.c,421 :: 		for(j = 0 ; j < NoOfAxis; j++){
SW	R0, Offset(_j+0)(GP)
...
;Globals.c,422 :: 		temp = buffA[(i*NoOfAxis) + j];
LW	R2, Offset(_i+0)(GP)
SLL	R3, R2, 1
LW	R2, Offset(_j+0)(GP)
ADDU	R2, R3, R2
...
;Globals.c,426 :: 		value = ulong2flt(temp);
; temp start address is: 8 (R2)
MOVZ	R25, R2, R0
; temp end address is: 8 (R2)
JAL	_ulong2flt+0
NOP	
;Globals.c,427 :: 		coord_system[i].coord[j] = value;
LW	R2, Offset(_i+0)(GP)
SLL	R3, R2, 4
...
;Globals.c,438 :: 		set_coord_data_read_indicator(COORD_READ_FLAG);
MOVZ	R25, R0, R0
...
;Globals.c,447 :: 		unsigned int settings_write_one_coord(int coord_select,float *coord){
ADDIU	SP, SP, -36
SW	RA, 0(SP)
;Globals.c,453 :: 		recipe = coord_select * NoOfAxis;
SEH	R2, R25
SLL	R2, R2, 1
...
;Globals.c,456 :: 		j=0;
SW	R0, Offset(_j+0)(GP)
;Globals.c,457 :: 		for(i = recipe;i< recipe+NoOfAxis;i++){
SEH	R2, R2
SW	R2, Offset(_i+0)(GP)
...
;Globals.c,459 :: 		coord_data[j] = *(coord+j);
ADDIU	R4, SP, 16
LW	R2, Offset(_j+0)(GP)
SLL	R2, R2, 2
ADDU	R3, R4, R2
...
LWC1	S0, 0(R2)
SWC1	S0, 0(R3)
;Globals.c,460 :: 		temp[j] = flt2ulong(coord_data[j]);
ADDIU	R3, SP, 24
LW	R2, Offset(_j+0)(GP)
SLL	R2, R2, 2
ADDU	R2, R3, R2
...
;Globals.c,469 :: 		switch(coord_select){
J	L_settings_write_one_coord50
NOP	
;Globals.c,471 :: 		case 1: add = (unsigned long)FLASH_Settings_VAddr_P1;break;
...
NOP	
;Globals.c,472 :: 		case 2: add = (unsigned long)FLASH_Settings_VAddr_P2;break;
...
J	L_settings_write_one_coord51
NOP	
;Globals.c,473 :: 		case 3: add = (unsigned long)FLASH_Settings_VAddr_P3;break;
...
J	L_settings_write_one_coord51
NOP	
;Globals.c,474 :: 		case 4: add = (unsigned long)FLASH_Settings_VAddr_P4;break;
...
J	L_settings_write_one_coord51
NOP	
;Globals.c,475 :: 		case 5: add = (unsigned long)FLASH_Settings_VAddr_P5;break;
...
J	L_settings_write_one_coord51
NOP	
;Globals.c,476 :: 		case 6: add = (unsigned long)FLASH_Settings_VAddr_P6;break;
...
J	L_settings_write_one_coord51
NOP	
;Globals.c,477 :: 		case 7: add = (unsigned long)FLASH_Settings_VAddr_P7;break;
...
J	L_settings_write_one_coord51
NOP	
;Globals.c,478 :: 		case 8: add = (unsigned long)FLASH_Settings_VAddr_P8;break;
...
J	L_settings_write_one_coord51
NOP	
;Globals.c,479 :: 		case 9: add = (unsigned long)FLASH_Settings_VAddr_P9;break;
...
J	L_settings_write_one_coord51
NOP	
;Globals.c,481 :: 		case 10: add = (unsigned long)FLASH_Settings_VAddr_G281;break;
...
J	L_settings_write_one_coord51
NOP	
;Globals.c,482 :: 		case 11: add = (unsigned long)FLASH_Settings_VAddr_G301;break;
...
;Globals.c,485 :: 		if(!read_ram_loaded_indicator()){
JAL	_read_ram_loaded_indicator+0
NOP	
...
;Globals.c,487 :: 		set_ram_loaded_indicator(read_row_from_flash(add));
SH	R25, 4(SP)
LW	R25, Offset(Globals_add+0)(GP)
JAL	_read_row_from_flash+0
NOP	
...
NOP	
LH	R25, 4(SP)
;Globals.c,491 :: 		error = (int)NVMErasePage(&add);
SW	R26, 4(SP)
SH	R25, 8(SP)
LUI	R25, hi_addr(Globals_add+0)
ORI	R25, R25, lo_addr(Globals_add+0)
...
;Globals.c,507 :: 		set_ram_loaded_indicator(NVMWriteQuad (&add, temp));
ADDIU	R2, SP, 24
SW	R26, 4(SP)
SH	R25, 8(SP)
MOVZ	R26, R2, R0
...
;Globals.c,515 :: 		int settings_read_startup_line(int n, char *line){
ADDIU	SP, SP, -20
SW	RA, 0(SP)
;Globals.c,518 :: 		switch(n){
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
J	L_settings_read_startup_line66
NOP	
;Globals.c,519 :: 		case 0: char_add = (char*)FLASH_Settings_VAddr_SLine1;break;
...
NOP	
;Globals.c,520 :: 		case 1: char_add = (char*)FLASH_Settings_VAddr_SLine2;break;
...
;Globals.c,523 :: 		memcpy(line,char_add,64);
ORI	R27, R0, 64
MOVZ	R25, R26, R0
LW	R26, 16(SP)
JAL	_memcpy+0
NOP	
;Globals.c,531 :: 		return STATUS_OK;
MOVZ	R2, R0, R0
;Globals.c,532 :: 		}
;Globals.c,531 :: 		return STATUS_OK;
;Globals.c,532 :: 		}
...
;Globals.c,536 :: 		int settings_store_startup_line(int n, char *line){
ADDIU	SP, SP, -24
SW	RA, 0(SP)
;Globals.c,541 :: 		str_len = strlen(line);
SW	R25, 4(SP)
SW	R27, 8(SP)
SH	R25, 12(SP)
MOVZ	R25, R26, R0
...
SEH	R4, R2
;Globals.c,550 :: 		add  = (unsigned long)FLASH_Settings_VAddr_P1; //C0000
LUI	R2, 48411
ORI	R2, R2, 49152
SW	R2, Offset(Globals_add+0)(GP)
;Globals.c,553 :: 		switch(n){
J	L_settings_store_startup_line70
NOP	
;Globals.c,554 :: 		case 0: start_offset = (unsigned long)Line0_Offset;break; //180
L_settings_store_startup_line72:
ORI	R2, R0, 384
SW	R2, 20(SP)
J	L_settings_store_startup_line71
NOP	
;Globals.c,555 :: 		case 1: start_offset = (unsigned long)Line1_Offset;break;
...
;Globals.c,558 :: 		if(!read_ram_loaded_indicator()){
JAL	_read_ram_loaded_indicator+0
NOP	
...
;Globals.c,560 :: 		set_ram_loaded_indicator(read_row_from_flash(add));
SH	R4, 12(SP)
LW	R25, Offset(Globals_add+0)(GP)
JAL	_read_row_from_flash+0
NOP	
...
JAL	Globals_set_ram_loaded_indicator+0
NOP	
;Globals.c,564 :: 		error = (int)NVMErasePage(&add);
SH	R4, 12(SP)
SW	R26, 16(SP)
LUI	R25, hi_addr(Globals_add+0)
ORI	R25, R25, lo_addr(Globals_add+0)
...
;Globals.c,574 :: 		return error;
LHU	R2, Offset(_error+0)(GP)
J	L_end_settings_store_startup_line
NOP	
;Globals.c,575 :: 		}
L_settings_store_startup_line75:
;Globals.c,578 :: 		for(i=start_offset;i<start_offset+16;i++)
; str_len start address is: 16 (R4)
LW	R2, 20(SP)
SW	R2, Offset(_i+0)(GP)
; str_len end address is: 16 (R4)
...
;Globals.c,583 :: 		memcpy(buffA+start_offset,line,str_len);
LW	R2, 20(SP)
SLL	R3, R2, 2
LUI	R2, 40960
ORI	R2, R2, 0
...
NOP	
LH	R25, 12(SP)
;Globals.c,595 :: 		set_ram_loaded_indicator((int)NVMWriteRow(&add,buffA));
SW	R26, 12(SP)
SH	R25, 16(SP)
LUI	R26, 40960
ORI	R26, R26, 0
...
;Globals.c,603 :: 		int settings_store_global_setting(int parameter, float value) {
ADDIU	SP, SP, -24
SW	RA, 0(SP)
;Globals.c,605 :: 		volatile unsigned long has_data = 0;
SW	R25, 4(SP)
SW	R26, 8(SP)
;Globals.c,606 :: 		int val_temp = 0;
;Globals.c,608 :: 		add = (unsigned long)FLASH_Settings_VAddr_P1;
LUI	R2, 48411
ORI	R2, R2, 49152
SW	R2, Offset(Globals_add+0)(GP)
;Globals.c,611 :: 		if(!read_ram_loaded_indicator()){
JAL	_read_ram_loaded_indicator+0
NOP	
...
;Globals.c,613 :: 		set_ram_loaded_indicator(read_row_from_flash(add));
SH	R25, 12(SP)
LW	R25, Offset(Globals_add+0)(GP)
JAL	_read_row_from_flash+0
NOP	
...
;Globals.c,618 :: 		error = (int)NVMErasePage(&add);
SH	R25, 12(SP)
SWC1	S12, 16(SP)
LUI	R25, hi_addr(Globals_add+0)
ORI	R25, R25, lo_addr(Globals_add+0)
...
;Globals.c,642 :: 		settings.steps_per_mm[parameter] = value;
SEH	R2, R25
SLL	R3, R2, 2
...
ADDU	R2, R2, R3
SWC1	S12, 0(R2)
;Globals.c,644 :: 		buffA[SPMMX_OFFSET+parameter] = flt2ulong(value);
ADDIU	R2, R25, 64
SEH	R2, R2
SLL	R3, R2, 2
LUI	R2, 40960
...
NOP	
;Globals.c,656 :: 		case 3:
L_settings_store_global_setting87:
;Globals.c,657 :: 		if (value < 3) { return(STATUS_SETTING_STEP_PULSE_MIN); }
LUI	R2, 16448
ORI	R2, R2, 0
MTC1	R2, S0
C.LE.S 	0, S0, S12
...
JAL	_round+0
NOP	
;Globals.c,659 :: 		settings.p_usec = val_temp;
SH	R2, Offset(_settings+52)(GP)
;Globals.c,661 :: 		buffA[P_USEC_OFFSET] = (unsigned long)val_temp;
SEH	R2, R2
SW	R2, Offset(-1610612456)(GP)
;Globals.c,662 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,663 :: 		case 4: settings.default_feed_rate = value;
L_settings_store_global_setting89:
SWC1	S12, Offset(_settings+8)(GP)
;Globals.c,664 :: 		buffA[D_FEED_RATE_OFFSET] = flt2ulong(value);
JAL	_flt2ulong+0
NOP	
SW	R2, Offset(-1610612452)(GP)
;Globals.c,665 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,666 :: 		case 5: settings.default_seek_rate = value;
L_settings_store_global_setting90:
SWC1	S12, Offset(_settings+12)(GP)
;Globals.c,667 :: 		buffA[D_SEEK_RATE_OFFSET] = flt2ulong(value);
JAL	_flt2ulong+0
NOP	
SW	R2, Offset(-1610612448)(GP)
;Globals.c,668 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,669 :: 		case 6:
L_settings_store_global_setting91:
;Globals.c,670 :: 		settings.invert_mask = floor(value);
JAL	_floor+0
NOP	
CVT36.S 	S0, S0
MFC1	R2, S0
SH	R2, Offset(_settings+58)(GP)
;Globals.c,671 :: 		buffA[INVERT_MASK_OFFSET] = flt2ulong(floor(value));
JAL	_floor+0
NOP	
MOV.S 	S12, S0
JAL	_flt2ulong+0
...
J	L_settings_store_global_setting82
NOP	
;Globals.c,673 :: 		case 7:
L_settings_store_global_setting92:
;Globals.c,674 :: 		val_temp = round(value);
JAL	_round+0
NOP	
;Globals.c,675 :: 		settings.stepper_idle_lock_time = val_temp;
SH	R2, Offset(_settings+48)(GP)
;Globals.c,676 :: 		buffA[IDLE_LOCK_TMR_OFFSET] = (unsigned long)val_temp;
SEH	R2, R2
SW	R2, Offset(-1610612404)(GP)
;Globals.c,677 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,678 :: 		case 8: // Convert to mm/min^2 for grbl internal use.
L_settings_store_global_setting93:
;Globals.c,679 :: 		settings.acceleration = value*60.0*60.0;
LUI	R2, 17008
ORI	R2, R2, 0
MTC1	R2, S0
MUL.S 	S1, S12, S0
...
MUL.S 	S0, S1, S0
SWC1	S0, Offset(_settings+32)(GP)
;Globals.c,680 :: 		buffA[ACCELERATION_OFFSET] = flt2ulong(value);
JAL	_flt2ulong+0
NOP	
SW	R2, Offset(-1610612428)(GP)
;Globals.c,681 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,682 :: 		case 9: settings.junction_deviation = fabs(value);
L_settings_store_global_setting94:
JAL	_fabs+0
NOP	
SWC1	S0, Offset(_settings+36)(GP)
;Globals.c,683 :: 		buffA[JUNCTION_DEV_OFFSET] = flt2ulong(fabs(value));
JAL	_fabs+0
NOP	
MOV.S 	S12, S0
JAL	_flt2ulong+0
...
J	L_settings_store_global_setting82
NOP	
;Globals.c,685 :: 		case 10:
L_settings_store_global_setting95:
;Globals.c,686 :: 		val_temp = round(value);
JAL	_round+0
NOP	
;Globals.c,687 :: 		settings.mm_per_arc_segment = val_temp;
SEH	R3, R2
MTC1	R3, S0
CVT32.W 	S0, S0
SWC1	S0, Offset(_settings+28)(GP)
;Globals.c,688 :: 		buffA[MM_ARC_SEG_OFFSET] = (unsigned long)val_temp;
SEH	R2, R2
SW	R2, Offset(-1610612432)(GP)
;Globals.c,689 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,690 :: 		case 11:
L_settings_store_global_setting96:
;Globals.c,691 :: 		val_temp = round(value);
JAL	_round+0
NOP	
;Globals.c,692 :: 		settings.n_arc_correction = val_temp;
SH	R2, Offset(_settings+40)(GP)
;Globals.c,693 :: 		buffA[N_ARC_CORREC_OFFSET] = (int)val_temp;
SEH	R2, R2
SW	R2, Offset(-1610612420)(GP)
;Globals.c,694 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,695 :: 		case 12:
L_settings_store_global_setting97:
;Globals.c,696 :: 		val_temp = round(value);
JAL	_round+0
NOP	
;Globals.c,697 :: 		settings.decimal_places = val_temp;
SH	R2, Offset(_settings+54)(GP)
;Globals.c,698 :: 		buffA[DEC_PLACES_OFFSET] = (unsigned long)val_temp;
SEH	R2, R2
SW	R2, Offset(-1610612392)(GP)
;Globals.c,699 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,700 :: 		case 13:
...
;Globals.c,702 :: 		settings.flags |= BITFLAG_REPORT_INCHES;
LHU	R2, Offset(_settings+42)(GP)
ORI	R2, R2, 1
SH	R2, Offset(_settings+42)(GP)
;Globals.c,703 :: 		}else{
...
;Globals.c,704 :: 		settings.flags &= ~BITFLAG_REPORT_INCHES;
...
;Globals.c,706 :: 		buffA[FLAGS_OFFSET] = (unsigned long)settings.flags;
LHU	R2, Offset(_settings+42)(GP)
SW	R2, Offset(-1610612416)(GP)
;Globals.c,707 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,708 :: 		case 14: // Reset to ensure change. Immediate re-init may cause problems.
L_settings_store_global_setting101:
;Globals.c,709 :: 		if (round(value)){
JAL	_round+0
NOP	
...
;Globals.c,710 :: 		settings.flags |= BITFLAG_AUTO_START;
LHU	R2, Offset(_settings+42)(GP)
ORI	R2, R2, 2
SH	R2, Offset(_settings+42)(GP)
;Globals.c,711 :: 		}else{
...
;Globals.c,712 :: 		settings.flags &= ~BITFLAG_AUTO_START;
LHU	R3, Offset(_settings+42)(GP)
ORI	R2, R0, 65533
AND	R2, R3, R2
SH	R2, Offset(_settings+42)(GP)
...
;Globals.c,714 :: 		buffA[FLAGS_OFFSET] = (unsigned long)settings.flags;
LHU	R2, Offset(_settings+42)(GP)
SW	R2, Offset(-1610612416)(GP)
;Globals.c,715 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,716 :: 		case 15: // Reset to ensure change. Immediate re-init may cause problems.
L_settings_store_global_setting104:
;Globals.c,717 :: 		if (round(value)){
JAL	_round+0
NOP	
...
;Globals.c,718 :: 		settings.flags |= BITFLAG_INVERT_ST_ENABLE;
LHU	R2, Offset(_settings+42)(GP)
ORI	R2, R2, 4
SH	R2, Offset(_settings+42)(GP)
;Globals.c,719 :: 		}else{
...
;Globals.c,720 :: 		settings.flags &= ~BITFLAG_INVERT_ST_ENABLE;
LHU	R3, Offset(_settings+42)(GP)
ORI	R2, R0, 65531
AND	R2, R3, R2
SH	R2, Offset(_settings+42)(GP)
...
;Globals.c,722 :: 		buffA[FLAGS_OFFSET] |= (unsigned long)settings.flags;
LHU	R3, Offset(_settings+42)(GP)
LW	R2, Offset(-1610612416)(GP)
OR	R2, R2, R3
SW	R2, Offset(-1610612416)(GP)
...
J	L_settings_store_global_setting82
NOP	
;Globals.c,724 :: 		case 16:
L_settings_store_global_setting107:
;Globals.c,725 :: 		if (round(value)){
JAL	_round+0
NOP	
...
;Globals.c,726 :: 		settings.flags |= BITFLAG_HARD_LIMIT_ENABLE;
LHU	R2, Offset(_settings+42)(GP)
ORI	R2, R2, 8
SH	R2, Offset(_settings+42)(GP)
;Globals.c,727 :: 		}else{
...
;Globals.c,728 :: 		settings.flags &= ~BITFLAG_HARD_LIMIT_ENABLE;
LHU	R3, Offset(_settings+42)(GP)
ORI	R2, R0, 65527
AND	R2, R3, R2
SH	R2, Offset(_settings+42)(GP)
...
;Globals.c,730 :: 		buffA[FLAGS_OFFSET] = (unsigned long)settings.flags;
LHU	R2, Offset(_settings+42)(GP)
SW	R2, Offset(-1610612416)(GP)
;Globals.c,732 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,733 :: 		case 17:
L_settings_store_global_setting110:
;Globals.c,734 :: 		if (round(value)){
JAL	_round+0
NOP	
...
;Globals.c,735 :: 		settings.flags |= BITFLAG_HOMING_ENABLE;
LHU	R2, Offset(_settings+42)(GP)
ORI	R2, R2, 16
SH	R2, Offset(_settings+42)(GP)
;Globals.c,736 :: 		}else{
...
;Globals.c,737 :: 		settings.flags &= ~BITFLAG_HOMING_ENABLE;
LHU	R3, Offset(_settings+42)(GP)
ORI	R2, R0, 65519
AND	R2, R3, R2
SH	R2, Offset(_settings+42)(GP)
...
;Globals.c,739 :: 		buffA[FLAGS_OFFSET] = (unsigned long)settings.flags;
LHU	R2, Offset(_settings+42)(GP)
SW	R2, Offset(-1610612416)(GP)
;Globals.c,740 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,741 :: 		case 18:
L_settings_store_global_setting113:
;Globals.c,742 :: 		val_temp = round(value);
JAL	_round+0
NOP	
;Globals.c,743 :: 		settings.homing_dir_mask = val_temp;
SH	R2, Offset(_settings+56)(GP)
;Globals.c,744 :: 		buffA[HOME_DIR_MASK_OFFSET] = (unsigned long)val_temp;
SEH	R2, R2
SW	R2, Offset(-1610612388)(GP)
;Globals.c,745 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,746 :: 		case 19: settings.homing_feed_rate = value;
L_settings_store_global_setting114:
SWC1	S12, Offset(_settings+16)(GP)
;Globals.c,747 :: 		buffA[H_FEED_RATE_OFFSET] = flt2ulong(value);
JAL	_flt2ulong+0
NOP	
SW	R2, Offset(-1610612444)(GP)
;Globals.c,748 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,749 :: 		case 20: settings.homing_seek_rate = value;
L_settings_store_global_setting115:
SWC1	S12, Offset(_settings+20)(GP)
;Globals.c,750 :: 		buffA[H_SEEK_RATE_OFFSET] = flt2ulong(value);
JAL	_flt2ulong+0
NOP	
SW	R2, Offset(-1610612440)(GP)
;Globals.c,751 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,752 :: 		case 21:
L_settings_store_global_setting116:
;Globals.c,753 :: 		val_temp = round(value);
JAL	_round+0
NOP	
;Globals.c,754 :: 		settings.homing_debounce_delay = val_temp;
SH	R2, Offset(_settings+46)(GP)
;Globals.c,755 :: 		buffA[H_DEBNC_DLY_OFFSET] = (unsigned long)val_temp;
SEH	R2, R2
SW	R2, Offset(-1610612408)(GP)
;Globals.c,756 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,757 :: 		case 22:
L_settings_store_global_setting117:
;Globals.c,758 :: 		val_temp = round(value);
JAL	_round+0
NOP	
;Globals.c,759 :: 		settings.homing_pulloff = val_temp;
SEH	R3, R2
MTC1	R3, S0
CVT32.W 	S0, S0
SWC1	S0, Offset(_settings+24)(GP)
;Globals.c,760 :: 		buffA[H_PULL_OFF_OFFSET] = (unsigned long)val_temp;
SEH	R2, R2
SW	R2, Offset(-1610612436)(GP)
;Globals.c,761 :: 		break;
J	L_settings_store_global_setting82
NOP	
;Globals.c,762 :: 		case 99://write buffC back to Row3
L_settings_store_global_setting118:
;Globals.c,763 :: 		val_temp = round(value);
JAL	_round+0
NOP	
;Globals.c,764 :: 		if(val_temp == 1){
SEH	R3, R2
ORI	R2, R0, 1
...
;Globals.c,766 :: 		buffA[FLASH_LOADED_OFFSET] = 0x7FFFFFFF;
LUI	R2, 32767
ORI	R2, R2, 65535
SW	R2, Offset(-1610611216)(GP)
;Globals.c,773 :: 		set_ram_loaded_indicator((int)NVMWriteRow(&add,buffA));
LUI	R26, 40960
ORI	R26, R26, 0
LUI	R25, hi_addr(Globals_add+0)
ORI	R25, R25, lo_addr(Globals_add+0)
...
J	L_settings_store_global_setting82
NOP	
;Globals.c,783 :: 		default:
L_settings_store_global_setting120:
;Globals.c,784 :: 		return(STATUS_INVALID_STATEMENT);
ORI	R2, R0, 6
J	L_end_settings_store_global_setting
NOP	
;Globals.c,785 :: 		}
...
;Globals.c,786 :: 		return(STATUS_OK);
MOVZ	R2, R0, R0
;Globals.c,787 :: 		}
;Globals.c,786 :: 		return(STATUS_OK);
;Globals.c,787 :: 		}
