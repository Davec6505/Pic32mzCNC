...
ADDIU	R3, R2, 84
SLTI	R2, R25, 0
BNE	R2, R0, L__SingleAxisStep111
NOP	
J	L_SingleAxisStep3
NOP	
L__SingleAxisStep111:
...
; dir start address is: 16 (R4)
SEH	R2, R26
BNE	R2, R0, L__SingleAxisStep114
NOP	
J	L_SingleAxisStep9
NOP	
...
SEH	R3, R26
ORI	R2, R0, 1
BNE	R3, R2, L__SingleAxisStep116
NOP	
J	L_SingleAxisStep10
NOP	
L__SingleAxisStep116:
SEH	R3, R26
ORI	R2, R0, 2
BNE	R3, R2, L__SingleAxisStep118
NOP	
...
SEH	R3, R26
ORI	R2, R0, 3
BNE	R3, R2, L__SingleAxisStep120
NOP	
...
SLTI	R2, R25, 0
BNE	R2, R0, L__GetAxisDirection163
NOP	
J	L_GetAxisDirection74
NOP	
L__GetAxisDirection163:
...
_Home:
;Kinematics.c,538 :: 		void Home(int axis){
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;Kinematics.c,539 :: 		long speed = 0;
SW	R25, 4(SP)
SW	R26, 8(SP)
;Kinematics.c,541 :: 		if(sys.homing_cnt == 0)
LH	R2, Offset(_sys+4)(GP)
BEQ	R2, R0, L__Home165
NOP	
J	L_Home76
NOP	
L__Home165:
;Kinematics.c,542 :: 		speed = 250;
J	L_Home77
NOP	
L_Home76:
...
NOP	
L_Home79:
;Kinematics.c,550 :: 		else if(axis == Y)
SEH	R3, R25
ORI	R2, R0, 1
BEQ	R3, R2, L__Home169
NOP	
J	L_Home81
NOP	
L__Home169:
;Kinematics.c,551 :: 		StopY();
SH	R25, 12(SP)
JAL	_StopY+0
NOP	
LH	R25, 12(SP)
L_Home81:
L_Home80:
;Kinematics.c,553 :: 		if(sys.homing_cnt == 0)
LH	R2, Offset(_sys+4)(GP)
...
NOP	
L__Home170:
;Kinematics.c,554 :: 		Inv_Home_Axis(5.0,100, axis);
LUI	R2, 16544
ORI	R2, R2, 0
SH	R25, 12(SP)
SEH	R26, R25
...
NOP	
L__Home172:
;Kinematics.c,558 :: 		sys.homing_cnt++;
LH	R2, Offset(_sys+4)(GP)
ADDIU	R2, R2, 1
SH	R2, Offset(_sys+4)(GP)
;Kinematics.c,559 :: 		}
L_Home83:
;Kinematics.c,561 :: 		if((!OC5IE_bit && !OC2IE_bit && !OC7IE_bit && !OC3IE_bit)){
_LX	
EXT	R2, R2, BitPos(OC5IE_bit+0), 1
...
L__Home176:
L__Home103:
;Kinematics.c,562 :: 		if(sys.homing_cnt < 1)
LH	R2, Offset(_sys+4)(GP)
SLTI	R2, R2, 1
...
NOP	
L__Home177:
;Kinematics.c,563 :: 		Home_Axis(300.0,250,axis);
LUI	R2, 17302
ORI	R2, R2, 0
SEH	R26, R25
ORI	R25, R0, 250
...
NOP	
L_Home87:
;Kinematics.c,565 :: 		STPS[axis].step_count = 0;
SEH	R3, R25
ORI	R2, R0, 88
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 32
SW	R0, 0(R2)
;Kinematics.c,566 :: 		STPS[axis].steps_position = 0;
SEH	R3, R25
ORI	R2, R0, 88
MULTU	R2, R3
MFLO	R3
...
; end of _Home
_Home_Axis:
;Kinematics.c,573 :: 		void Home_Axis(double distance,long speed,int axis){
ADDIU	SP, SP, -24
SW	RA, 0(SP)
;Kinematics.c,574 :: 		distance = (distance < max_sizes[axis])? max_sizes[axis]:distance;
SW	R25, 4(SP)
SW	R27, 8(SP)
SEH	R2, R26
SLL	R3, R2, 2
...
ADDU	R2, R2, R3
LWC1	S0, 0(R2)
; ?FLOC___Home_Axis?T414 start address is: 8 (R2)
MOV.S 	S1, S0
; ?FLOC___Home_Axis?T414 end address is: 8 (R2)
J	L_Home_Axis90
NOP	
L_Home_Axis89:
; ?FLOC___Home_Axis?T414 start address is: 8 (R2)
...
; ?FLOC___Home_Axis?T414 start address is: 8 (R2)
MOV.S 	S12, S1
;Kinematics.c,575 :: 		distance = (distance < 0.0)? distance : -distance;
MOVZ	R2, R0, R0
MTC1	R2, S0
C.LE.S 	0, S0, S1
BC1F	0, L__Home_Axis180
NOP	
J	L_Home_Axis91
NOP	
L__Home_Axis180:
; ?FLOC___Home_Axis?T414 end address is: 8 (R2)
; ?FLOC___Home_Axis?T416 start address is: 0 (R0)
MOV.S 	S0, S12
; ?FLOC___Home_Axis?T416 end address is: 0 (R0)
J	L_Home_Axis92
NOP	
L_Home_Axis91:
MOVZ	R2, R0, R0
MTC1	R2, S0
SUB.S 	S0, S0, S12
; ?FLOC___Home_Axis?T416 start address is: 8 (R2)
MOV.S 	S1, S0
; ?FLOC___Home_Axis?T416 end address is: 8 (R2)
MOV.S 	S0, S1
L_Home_Axis92:
; ?FLOC___Home_Axis?T416 start address is: 0 (R0)
MOV.S 	S12, S0
; ?FLOC___Home_Axis?T416 end address is: 0 (R0)
;Kinematics.c,576 :: 		STPS[axis].mmToTravel = belt_steps(-max_sizes[axis]);
SEH	R3, R26
ORI	R2, R0, 88
MULTU	R2, R3
MFLO	R3
...
LW	R3, 20(SP)
SW	R2, 0(R3)
;Kinematics.c,577 :: 		speed_cntr_Move(STPS[axis].mmToTravel, speed ,axis);
SEH	R3, R26
ORI	R2, R0, 88
MULTU	R2, R3
MFLO	R3
...
NOP	
LH	R26, 12(SP)
;Kinematics.c,578 :: 		SingleAxisStep(STPS[axis].mmToTravel,axis);
SEH	R3, R26
ORI	R2, R0, 88
MULTU	R2, R3
MFLO	R3
...
; end of _Home_Axis
_Inv_Home_Axis:
;Kinematics.c,581 :: 		void Inv_Home_Axis(double distance,long speed,int axis){
ADDIU	SP, SP, -24
SW	RA, 0(SP)
;Kinematics.c,582 :: 		distance = (distance > 10.0)?  10.0 : distance;
SW	R25, 4(SP)
SW	R27, 8(SP)
LUI	R2, 16672
ORI	R2, R2, 0
...
LUI	R2, 16672
ORI	R2, R2, 0
; ?FLOC___Inv_Home_Axis?T444 start address is: 8 (R2)
MTC1	R2, S1
; ?FLOC___Inv_Home_Axis?T444 end address is: 8 (R2)
J	L_Inv_Home_Axis94
NOP	
L_Inv_Home_Axis93:
; ?FLOC___Inv_Home_Axis?T444 start address is: 8 (R2)
...
; ?FLOC___Inv_Home_Axis?T444 start address is: 8 (R2)
MOV.S 	S12, S1
;Kinematics.c,583 :: 		distance *= (distance < 0.0)?  -1.0 : 1.0;
MOVZ	R2, R0, R0
MTC1	R2, S0
C.LE.S 	0, S0, S1
BC1F	0, L__Inv_Home_Axis183
NOP	
J	L_Inv_Home_Axis95
NOP	
L__Inv_Home_Axis183:
...
LUI	R2, 49024
ORI	R2, R2, 0
; ?FLOC___Inv_Home_Axis?T446 start address is: 8 (R2)
MTC1	R2, S1
; ?FLOC___Inv_Home_Axis?T446 end address is: 8 (R2)
J	L_Inv_Home_Axis96
NOP	
L_Inv_Home_Axis95:
LUI	R2, 16256
...
; ?FLOC___Inv_Home_Axis?T446 end address is: 8 (R2)
MOV.S 	S12, S0
;Kinematics.c,584 :: 		STPS[axis].mmToTravel = belt_steps(distance);
SEH	R3, R26
ORI	R2, R0, 88
MULTU	R2, R3
MFLO	R3
...
LW	R3, 20(SP)
SW	R2, 0(R3)
;Kinematics.c,585 :: 		speed_cntr_Move(STPS[axis].mmToTravel, speed ,axis);
SEH	R3, R26
ORI	R2, R0, 88
MULTU	R2, R3
MFLO	R3
...
NOP	
LH	R26, 12(SP)
;Kinematics.c,586 :: 		SingleAxisStep(STPS[axis].mmToTravel,axis);
SEH	R3, R26
ORI	R2, R0, 88
MULTU	R2, R3
MFLO	R3
