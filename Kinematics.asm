...
LW	R3, 56(SP)
SW	R2, 0(R3)
;Kinematics.c,186 :: 		while(DMA_IsOn(1));
L_DualAxisStep27:
SH	R26, 4(SP)
SH	R25, 6(SP)
SWC1	S14, 8(SP)
...
NOP	
L_DualAxisStep28:
;Kinematics.c,188 :: 		,STPS[axisA].dist,STPS[axisB].dist);
SEH	R3, R26
ORI	R2, R0, 76
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 36
LW	R3, 0(R2)
;Kinematics.c,187 :: 		dma_printf("SV.dA:= %l\tSV.dB:= %l\n"
ADDIU	R23, SP, 28
ADDIU	R22, R23, 23
...
;Kinematics.c,419 :: 		}
L_mc_arc57:
;Kinematics.c,424 :: 		if(!OC5IE_bit && !OC3IE_bit)//!Get_Axis_IEnable_States()||SV.mode_complete < 1)
_LX	
...
; ?FLOC___GetAxisDirection?T563 start address is: 8 (R2)
ORI	R2, R0, 255
; ?FLOC___GetAxisDirection?T563 end address is: 8 (R2)
