...
;Kinematics.c,95 :: 		SV.mode_complete = 1;
ORI	R3, R0, 1
...
;Kinematics.c,106 :: 		static void SingleAxisStart(long dist,float speed,int axis_No){
ADDIU	SP, SP, -28
SW	RA, 0(SP)
...
NOP	
L__DualAxisStep113:
; ?FLOC___DualAxisStep?T110 start address is: 16 (R4)
ORI	R4, R0, 255
; ?FLOC___DualAxisStep?T110 end address is: 16 (R4)
J	L_DualAxisStep22
NOP	
L_DualAxisStep21:
; ?FLOC___DualAxisStep?T110 start address is: 16 (R4)
...
; tempA end address is: 24 (R6)
L__DualAxisStep87:
;Kinematics.c,202 :: 		SV.mode_complete = 1; //set this to respond with ok
ORI	R3, R0, 1
LBU	R2, Offset(_SV+0)(GP)
INS	R2, R3, 6, 2
SB	R2, Offset(_SV+0)(GP)
...
;Kinematics.c,315 :: 		}
L_mc_arc32:
;Kinematics.c,318 :: 		while(DMA_IsOn(1));
...
NOP	
L_mc_arc35:
;Kinematics.c,328 :: 		,offset[axis_0],offset[axis_1]
LH	R2, 504(SP)
SLL	R4, R2, 2
ADDU	R2, R27, R4
LWC1	S5, 0(R2)
...
ADDU	R2, R27, R3
LWC1	S4, 0(R2)
;Kinematics.c,327 :: 		,target[axis_0],target[axis_1]
ADDU	R2, R26, R4
LWC1	S3, 0(R2)
ADDU	R2, R26, R3
LWC1	S2, 0(R2)
;Kinematics.c,326 :: 		position[axis_0],position[axis_1]
ADDU	R2, R25, R4
LWC1	S1, 0(R2)
ADDU	R2, R25, R3
LWC1	S0, 0(R2)
;Kinematics.c,325 :: 		[rt_axis0:= %f : rt_axis1:= %f]\r\n\n",
ADDIU	R23, SP, 96
ADDIU	R22, R23, 160
...
NOP	
ADDIU	R3, SP, 96
;Kinematics.c,330 :: 		,r_axis0,r_axis1,rt_axis0,rt_axis1);
SH	R28, 4(SP)
; rt_axis1 end address is: 176 (R44)
SW	R27, 8(SP)
SW	R26, 12(SP)
...
LW	R2, 96(SP)
SW	R2, 36(SP)
;Kinematics.c,329 :: 		,center_axis0,center_axis1
LW	R2, 92(SP)
SW	R2, 32(SP)
LW	R2, 88(SP)
SW	R2, 28(SP)
...
_SX	
;Kinematics.c,364 :: 		while(DMA_IsOn(1));
L_mc_arc38:
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
...
NOP	
L_mc_arc39:
;Kinematics.c,369 :: 		[LinPseg:= %f : *pSeg:= %f]\n[gc.freq:= %l]\r\n",
ADDIU	R23, SP, 256
ADDIU	R22, R23, 145
...
NOP	
ADDIU	R3, SP, 256
;Kinematics.c,371 :: 		,linear_travel,linear_per_segment,theta_per_segment,feed_rate);
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
SW	R25, 16(SP)
...
LW	R2, 96(SP)
SW	R2, 28(SP)
;Kinematics.c,370 :: 		cos_T,sin_T,radius,segments,angular_travel,mm_of_travel
LW	R2, 112(SP)
SW	R2, 24(SP)
LW	R2, 108(SP)
SW	R2, 20(SP)
...
SWC1	S0, 84(SP)
L_mc_arc47:
;Kinematics.c,417 :: 		}else if(position[axis_0] < target[axis_0]){
J	L_mc_arc48
NOP	
L_mc_arc46:
SEH	R2, R28
...
SWC1	S0, 88(SP)
L_mc_arc52:
;Kinematics.c,423 :: 		}else if(position[axis_1] < target[axis_1]){
J	L_mc_arc53
NOP	
L_mc_arc51:
LH	R2, 504(SP)
...
NOP	
L_mc_arc57:
;Kinematics.c,447 :: 		while(DMA_IsOn(1));
L_mc_arc61:
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
...
NOP	
L_mc_arc62:
;Kinematics.c,452 :: 		,i,segments,nPx,nPy,target[axis_0],target[axis_1]);
LH	R2, 504(SP)
SLL	R2, R2, 2
ADDU	R2, R26, R2
LWC1	S1, 0(R2)
...
ADDU	R2, R26, R2
LWC1	S0, 0(R2)
;Kinematics.c,451 :: 		[ tar[axis_0]:= %f\ttar[axis_1]:= %f]\r\n"
ADDIU	R23, SP, 401
ADDIU	R22, R23, 81
...
LW	R27, 8(SP)
LH	R28, 4(SP)
;Kinematics.c,463 :: 		while(DMA_IsOn(1));
L_mc_arc63:
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
...
AND	R2, R3, R2
SH	R2, 0(R4)
;Kinematics.c,573 :: 		Home_Axis(12.0,100.0, axis);
LUI	R3, 17096
ORI	R3, R3, 0
LUI	R2, 16704
ORI	R2, R2, 0
...
AND	R2, R3, R2
SH	R2, 0(R4)
;Kinematics.c,617 :: 		Home_Axis(-290.00,50.0,axis);
LUI	R3, 16968
ORI	R3, R3, 0
LUI	R2, 50065
ORI	R2, R2, 0
