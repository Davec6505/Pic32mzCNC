...
; angular_travel end address is: 168 (R42)
; linear_travel end address is: 192 (R48)
;Kinematics.c,307 :: 		while(DMA_IsOn(1));
L_mc_arc34:
; angular_travel start address is: 168 (R42)
; linear_travel start address is: 192 (R48)
SWC1	S24, 4(SP)
...
NOP	
ADDIU	R3, SP, 68
;Kinematics.c,309 :: 		cos_T,sin_T,radius,segments,angular_travel,mm_of_travel,linear_travel,linear_per_segment,theta_per_segment);
LW	R2, 240(SP)
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
...
LW	R27, 8(SP)
LH	R28, 4(SP)
;Kinematics.c,312 :: 		while(i < segments) { // Increment (segments-1)
L_mc_arc36:
LHU	R3, 252(SP)
LHU	R2, 264(SP)
SLTU	R2, R2, R3
BNE	R2, R0, L__mc_arc114
NOP	
J	L_mc_arc37
NOP	
L__mc_arc114:
;Kinematics.c,314 :: 		if (count < n_arc_correction) {
LBU	R3, 238(SP)
LH	R2, 236(SP)
SLT	R2, R2, R3
...
NOP	
L__mc_arc115:
;Kinematics.c,316 :: 		r_axisi = r_axis0*sin_T + r_axis1*cos_T;
LWC1	S1, 260(SP)
LWC1	S0, 40(SP)
MUL.S 	S2, S0, S1
LWC1	S1, 256(SP)
...
MUL.S 	S0, S0, S1
ADD.S 	S3, S2, S0
;Kinematics.c,317 :: 		r_axis0 = r_axis0*cos_T - r_axis1*sin_T;
LWC1	S1, 256(SP)
LWC1	S0, 40(SP)
MUL.S 	S2, S0, S1
LWC1	S1, 260(SP)
...
SUB.S 	S0, S2, S0
SWC1	S0, 40(SP)
;Kinematics.c,318 :: 		r_axis1 = r_axisi;
SWC1	S3, 44(SP)
;Kinematics.c,319 :: 		count++;
LH	R2, 236(SP)
ADDIU	R2, R2, 1
SH	R2, 236(SP)
...
NOP	
L_mc_arc38:
;Kinematics.c,323 :: 		cos_Ti = cos(i*theta_per_segment);
LHU	R2, 264(SP)
MTC1	R2, S0
CVT32.W 	S1, S0
LWC1	S0, 240(SP)
...
MOV.S 	S5, S0
;Kinematics.c,324 :: 		sin_Ti = sin(i*theta_per_segment);
LHU	R2, 264(SP)
MTC1	R2, S0
CVT32.W 	S1, S0
LWC1	S0, 240(SP)
...
NOP	
LW	R26, 4(SP)
;Kinematics.c,325 :: 		r_axis0 = -offset[axis_0]*cos_Ti + offset[axis_1]*sin_Ti;
SEH	R2, R28
SLL	R2, R2, 2
ADDU	R2, R27, R2
LWC1	S4, 0(R2)
...
ADD.S 	S1, S3, S1
SWC1	S1, 40(SP)
;Kinematics.c,326 :: 		r_axis1 = -offset[axis_0]*sin_Ti - offset[axis_1]*cos_Ti;
MOVZ	R2, R0, R0
MTC1	R2, S1
SUB.S 	S1, S1, S4
MUL.S 	S1, S1, S0
...
SUB.S 	S0, S1, S0
SWC1	S0, 44(SP)
;Kinematics.c,327 :: 		count = 0;
SH	R0, 236(SP)
;Kinematics.c,328 :: 		}
L_mc_arc39:
;Kinematics.c,331 :: 		arc_target[axis_0] = center_axis0 + r_axis0;
ADDIU	R4, SP, 48
SEH	R2, R28
SLL	R2, R2, 2
ADDU	R2, R4, R2
...
ADD.S 	S0, S0, S1
SWC1	S0, 0(R2)
;Kinematics.c,332 :: 		arc_target[axis_1] = center_axis1 + r_axis1;
LH	R2, 268(SP)
SLL	R2, R2, 2
ADDU	R2, R4, R2
LWC1	S1, 44(SP)
...
ADD.S 	S0, S0, S1
SWC1	S0, 0(R2)
;Kinematics.c,333 :: 		arc_target[axis_linear] += linear_per_segment;
LH	R2, 270(SP)
SLL	R2, R2, 2
ADDU	R2, R4, R2
LWC1	S1, 0(R2)
...
ADD.S 	S0, S1, S0
SWC1	S0, 0(R2)
;Kinematics.c,334 :: 		nPx =  arc_target[axis_0] - position[axis_0];
SEH	R2, R28
SLL	R3, R2, 2
ADDU	R2, R4, R3
LWC1	S1, 0(R2)
...
SUB.S 	S0, S1, S0
SWC1	S0, 60(SP)
;Kinematics.c,335 :: 		position[axis_0] = arc_target[axis_0];
SWC1	S1, 0(R2)
...
SUB.S 	S0, S1, S0
SWC1	S0, 64(SP)
;Kinematics.c,337 :: 		position[axis_1] = arc_target[axis_1];
SWC1	S1, 0(R2)
;Kinematics.c,339 :: 		STPS[axis_0].step_delay = 1000;
SEH	R3, R28
ORI	R2, R0, 100
MULTU	R2, R3
MFLO	R3
...
ORI	R2, R0, 1000
SW	R2, 0(R3)
;Kinematics.c,340 :: 		STPS[axis_1].step_delay = 1000;
LH	R3, 268(SP)
ORI	R2, R0, 100
MULTU	R2, R3
MFLO	R3
...
ORI	R2, R0, 1000
SW	R2, 0(R3)
;Kinematics.c,343 :: 		while(DMA_IsOn(1));
L_mc_arc40:
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
...
NOP	
ADDIU	R3, SP, 195
;Kinematics.c,345 :: 		i,segments,nPx,nPy);
LW	R2, 64(SP)
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
...
LW	R27, 8(SP)
LH	R28, 4(SP)
;Kinematics.c,348 :: 		SV.cir = 1;
LBU	R2, Offset(_SV+2)(GP)
ORI	R2, R2, 8
SB	R2, Offset(_SV+2)(GP)
;Kinematics.c,349 :: 		DualAxisStep(nPx, nPy,axis_0,axis_1,1000);//,xy);
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
SW	R25, 16(SP)
...
LW	R27, 8(SP)
LH	R28, 4(SP)
;Kinematics.c,351 :: 		while(1){
L_mc_arc42:
;Kinematics.c,353 :: 		if(Test_Port_Pins(axis_0) || Test_Port_Pins(axis_1)){
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
SW	R25, 16(SP)
...
LW	R27, 8(SP)
LH	R28, 4(SP)
;Kinematics.c,355 :: 		limit_error = 1;
ORI	R2, R0, 1
SB	R2, 239(SP)
;Kinematics.c,356 :: 		}
L_mc_arc46:
;Kinematics.c,358 :: 		if(!OC5IE_bit && !OC2IE_bit)
_LX	
...
NOP	
L_mc_arc43:
;Kinematics.c,364 :: 		if(limit_error)
LBU	R2, 239(SP)
...
; end of _mc_arc
_hypot:
;Kinematics.c,379 :: 		float hypot(float angular_travel, float linear_travel){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Kinematics.c,380 :: 		return(sqrt((angular_travel*angular_travel) + (linear_travel*linear_travel)));
MUL.S 	S1, S12, S12
MUL.S 	S0, S13, S13
ADD.S 	S0, S1, S0
MOV.S 	S12, S0
...
; end of _hypot
_GetAxisDirection:
;Kinematics.c,389 :: 		int GetAxisDirection(long mm2move){
;Kinematics.c,390 :: 		return(mm2move < 0)? CCW_:CW_ ;
SLTI	R2, R25, 0
...
; ?FLOC___GetAxisDirection?T359 start address is: 8 (R2)
ORI	R2, R0, 255
; ?FLOC___GetAxisDirection?T359 end address is: 8 (R2)
...
_Home:
;Kinematics.c,403 :: 		int Home(int axis){
ADDIU	SP, SP, -12
SW	RA, 0(SP)
;Kinematics.c,407 :: 		if(sys.state == STATE_IDLE){
SW	R26, 4(SP)
...
NOP	
L__Home128:
;Kinematics.c,408 :: 		speed = 1000;//settings.homing_feed_rate;
ORI	R2, R0, 1000
SW	R2, Offset(Home_speed_L0+0)(GP)
;Kinematics.c,411 :: 		Rst_FP(axis);Rst_FN(axis);
SH	R25, 8(SP)
JAL	_Rst_FP+0
NOP	
LH	R25, 8(SP)
...
NOP	
LH	R25, 8(SP)
;Kinematics.c,414 :: 		bit_false(homing[axis].home_state,bit(HOME_COMPLETE));
SEH	R2, R25
SLL	R3, R2, 2
...
AND	R2, R3, R2
SH	R2, 0(R4)
;Kinematics.c,417 :: 		bit_false(homing[axis].home_state,bit(HOME_REV));
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
AND	R2, R3, R2
SH	R2, 0(R4)
;Kinematics.c,420 :: 		homing[axis].home_cnt = 0;
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
ADDIU	R2, R2, 2
SH	R0, 0(R2)
;Kinematics.c,423 :: 		EnableStepper(axis);//sort this out
SH	R25, 8(SP)
JAL	_EnableStepper+0
NOP	
LH	R25, 8(SP)
;Kinematics.c,426 :: 		sys.state = STATE_HOMING;
ORI	R2, R0, 5
SH	R2, Offset(_sys+2)(GP)
;Kinematics.c,429 :: 		if(!Test_Port_Pins(axis)){
SH	R25, 8(SP)
JAL	_Test_Port_Pins+0
NOP	
LH	R25, 8(SP)
...
NOP	
L__Home129:
;Kinematics.c,431 :: 		homing[axis].home_cnt = 1;
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
ORI	R2, R0, 1
SH	R2, 0(R3)
;Kinematics.c,433 :: 		goto HOMED;
J	___Home_HOMED
NOP	
;Kinematics.c,434 :: 		}
L_Home54:
;Kinematics.c,438 :: 		Home_Axis(-500.0,speed,axis);
LUI	R2, 50170
ORI	R2, R2, 0
SH	R25, 8(SP)
SEH	R26, R25
...
NOP	
LH	R25, 8(SP)
;Kinematics.c,447 :: 		return axis;
SEH	R2, R25
J	L_end_Home
NOP	
;Kinematics.c,448 :: 		}
L_Home53:
;Kinematics.c,452 :: 		if(sys.state == STATE_HOMING){
...
NOP	
L__Home132:
;Kinematics.c,460 :: 		HOMED:
___Home_HOMED:
;Kinematics.c,461 :: 		speed = 100;//settings.homing_seek_rate;
ORI	R2, R0, 100
SW	R2, Offset(Home_speed_L0+0)(GP)
;Kinematics.c,470 :: 		if(bit_isfalse(homing[axis].home_state,BIT_HOME_COMPLETE)){
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
NOP	
L__Home133:
;Kinematics.c,472 :: 		if(bit_isfalse(homing[axis].home_state,BIT_HOME_REV)){
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
NOP	
L__Home134:
;Kinematics.c,475 :: 		if(homing[axis].home_cnt == 1){ //at 1st hit of limit
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
NOP	
L__Home135:
;Kinematics.c,477 :: 		bit_true(homing[axis].home_state,bit(HOME_REV));
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
ORI	R2, R2, 8
SH	R2, 0(R3)
;Kinematics.c,478 :: 		bit_false(homing[axis].home_state,bit(HOME));
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
AND	R2, R3, R2
SH	R2, 0(R4)
;Kinematics.c,481 :: 		Home_Axis(12.0,100, axis);
LUI	R2, 16704
ORI	R2, R2, 0
SH	R25, 8(SP)
SEH	R26, R25
...
NOP	
LH	R25, 8(SP)
;Kinematics.c,483 :: 		}else if(homing[axis].home_cnt > 1){//2nd hit of limit
J	L_Home60
NOP	
L_Home59:
SEH	R2, R25
...
NOP	
L__Home136:
;Kinematics.c,485 :: 		bit_true(homing[axis].home_state,bit(HOME_COMPLETE));
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
ORI	R2, R2, 32
SH	R2, 0(R3)
;Kinematics.c,486 :: 		StopAxis(axis);
SH	R25, 8(SP)
JAL	_StopAxis+0
NOP	
LH	R25, 8(SP)
;Kinematics.c,487 :: 		axis++;
ADDIU	R2, R25, 1
SEH	R25, R2
;Kinematics.c,489 :: 		sys.state = STATE_IDLE;
...
NOP	
L__Home138:
;Kinematics.c,522 :: 		homing[axis].home_cnt++;
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
ADDIU	R2, R2, 1
SH	R2, 0(R3)
;Kinematics.c,523 :: 		if(bit_istrue(homing[axis].home_state,BIT_HOME_REV)){
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
NOP	
L__Home140:
;Kinematics.c,524 :: 		bit_false(homing[axis].home_state,bit(HOME_REV));
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
AND	R2, R3, R2
SH	R2, 0(R4)
;Kinematics.c,525 :: 		Home_Axis(-290.00,50,axis);
LUI	R2, 50065
ORI	R2, R2, 0
SH	R25, 8(SP)
SEH	R26, R25
...
;Kinematics.c,541 :: 		static void Home_Axis(double distance,long speed,int axis){
ADDIU	SP, SP, -20
SW	RA, 0(SP)
...
LW	R25, 8(SP)
LH	R26, 4(SP)
;Kinematics.c,544 :: 		STPS[axis].run_state = STOP ;
SEH	R3, R26
ORI	R2, R0, 100
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 6
SH	R0, 0(R2)
;Kinematics.c,554 :: 		STPS[axis].mmToTravel = belt_steps(distance,axis);
SEH	R3, R26
ORI	R2, R0, 100
MULTU	R2, R3
MFLO	R3
...
LW	R3, 16(SP)
SW	R2, 0(R3)
;Kinematics.c,555 :: 		SingleAxisStep(STPS[axis].mmToTravel, speed,axis);
SEH	R3, R26
ORI	R2, R0, 100
MULTU	R2, R3
MFLO	R3
...
;Kinematics.c,558 :: 		static void ResetHoming(){
;Kinematics.c,559 :: 		int i = 0;
;Kinematics.c,560 :: 		for(i = 0;i< NoOfAxis;i++){
...
;Kinematics.c,561 :: 		homing[i].home_state = 0;
SEH	R2, R4
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
ADDU	R2, R2, R3
SH	R0, 0(R2)
;Kinematics.c,562 :: 		homing[i].home_cnt = 0;
SEH	R2, R4
SLL	R3, R2, 2
LUI	R2, hi_addr(Kinematics_homing+0)
ORI	R2, R2, lo_addr(Kinematics_homing+0)
...
_mc_reset:
;Kinematics.c,571 :: 		void mc_reset(){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Kinematics.c,573 :: 		if (bit_isfalse(sys.execute, EXEC_RESET)) {
...
NOP	
L__mc_reset145:
;Kinematics.c,574 :: 		sys.execute |= EXEC_RESET;
LH	R2, Offset(_sys+18)(GP)
ORI	R2, R2, 16
SH	R2, Offset(_sys+18)(GP)
;Kinematics.c,584 :: 		switch (sys.state) {
J	L_mc_reset68
NOP	
;Kinematics.c,585 :: 		case STATE_CYCLE: case STATE_HOLD: case STATE_HOMING: // case STATE_JOG:
L_mc_reset70:
L_mc_reset71:
L_mc_reset72:
;Kinematics.c,586 :: 		sys.execute |= EXEC_ALARM; // Execute alarm state.
LH	R2, Offset(_sys+18)(GP)
ORI	R2, R2, 32
SH	R2, Offset(_sys+18)(GP)
;Kinematics.c,587 :: 		disableOCx(); // Execute alarm force kills steppers. Position likely lost.
JAL	_disableOCx+0
NOP	
;Kinematics.c,588 :: 		DisableStepper();
JAL	_DisableStepper+0
NOP	
;Kinematics.c,589 :: 		ResetHoming();
