...
NOP	
L__SingleAxisStep91:
;Kinematics.c,82 :: 		tempA = belt_steps(newxyz);
SH	R26, 12(SP)
SW	R25, 16(SP)
JAL	_belt_steps+0
NOP	
...
NOP	
L_SingleAxisStep12:
;Kinematics.c,95 :: 		tempA = belt_steps(newxyz);
SH	R26, 12(SP)
SW	R25, 16(SP)
JAL	_belt_steps+0
NOP	
...
NOP	
L__DualAxisStep94:
;Kinematics.c,126 :: 		tempA = belt_steps(axis_a);//ulong2flt( STPS[axisA].steps_abs_position);
SW	R27, 8(SP)
SH	R26, 12(SP)
SH	R25, 14(SP)
SWC1	S13, 16(SP)
...
LH	R26, 12(SP)
SW	R2, 20(SP)
;Kinematics.c,127 :: 		tempB = belt_steps(axis_b);//ulong2flt( STPS[axisB].steps_abs_position);
SH	R26, 12(SP)
SH	R25, 14(SP)
MOV.S 	S12, S13
JAL	_belt_steps+0
...
NOP	
L_DualAxisStep16:
;Kinematics.c,132 :: 		tempA = belt_steps(axis_a);
SW	R27, 8(SP)
SH	R26, 12(SP)
SH	R25, 14(SP)
SWC1	S13, 16(SP)
...
LH	R26, 12(SP)
SW	R2, 20(SP)
;Kinematics.c,133 :: 		tempB = belt_steps(axis_b);
SH	R26, 12(SP)
SH	R25, 14(SP)
MOV.S 	S12, S13
JAL	_belt_steps+0
...
NOP	
ADDIU	R3, SP, 68
;Kinematics.c,308 :: 		cos_T,sin_T,radius,segments,angular_travel,mm_of_travel,linear_travel,linear_per_segment,theta_per_segment);
LW	R2, 260(SP)
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R25, 12(SP)
...
ORI	R2, R0, 1000
SW	R2, 0(R3)
;Kinematics.c,341 :: 		if(!DMA_IsOn(1));
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
SW	R25, 16(SP)
...
NOP	
ADDIU	R3, SP, 195
;Kinematics.c,343 :: 		i,segments,nPx,nPy,tempA,tempB);
LW	R2, 24(SP)
SH	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
...
SLTI	R2, R25, 0
BNE	R2, R0, L__GetAxisDirection120
NOP	
J	L_GetAxisDirection48
NOP	
L__GetAxisDirection120:
...
ADDIU	R2, R2, 6
SH	R0, 0(R2)
;Kinematics.c,552 :: 		STPS[axis].mmToTravel = belt_steps(distance);
SEH	R3, R26
ORI	R2, R0, 100
MULTU	R2, R3
MFLO	R3
...
SEH	R2, R4
SLTI	R2, R2, 2
BNE	R2, R0, L_Kinematics_ResetHoming137
NOP	
J	L_Kinematics_ResetHoming62
NOP	
L_Kinematics_ResetHoming137:
