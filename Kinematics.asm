...
;Kinematics.c,129 :: 		Axis_Interpolate(X,Y);
ORI	R26, R0, 1
MOVZ	R25, R0, R0
...
;Kinematics.c,164 :: 		Axis_Interpolate(X,Z);
ORI	R26, R0, 2
MOVZ	R25, R0, R0
JAL	_Axis_Interpolate+0
NOP	
...
L_DualAxisStep40:
;Kinematics.c,170 :: 		axis_xyz = yz;
ORI	R2, R0, 2
SB	R2, Offset(_axis_xyz+0)(GP)
;Kinematics.c,171 :: 		STPS[Y].axis_dir = Direction(axis_a);
SLTI	R2, R25, 0
...
; ?FLOC___DualAxisStep?T128 end address is: 12 (R3)
SH	R2, Offset(_STPS+180)(GP)
;Kinematics.c,172 :: 		STPS[Z].axis_dir = Direction(axis_b);
SLTI	R2, R26, 0
...
; ?FLOC___DualAxisStep?T131 end address is: 12 (R3)
SH	R2, Offset(_STPS+272)(GP)
;Kinematics.c,174 :: 		Multi_Axis_Enable(axis_xyz);
SW	R26, 12(SP)
SW	R25, 16(SP)
LBU	R25, Offset(_axis_xyz+0)(GP)
JAL	_Multi_Axis_Enable+0
...
LW	R25, 16(SP)
LW	R26, 12(SP)
;Kinematics.c,178 :: 		SV.dy   = axis_a - SV.pz;
LW	R2, Offset(_SV+40)(GP)
SUBU	R2, R25, R2
SW	R2, Offset(_SV+20)(GP)
;Kinematics.c,179 :: 		SV.dz   = axis_b - SV.py;
LW	R2, Offset(_SV+36)(GP)
SUBU	R2, R26, R2
SW	R2, Offset(_SV+24)(GP)
;Kinematics.c,181 :: 		dirA = SV.dy > 0? CW:CCW;
LW	R2, Offset(_SV+20)(GP)
SLTI	R2, R2, 1
...
SEB	R4, R2
; ?FLOC___DualAxisStep?T135 end address is: 8 (R2)
;Kinematics.c,182 :: 		dirB = SV.dz > 0? CW:CCW;
LW	R2, Offset(_SV+24)(GP)
SLTI	R2, R2, 1
...
SEB	R5, R2
; ?FLOC___DualAxisStep?T137 end address is: 8 (R2)
;Kinematics.c,184 :: 		DIR_StepY = (Y_DIR_DIR ^ dirA) & 0x0001;
ANDI	R3, R4, 1
; dirA end address is: 16 (R4)
_LX	
INS	R2, R3, BitPos(DIR_StepY+0), 1
_SX	
;Kinematics.c,185 :: 		DIR_StepZ = (Z_DIR_DIR ^ dirB) & 0x0001;
ANDI	R3, R5, 1
; dirB end address is: 20 (R5)
_LX	
INS	R2, R3, BitPos(DIR_StepZ+0), 1
_SX	
;Kinematics.c,187 :: 		SV.dy = labs(SV.dy);
LW	R25, Offset(_SV+20)(GP)
JAL	_labs+0
NOP	
SW	R2, Offset(_SV+20)(GP)
;Kinematics.c,188 :: 		SV.dz = labs(SV.dz);
LW	R25, Offset(_SV+24)(GP)
JAL	_labs+0
NOP	
SW	R2, Offset(_SV+24)(GP)
;Kinematics.c,190 :: 		if(SV.dy > SV.dz)
LW	R3, Offset(_SV+20)(GP)
SLT	R2, R2, R3
...
NOP	
L__DualAxisStep145:
;Kinematics.c,191 :: 		SV.d2 = BresDiffVal(SV.dz,SV.dy);//2*(SV.dz - SV.dy);
LW	R3, Offset(_SV+20)(GP)
LW	R2, Offset(_SV+24)(GP)
SUBU	R2, R2, R3
SLL	R2, R2, 1
...
NOP	
L_DualAxisStep49:
;Kinematics.c,193 :: 		SV.d2 = BresDiffVal(SV.dy,SV.dz);//2* (SV.dy - SV.dz);
...
SW	R2, Offset(_SV+12)(GP)
L_DualAxisStep50:
;Kinematics.c,195 :: 		STPS[Y].step_count = 0;
SW	R0, Offset(_STPS+124)(GP)
;Kinematics.c,196 :: 		STPS[Z].step_count = 0;
SW	R0, Offset(_STPS+216)(GP)
;Kinematics.c,198 :: 		Axis_Interpolate(Y,Z);
ORI	R26, R0, 2
ORI	R25, R0, 1
JAL	_Axis_Interpolate+0
NOP	
;Kinematics.c,199 :: 		break;
J	L_DualAxisStep15
NOP	
;Kinematics.c,200 :: 		default: break;
L_DualAxisStep51:
J	L_DualAxisStep15
NOP	
;Kinematics.c,202 :: 		}
...
_r_or_ijk:
;Kinematics.c,223 :: 		double r, double i, double j, double k, int axis_A,int axis_B,int dir){
ADDIU	SP, SP, -120
SW	RA, 0(SP)
SW	R25, 4(SP)
SW	R26, 8(SP)
...
;Kinematics.c,224 :: 		unsigned short isclockwise = 0;
;Kinematics.c,225 :: 		double inverse_feed_rate = -1; // negative inverse_feed_rate means no inverse_feed_rate specified
;Kinematics.c,229 :: 		double x = 0.00;
;Kinematics.c,230 :: 		double y = 0.00;
;Kinematics.c,231 :: 		double h_x2_div_d = 0.00;
;Kinematics.c,235 :: 		position[axis_A] = Cur_axis_a;
ADDIU	R3, SP, 28
SEH	R2, R25
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S12, 0(R2)
;Kinematics.c,236 :: 		position[axis_B] = Cur_axis_b;
SEH	R2, R26
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S13, 0(R2)
;Kinematics.c,237 :: 		target[axis_A] = Fin_axis_a;
ADDIU	R3, SP, 52
SEH	R2, R25
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S14, 0(R2)
;Kinematics.c,238 :: 		target[axis_B] = Fin_axis_b;
SEH	R2, R26
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S15, 0(R2)
;Kinematics.c,239 :: 		offset[axis_A] = i;
ADDIU	R3, SP, 76
SEH	R2, R25
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S1, 0(R2)
;Kinematics.c,240 :: 		offset[axis_B] = j;
SEH	R2, R26
SLL	R2, R2, 2
ADDU	R2, R3, R2
SWC1	S2, 0(R2)
;Kinematics.c,242 :: 		if (r != 0.00) { // Arc Radius Mode
MOVZ	R2, R0, R0
MTC1	R2, S0
C.EQ.S 	0, S6, S0
...
;Kinematics.c,306 :: 		x = target[axis_plane_a] - position[axis_plane_a];
ADDIU	R5, SP, 52
LHU	R2, 100(SP)
SLL	R3, R2, 2
ADDU	R2, R5, R3
...
MOV.S 	S4, S3
;Kinematics.c,308 :: 		y = target[axis_plane_b] - position[axis_plane_b];
LHU	R2, 102(SP)
SLL	R3, R2, 2
ADDU	R2, R5, R3
LWC1	S1, 0(R2)
...
MOV.S 	S5, S2
;Kinematics.c,312 :: 		h_x2_div_d = 4 * r*r - x*x - y*y;
LUI	R2, 16512
ORI	R2, R2, 0
MTC1	R2, S0
MUL.S 	S0, S0, S6
...
MUL.S 	S0, S2, S2
SUB.S 	S0, S1, S0
;Kinematics.c,315 :: 		h_x2_div_d = -sqrt(h_x2_div_d)/hypot(x,y); // == -(h * 2 / d)
MOV.S 	S12, S0
JAL	_sqrt+0
NOP	
MOVZ	R2, R0, R0
...
MOV.S 	S1, S0
;Kinematics.c,317 :: 		if (gc.motion_mode == MOTION_MODE_CCW_ARC) { h_x2_div_d = -h_x2_div_d; }
...
NOP	
L__r_or_ijk155:
;Kinematics.c,341 :: 		h_x2_div_d = -h_x2_div_d;
MOVZ	R2, R0, R0
MTC1	R2, S0
SUB.S 	S0, S0, S1
; h_x2_div_d end address is: 8 (R2)
...
MOV.S 	S3, S0
;Kinematics.c,342 :: 		r = -r; // Finished with r. Set to positive for mc_arc
MOVZ	R2, R0, R0
MTC1	R2, S0
SUB.S 	S0, S0, S6
...
;Kinematics.c,343 :: 		}
L_r_or_ijk54:
;Kinematics.c,346 :: 		i =  0.5*(x-(y*h_x2_div_d));
; r start address is: 16 (R4)
; h_x2_div_d start address is: 24 (R6)
MUL.S 	S0, S5, S3
SUB.S 	S1, S4, S0
...
;Kinematics.c,348 :: 		j =  0.5*(y+(x*h_x2_div_d));
MUL.S 	S0, S4, S3
...
;Kinematics.c,349 :: 		} else {
MOV.S 	S16, S2
; r end address is: 16 (R4)
J	L_r_or_ijk55
NOP	
L_r_or_ijk52:
;Kinematics.c,352 :: 		r = hypot(i, j); // Compute arc radius for mc_arc
; j start address is: 16 (R4)
; i start address is: 8 (R2)
MOV.S 	S13, S2
; j end address is: 16 (R4)
...
;Kinematics.c,353 :: 		}
L_r_or_ijk55:
;Kinematics.c,354 :: 		dma_printf("Radius:= %f",r);
...
LH	R27, 24(SP)
LWC1	S16, 20(SP)
;Kinematics.c,357 :: 		isclockwise = false;
; isclockwise start address is: 24 (R6)
MOVZ	R6, R0, R0
;Kinematics.c,358 :: 		if (dir == CW) { isclockwise = true; }
SEH	R2, R27
...
ADDIU	R4, SP, 52
ADDIU	R3, SP, 28
;Kinematics.c,363 :: 		DEFAULT_FEEDRATE, gc.inverse_feed_rate_mode,r, isclockwise);
LUI	R2, 17274
ORI	R2, R2, 0
MOV.S 	S13, S16
...
; end of _r_or_ijk
_mc_arc:
;Kinematics.c,369 :: 		uint8_t axis_linear, double feed_rate, uint8_t invert_feed_rate, double radius, uint8_t isclockwise){
ADDIU	SP, SP, -84
SW	RA, 0(SP)
LBU	R2, 84(SP)
SB	R2, 84(SP)
...
LBU	R7, 87(SP)
;Kinematics.c,371 :: 		double center_axis0            = position[axis_0] + offset[axis_0];
ANDI	R2, R28, 255
SLL	R5, R2, 2
ADDU	R2, R25, R5
LWC1	S0, 0(R2)
...
ADD.S 	S4, S0, S5
SWC1	S4, 20(SP)
;Kinematics.c,372 :: 		double center_axis1             = position[axis_1] + offset[axis_1];
LBU	R2, 84(SP)
SLL	R4, R2, 2
ADDU	R2, R25, R4
LWC1	S0, 0(R2)
...
ADD.S 	S2, S0, S3
SWC1	S2, 24(SP)
;Kinematics.c,373 :: 		double linear_travel           = target[axis_linear] - position[axis_linear];
LBU	R2, 85(SP)
SLL	R3, R2, 2
ADDU	R2, R26, R3
LWC1	S1, 0(R2)
...
MOV.S 	S6, S0
;Kinematics.c,374 :: 		double r_axis0                 = -offset[axis_0];  // Radius vector from center to current location
MOVZ	R2, R0, R0
MTC1	R2, S0
SUB.S 	S0, S0, S5
SWC1	S0, 28(SP)
;Kinematics.c,375 :: 		double r_axis1                 = -offset[axis_1];
MOVZ	R2, R0, R0
MTC1	R2, S0
SUB.S 	S0, S0, S3
SWC1	S0, 32(SP)
;Kinematics.c,376 :: 		double rt_axis0                = target[axis_0] - center_axis0;
ADDU	R2, R26, R5
LWC1	S0, 0(R2)
SUB.S 	S0, S0, S4
; rt_axis0 start address is: 24 (R6)
MOV.S 	S3, S0
;Kinematics.c,377 :: 		double rt_axis1                 = target[axis_1] - center_axis1;
ADDU	R2, R26, R4
LWC1	S0, 0(R2)
SUB.S 	S0, S0, S2
; rt_axis1 start address is: 32 (R8)
MOV.S 	S4, S0
;Kinematics.c,378 :: 		double theta_per_segment       = 0.00;
;Kinematics.c,379 :: 		double linear_per_segment      = 0.00;
;Kinematics.c,380 :: 		double angular_travel          = 0.00;
;Kinematics.c,381 :: 		double millimeters_of_travel   = 0.00;
;Kinematics.c,382 :: 		uint16_t segments              = 0;
;Kinematics.c,383 :: 		double cos_T                   = 0.00;
;Kinematics.c,384 :: 		double sin_T                   = 0.00;
;Kinematics.c,391 :: 		int8_t count = 0;
MOVZ	R30, R0, R0
SB	R30, 57(SP)
;Kinematics.c,397 :: 		angular_travel = atan2(r_axis0*rt_axis1-r_axis1*rt_axis0, r_axis0*rt_axis0+r_axis1*rt_axis1);
LWC1	S0, 28(SP)
MUL.S 	S1, S0, S3
LWC1	S0, 32(SP)
MUL.S 	S0, S0, S4
...
LWC1	S13, 4(SP)
SWC1	S0, 68(SP)
;Kinematics.c,399 :: 		if (isclockwise) {
...
MFC1	R2, S0
SH	R2, 72(SP)
;Kinematics.c,415 :: 		if (invert_feed_rate) { feed_rate *= segments; }
...
DIV.S 	S2, S1, S0
SWC1	S2, 60(SP)
;Kinematics.c,421 :: 		linear_per_segment = linear_travel/segments;
DIV.S 	S0, S6, S0
...
SUB.S 	S0, S0, S1
SWC1	S0, 76(SP)
;Kinematics.c,449 :: 		sin_T = theta_per_segment;
SWC1	S2, 80(SP)
;Kinematics.c,451 :: 		nPx = arc_target[X] = position[X];
ADDIU	R2, SP, 36
LWC1	S0, 0(R25)
SWC1	S0, 0(R2)
...
NOP	
L__mc_arc164:
;Kinematics.c,454 :: 		if (count < n_arc_correction) {
LBU	R3, 56(SP)
LB	R2, 57(SP)
SLT	R2, R2, R3
...
MUL.S 	S0, S0, S1
ADD.S 	S3, S2, S0
;Kinematics.c,457 :: 		r_axis0 = r_axis0*cos_T - r_axis1*sin_T;
LWC1	S1, 76(SP)
LWC1	S0, 28(SP)
MUL.S 	S2, S0, S1
LWC1	S1, 80(SP)
...
SUB.S 	S0, S2, S0
SWC1	S0, 28(SP)
;Kinematics.c,458 :: 		r_axis1 = r_axisi;
SWC1	S3, 32(SP)
;Kinematics.c,459 :: 		count++;
LB	R2, 57(SP)
ADDIU	R2, R2, 1
SB	R2, 57(SP)
;Kinematics.c,460 :: 		} else {
J	L_mc_arc66
NOP	
L_mc_arc65:
;Kinematics.c,463 :: 		cos_Ti = cos(i*theta_per_segment);
LHU	R2, 48(SP)
MTC1	R2, S0
CVT32.W 	S1, S0
LWC1	S0, 60(SP)
...
MOV.S 	S5, S0
;Kinematics.c,464 :: 		sin_Ti = sin(i*theta_per_segment);
LHU	R2, 48(SP)
MTC1	R2, S0
CVT32.W 	S1, S0
LWC1	S0, 60(SP)
...
;Kinematics.c,489 :: 		STPS[Y].mmToTravel = belt_steps(nPy);//calcSteps(nPy,8.06);
LWC1	S12, 52(SP)
JAL	_belt_steps+0
NOP	
LW	R25, 16(SP)
...
;Kinematics.c,490 :: 		tempA = abs(STPS[X].mmToTravel);
SW	R25, 4(SP)
...
SEH	R3, R2
;Kinematics.c,491 :: 		tempB = abs(STPS[Y].mmToTravel);
...
LBU	R28, 4(SP)
L_mc_arc73:
;Kinematics.c,498 :: 		DualAxisStep(STPS[X].mmToTravel, STPS[Y].mmToTravel,xy);
SB	R28, 4(SP)
SW	R27, 8(SP)
SW	R26, 12(SP)
SW	R25, 16(SP)
...
; end of _mc_arc
_hypot:
;Kinematics.c,507 :: 		float hypot(float angular_travel, float linear_travel){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Kinematics.c,508 :: 		return(sqrt((angular_travel*angular_travel) + (linear_travel*linear_travel)));
MUL.S 	S1, S12, S12
MUL.S 	S0, S13, S13
ADD.S 	S0, S1, S0
MOV.S 	S12, S0
...
; end of _hypot
_GetAxisDirection:
;Kinematics.c,517 :: 		int GetAxisDirection(long mm2move){
;Kinematics.c,518 :: 		return(mm2move < 0)? CCW_:CW_ ;
SLTI	R2, R25, 0
...
_ResetHoming:
;Kinematics.c,525 :: 		void ResetHoming(){
;Kinematics.c,526 :: 		int i = 0;
;Kinematics.c,527 :: 		for(i = 0;i< NoOfAxis;i++){
...
NOP	
L__ResetHoming173:
;Kinematics.c,528 :: 		homing[i].set = 0;
SEH	R2, R4
SLL	R3, R2, 2
...
INS	R2, R0, 0, 1
SB	R2, 0(R3)
;Kinematics.c,529 :: 		homing[i].complete = 0;
SEH	R2, R4
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
INS	R2, R0, 4, 1
SB	R2, 0(R3)
;Kinematics.c,530 :: 		homing[i].home_cnt = 0;
SEH	R2, R4
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
ADDIU	R2, R2, 2
SH	R0, 0(R2)
;Kinematics.c,531 :: 		homing[i].rev = 0;
SEH	R2, R4
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
INS	R2, R0, 2, 1
SB	R2, 0(R3)
;Kinematics.c,532 :: 		homing[i].home = 0;
SEH	R2, R4
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
; end of _ResetHoming
_Home:
;Kinematics.c,537 :: 		void Home(int axis){
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;Kinematics.c,538 :: 		long speed = 0;
SW	R26, 4(SP)
;Kinematics.c,540 :: 		if(!homing[axis].set){
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
NOP	
L__Home175:
;Kinematics.c,541 :: 		homing[axis].set = 1;
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
ORI	R2, R2, 1
SB	R2, 0(R3)
;Kinematics.c,542 :: 		homing[axis].complete = 0;
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
INS	R2, R0, 4, 1
SB	R2, 0(R3)
;Kinematics.c,543 :: 		homing[axis].home_cnt = 0;
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
ADDIU	R2, R2, 2
SH	R0, 0(R2)
;Kinematics.c,544 :: 		speed = 2000;
; speed start address is: 16 (R4)
ORI	R4, R0, 2000
;Kinematics.c,545 :: 		}else{
; speed end address is: 16 (R4)
J	L_Home80
NOP	
L_Home79:
;Kinematics.c,546 :: 		speed = 100;
; speed start address is: 16 (R4)
ORI	R4, R0, 100
; speed end address is: 16 (R4)
;Kinematics.c,547 :: 		}
L_Home80:
;Kinematics.c,551 :: 		if(FP(axis)){
; speed start address is: 16 (R4)
SW	R4, 8(SP)
SH	R25, 12(SP)
JAL	_FP+0
...
NOP	
L_Home82:
;Kinematics.c,554 :: 		else if(axis == Y)
SEH	R3, R25
ORI	R2, R0, 1
...
L_Home84:
L_Home83:
;Kinematics.c,557 :: 		if(!homing[axis].rev){
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
NOP	
L__Home180:
;Kinematics.c,558 :: 		homing[axis].rev = 1;
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
ORI	R2, R2, 4
SB	R2, 0(R3)
;Kinematics.c,559 :: 		Inv_Home_Axis(2.0,speed, axis);
LUI	R2, 16384
ORI	R2, R2, 0
SW	R4, 8(SP)
SH	R25, 12(SP)
...
NOP	
L__Home182:
;Kinematics.c,565 :: 		homing[axis].home = 0;
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
;Kinematics.c,566 :: 		}
L_Home86:
;Kinematics.c,568 :: 		if((!OC5IE_bit && !OC2IE_bit && !OC7IE_bit && !OC3IE_bit)){
_LX	
EXT	R2, R2, BitPos(OC5IE_bit+0), 1
...
L__Home186:
L__Home109:
;Kinematics.c,570 :: 		if(!homing[axis].home){
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
NOP	
L__Home187:
;Kinematics.c,571 :: 		homing[axis].home = 1;
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
ORI	R2, R2, 2
SB	R2, 0(R3)
;Kinematics.c,572 :: 		Home_Axis(-290.00,speed,axis);
LUI	R2, 50065
ORI	R2, R2, 0
SH	R25, 8(SP)
SEH	R26, R25
...
;Kinematics.c,573 :: 		}
L_Home90:
;Kinematics.c,575 :: 		if((homing[axis].home_cnt >= 2)&&(!homing[axis].complete)){
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
L__Home189:
L__Home108:
;Kinematics.c,576 :: 		homing[axis].complete      = 1;
SEH	R2, R25
SLL	R3, R2, 2
LUI	R2, hi_addr(_homing+0)
ORI	R2, R2, lo_addr(_homing+0)
...
ORI	R2, R2, 16
SB	R2, 0(R3)
;Kinematics.c,577 :: 		STPS[axis].step_count      = 0;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 32
SW	R0, 0(R2)
;Kinematics.c,578 :: 		STPS[axis].steps_position  = 0;
SEH	R3, R25
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
; end of _Home
_Home_Axis:
;Kinematics.c,585 :: 		void Home_Axis(double distance,long speed,int axis){
ADDIU	SP, SP, -24
SW	RA, 0(SP)
;Kinematics.c,586 :: 		distance = (distance < max_sizes[axis])? max_sizes[axis]:distance;
SW	R25, 4(SP)
SW	R27, 8(SP)
SEH	R2, R26
SLL	R3, R2, 2
...
; ?FLOC___Home_Axis?T534 start address is: 8 (R2)
MOV.S 	S12, S1
;Kinematics.c,587 :: 		distance = (distance < 0.0)? distance : -distance;
MOVZ	R2, R0, R0
MTC1	R2, S0
C.LE.S 	0, S0, S1
...
; ?FLOC___Home_Axis?T536 start address is: 0 (R0)
MOV.S 	S12, S0
;Kinematics.c,588 :: 		STPS[axis].mmToTravel = belt_steps(distance);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R3, 20(SP)
SW	R2, 0(R3)
;Kinematics.c,589 :: 		speed_cntr_Move(STPS[axis].mmToTravel, speed ,axis);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
NOP	
LH	R26, 12(SP)
;Kinematics.c,590 :: 		SingleAxisStep(STPS[axis].mmToTravel,axis);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
; end of _Home_Axis
_Inv_Home_Axis:
;Kinematics.c,593 :: 		void Inv_Home_Axis(double distance,long speed,int axis){
ADDIU	SP, SP, -24
SW	RA, 0(SP)
;Kinematics.c,594 :: 		distance = (distance > 10.0)?  10.0 : distance;
SW	R25, 4(SP)
SW	R27, 8(SP)
LUI	R2, 16672
ORI	R2, R2, 0
...
; ?FLOC___Inv_Home_Axis?T559 start address is: 8 (R2)
MOV.S 	S12, S1
;Kinematics.c,595 :: 		distance *= (distance < 0.0)?  -1.0 : 1.0;
MOVZ	R2, R0, R0
MTC1	R2, S0
C.LE.S 	0, S0, S1
...
; ?FLOC___Inv_Home_Axis?T561 end address is: 8 (R2)
MOV.S 	S12, S0
;Kinematics.c,596 :: 		STPS[axis].mmToTravel = belt_steps(distance);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
LW	R3, 20(SP)
SW	R2, 0(R3)
;Kinematics.c,597 :: 		speed_cntr_Move(STPS[axis].mmToTravel, speed ,axis);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
...
NOP	
LH	R26, 12(SP)
;Kinematics.c,598 :: 		SingleAxisStep(STPS[axis].mmToTravel,axis);
SEH	R3, R26
ORI	R2, R0, 92
MULTU	R2, R3
MFLO	R3
