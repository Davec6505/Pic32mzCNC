...
SH	R0, 2(SP)
;Main.c,73 :: 		EnableInterrupts();
EI	R30
;Main.c,75 :: 		while(1){
L_main0:
;Main.c,77 :: 		Debounce_Limits(X);
MOVZ	R25, R0, R0
JAL	_Debounce_Limits+0
NOP	
;Main.c,78 :: 		Debounce_Limits(Y);
ORI	R25, R0, 1
JAL	_Debounce_Limits+0
NOP	
;Main.c,81 :: 		if(!status_of_gcode){
LH	R2, 2(SP)
BEQ	R2, R0, L__main80
NOP	
J	L_main2
NOP	
L__main80:
;Main.c,83 :: 		modal_group = Get_modalgroup();
JAL	_Get_modalgroup+0
NOP	
; modal_group start address is: 16 (R4)
SEH	R4, R2
;Main.c,84 :: 		switch(modal_group){
J	L_main3
NOP	
; modal_group end address is: 16 (R4)
;Main.c,85 :: 		case 0:break;
L_main5:
J	L_main4
NOP	
;Main.c,86 :: 		case 2://MODAL_GROUP_0: // [G4,G10,G28,G30,G53,G92,G92.1] Non-modal
L_main6:
;Main.c,87 :: 		modal_action = Non_Modal_Actions(Get_modalword());
JAL	_Get_modalword+0
NOP	
SEH	R25, R2
JAL	_Non_Modal_Actions+0
NOP	
;Main.c,88 :: 		modal_group = Rst_modalgroup();
JAL	_Rst_modalgroup+0
NOP	
;Main.c,89 :: 		break;
J	L_main4
NOP	
;Main.c,90 :: 		case 4://MODAL_GROUP_1: // [G0,G1,G2,G3,G80] Motion
L_main7:
;Main.c,91 :: 		axis_to_run = Get_Axisword();
JAL	_Get_Axisword+0
NOP	
SH	R2, 0(SP)
;Main.c,92 :: 		if(axis_to_run){
BNE	R2, R0, L__main82
NOP	
J	L_main8
NOP	
L__main82:
;Main.c,93 :: 		EnableSteppers(2);
ORI	R25, R0, 2
JAL	_EnableSteppers+0
NOP	
;Main.c,94 :: 		Temp_Move(axis_to_run);
LH	R25, 0(SP)
JAL	_Temp_Move+0
NOP	
;Main.c,95 :: 		axis_to_run = Rst_Axisword();
JAL	_Rst_Axisword+0
NOP	
;Main.c,96 :: 		}
L_main8:
...
J	L_main4
NOP	
;Main.c,98 :: 		case 8://MODAL_GROUP_2  [G17,G18,G19] Plane selection
L_main9:
;Main.c,99 :: 		break;
J	L_main4
NOP	
;Main.c,100 :: 		case 16://MODAL_GROUP_3 [G90,G91] Distance mode
L_main10:
;Main.c,101 :: 		break;
J	L_main4
NOP	
;Main.c,102 :: 		case 32://MODAL_GROUP_4 [M0,M1,M2,M30] Stopping
L_main11:
;Main.c,103 :: 		break;
J	L_main4
NOP	
;Main.c,104 :: 		case 64://MODAL_GROUP_5 [G93,G94] Feed rate mode
L_main12:
;Main.c,105 :: 		break;
J	L_main4
NOP	
;Main.c,106 :: 		case 128://MODAL_GROUP_6 [G20,G21] Units
L_main13:
;Main.c,107 :: 		break;
J	L_main4
NOP	
;Main.c,108 :: 		case 256://MODAL_GROUP_7 [M3,M4,M5] Spindle turning
L_main14:
;Main.c,109 :: 		break;
J	L_main4
NOP	
;Main.c,110 :: 		case 512://MODAL_GROUP_12 [G54,G55,G56,G57,G58,G59] Coordinate system selection
L_main15:
;Main.c,111 :: 		break;
J	L_main4
NOP	
...
;Main.c,113 :: 		}
L_main2:
;Main.c,114 :: 		status_of_gcode = Sample_Ringbuffer();
JAL	_Sample_Ringbuffer+0
NOP	
SH	R2, 2(SP)
;Main.c,118 :: 		LED1 = TMR.clock >> 4;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 4
_LX	
INS	R2, R3, BitPos(LED1+0), 1
_SX	
;Main.c,123 :: 		if(disable_steps <= SEC_TO_DISABLE_STEPPERS)
...
NOP	
L__main103:
;Main.c,124 :: 		disable_steps = TMR.Reset(SEC_TO_DISABLE_STEPPERS,disable_steps);
...
L_main16:
;Main.c,131 :: 		if(STPS[X].run_state != STOP || STPS[Y].run_state != STOP){
...
L__main77:
L__main76:
;Main.c,132 :: 		while(DMA_IsOn(1));
L_main20:
ORI	R25, R0, 1
JAL	_DMA_IsOn+0
NOP	
BNE	R2, R0, L__main107
NOP	
J	L_main21
NOP	
L__main107:
...
NOP	
L_main21:
;Main.c,134 :: 		(STPS[X].run_state&0xff),STPS[X].step_count,
LHU	R2, Offset(_STPS+6)(GP)
ANDI	R4, R2, 255
;Main.c,133 :: 		dma_printf("run_state:= %d\t%l\t%l\t%l\t%l\t%d\n",
ADDIU	R23, SP, 4
ADDIU	R22, R23, 31
...
NOP	
ADDIU	R3, SP, 4
;Main.c,135 :: 		SV.dA,STPS[Y].step_count,SV.dB,STPS[X].step_delay);
...
; end of _main
_Temp_Move:
;Main.c,144 :: 		int Temp_Move(int a){
ADDIU	SP, SP, -32
SW	RA, 0(SP)
;Main.c,145 :: 		switch(a){
SW	R26, 4(SP)
...
J	L_Temp_Move22
NOP	
;Main.c,146 :: 		case 1: //b0000 0001
L_Temp_Move24:
;Main.c,147 :: 		SingleAxisStep(gc.next_position[X],gc.frequency,X);
SH	R25, 12(SP)
MOVZ	R26, R0, R0
...
J	L_Temp_Move23
NOP	
;Main.c,149 :: 		case 2://b0000 0010
L_Temp_Move25:
;Main.c,150 :: 		SingleAxisStep(gc.next_position[Y],gc.frequency,Y);
SH	R25, 12(SP)
ORI	R26, R0, 1
LH	R25, Offset(_gc+12)(GP)
...
J	L_Temp_Move23
NOP	
;Main.c,152 :: 		case 3://b0000 0011
L_Temp_Move26:
;Main.c,153 :: 		while(DMA_IsOn(1));
L_Temp_Move27:
SH	R25, 12(SP)
ORI	R25, R0, 1
JAL	_DMA_IsOn+0
...
NOP	
ADDIU	SP, SP, 12
;Main.c,155 :: 		DualAxisStep(gc.next_position[X], gc.next_position[Y],X,Y,gc.frequency);
...
J	L_Temp_Move23
NOP	
;Main.c,159 :: 		case 4://b0000 0100
L_Temp_Move29:
;Main.c,160 :: 		SingleAxisStep(gc.next_position[Z],gc.frequency,Z);
SH	R25, 12(SP)
ORI	R26, R0, 2
LH	R25, Offset(_gc+12)(GP)
...
J	L_Temp_Move23
NOP	
;Main.c,162 :: 		case 5://b0000 0101
L_Temp_Move30:
;Main.c,163 :: 		DualAxisStep(gc.next_position[X], gc.next_position[Z],X,Z,gc.frequency);
SH	R25, 12(SP)
LH	R27, Offset(_gc+12)(GP)
ORI	R26, R0, 2
MOVZ	R25, R0, R0
...
J	L_Temp_Move23
NOP	
;Main.c,165 :: 		case 6://b0000 0110
L_Temp_Move31:
;Main.c,166 :: 		DualAxisStep(gc.next_position[Y], gc.next_position[Z],Y,Z,gc.frequency);
SH	R25, 12(SP)
LH	R27, Offset(_gc+12)(GP)
ORI	R26, R0, 2
ORI	R25, R0, 1
...
J	L_Temp_Move23
NOP	
;Main.c,168 :: 		case 8://b0000 1000
L_Temp_Move32:
;Main.c,169 :: 		SingleAxisStep(gc.next_position[A],gc.frequency,A);
SH	R25, 12(SP)
ORI	R26, R0, 3
LH	R25, Offset(_gc+12)(GP)
...
J	L_Temp_Move23
NOP	
;Main.c,171 :: 		case 9://b0000 1001
L_Temp_Move33:
;Main.c,172 :: 		DualAxisStep(gc.next_position[X], gc.next_position[A],X,A,gc.frequency);
SH	R25, 12(SP)
LH	R27, Offset(_gc+12)(GP)
ORI	R26, R0, 3
MOVZ	R25, R0, R0
...
J	L_Temp_Move23
NOP	
;Main.c,174 :: 		case 10://b0000 1010
L_Temp_Move34:
;Main.c,175 :: 		DualAxisStep(gc.next_position[Y], gc.next_position[A],Y,A,gc.frequency);
SH	R25, 12(SP)
LH	R27, Offset(_gc+12)(GP)
ORI	R26, R0, 3
ORI	R25, R0, 1
...
J	L_Temp_Move23
NOP	
;Main.c,177 :: 		case 12://b0000 1100
L_Temp_Move35:
;Main.c,178 :: 		DualAxisStep(gc.next_position[Z], gc.next_position[A],Z,A,gc.frequency);
SH	R25, 12(SP)
LH	R27, Offset(_gc+12)(GP)
ORI	R26, R0, 3
ORI	R25, R0, 2
...
J	L_Temp_Move23
NOP	
;Main.c,180 :: 		case 13://Homing X axis
L_Temp_Move36:
;Main.c,181 :: 		Home(X);
SH	R25, 12(SP)
MOVZ	R25, R0, R0
...
J	L_Temp_Move23
NOP	
;Main.c,183 :: 		case 14://Homing Y axis
L_Temp_Move37:
;Main.c,184 :: 		Home(Y);
SH	R25, 12(SP)
ORI	R25, R0, 1
...
J	L_Temp_Move23
NOP	
;Main.c,186 :: 		case 15://Homing Y axis
L_Temp_Move38:
;Main.c,187 :: 		r_or_ijk(150.00, 30.00, 150.00, 30.00, 0.00, -50.00, 50.00,0.00,X,Y,CW);
LUI	R5, 16880
ORI	R5, R5, 0
LUI	R4, 17174
ORI	R4, R4, 0
...
; end of _Temp_Move
_Non_Modal_Actions:
;Main.c,196 :: 		int Non_Modal_Actions(int action){
ADDIU	SP, SP, -68
SW	RA, 0(SP)
;Main.c,201 :: 		switch(action){
SW	R26, 4(SP)
SW	R27, 8(SP)
...
MOVZ	R5, R0, R0
;Main.c,205 :: 		if(gc.S > 0){ //wait in seconds
...
;Main.c,208 :: 		LED2 = TMR.clock >> 1;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 1
_LX	
INS	R2, R3, BitPos(LED2+0), 1
_SX	
;Main.c,209 :: 		Delay_ms(1);
LUI	R24, 1
ORI	R24, R24, 1130
...
;Main.c,212 :: 		}else if(gc.P > 0){ //wait in msec
...
SLTI	R2, R2, 1
BEQ	R2, R0, L__Non_Modal_Actions141
NOP	
J	L_Non_Modal_Actions49
NOP	
L__Non_Modal_Actions141:
;Main.c,213 :: 		dly_time = (unsigned long)gc.P;
LH	R2, Offset(_gc+120)(GP)
; dly_time start address is: 16 (R4)
MOVZ	R4, R2, R0
; dly_time end address is: 16 (R4)
; i end address is: 20 (R5)
;Main.c,214 :: 		while(i < dly_time){
...
;Main.c,215 :: 		LED2 = TMR.clock >> 1;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 1
_LX	
INS	R2, R3, BitPos(LED2+0), 1
_SX	
;Main.c,216 :: 		Delay_ms(1);
LUI	R24, 1
ORI	R24, R24, 1130
...
;Main.c,237 :: 		if (gc.L == 20) {
LH	R3, Offset(_gc+14)(GP)
ORI	R2, R0, 20
BEQ	R3, R2, L__Non_Modal_Actions147
NOP	
J	L_Non_Modal_Actions58
NOP	
L__Non_Modal_Actions147:
;Main.c,244 :: 		result = Settings_Write_Coord_Data(Addre,gc.P,gc.next_position );
SH	R25, 12(SP)
...
ADDIU	SP, SP, 8
LH	R25, 12(SP)
;Main.c,250 :: 		ptr = Addre;
LUI	R2, 48387
SW	R2, Offset(_ptr+0)(GP)
;Main.c,251 :: 		test_flash = *ptr;//ReadFlashWord(Addre);//NVMRead(Addre);//
LW	R2, Offset(_ptr+0)(GP)
LW	R2, 0(R2)
; test_flash start address is: 12 (R3)
MOVZ	R3, R2, R0
;Main.c,252 :: 		test = ulong2flt(test_flash);
SW	R3, 12(SP)
SH	R25, 16(SP)
MOVZ	R25, R2, R0
JAL	_ulong2flt+0
...
MOV.S 	S1, S0
; test_flash end address is: 12 (R3)
; test end address is: 8 (R2)
MOVZ	R4, R3, R0
MOV.S 	S16, S1
;Main.c,253 :: 		while(DMA_IsOn(1));
L_Non_Modal_Actions61:
; test start address is: 128 (R32)
; test_flash start address is: 16 (R4)
SW	R4, 12(SP)
SWC1	S16, 16(SP)
SH	R25, 20(SP)
ORI	R25, R0, 1
...
;Main.c,254 :: 		dma_printf("ptr:= $l\ttest_flash:= %l\ttest:= %f\n",ptr,test_flash,test);
ADDIU	R23, SP, 32
ADDIU	R22, R23, 36
...
ADDIU	R3, SP, 32
SH	R25, 12(SP)
; test end address is: 128 (R32)
ADDIU	SP, SP, -16
SWC1	S16, 12(SP)
SW	R4, 8(SP)
; test_flash end address is: 16 (R4)
LW	R2, Offset(_ptr+0)(GP)
SW	R2, 4(SP)
SW	R3, 0(SP)
JAL	_dma_printf+0
...
J	L_Non_Modal_Actions41
NOP	
;Main.c,285 :: 		default: action = -1; //error in action msg ???
