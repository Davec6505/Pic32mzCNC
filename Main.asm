...
SEH	R4, R2
;Main.c,117 :: 		switch(modal_group){
J	L_main5
NOP	
; modal_group end address is: 16 (R4)
;Main.c,118 :: 		case 0:break;
L_main7:
J	L_main6
NOP	
;Main.c,119 :: 		case 2:// [G4,G10,G28,G30,G53,G92,G92.1] Non-modal
L_main8:
;Main.c,120 :: 		modal_action = Modal_Group_Actions0(Get_non_modalword());
JAL	_Get_non_modalword+0
NOP	
SEH	R25, R2
JAL	Main_Modal_Group_Actions0+0
NOP	
;Main.c,121 :: 		modal_action = modal_group = Rst_modalgroup();
...
J	L_main6
NOP	
;Main.c,124 :: 		case 4: // [G0,G1,G2,G3,G80] Motion
L_main9:
;Main.c,125 :: 		axis_to_run = Get_Axisword();
JAL	_Get_Axisword+0
NOP	
SH	R2, 2(SP)
;Main.c,127 :: 		if(axis_to_run){
BNE	R2, R0, L__main163
NOP	
J	L_main10
NOP	
L__main163:
;Main.c,130 :: 		EnableSteppers(ALL_AXIS);
ORI	R25, R0, 31
JAL	_EnableSteppers+0
NOP	
;Main.c,131 :: 		Modal_Group_Actions1(axis_to_run);
LH	R25, 2(SP)
JAL	Main_Modal_Group_Actions1+0
NOP	
;Main.c,132 :: 		axis_to_run = Rst_Axisword();
JAL	_Rst_Axisword+0
NOP	
SH	R2, 2(SP)
...
NOP	
L_main10:
;Main.c,135 :: 		int report = GET_FAIL();
JAL	_GET_FAIL+0
NOP	
;Main.c,136 :: 		if(!report){
BEQ	R2, R0, L__main164
NOP	
J	L_main12
NOP	
L__main164:
;Main.c,137 :: 		report_status_message(STATUS_OK);
MOVZ	R25, R0, R0
JAL	_report_status_message+0
NOP	
;Main.c,138 :: 		SET_FAIL(STATUS_NO_REPORT);
ORI	R25, R0, 99
JAL	_SET_FAIL+0
NOP	
;Main.c,139 :: 		}
...
J	L_main6
NOP	
;Main.c,142 :: 		case 8: // [G17,G18,G19] Plane selection [report status set in GCODE]
L_main13:
;Main.c,143 :: 		case 16:// [G90,G91] Distance mode  [not conditioned here]
L_main14:
;Main.c,144 :: 		report_status_message(GET_FAIL());
JAL	_GET_FAIL+0
NOP	
SEH	R25, R2
JAL	_report_status_message+0
...
J	L_main6
NOP	
;Main.c,147 :: 		case 32://MODAL_GROUP_4 [M0,M1,M2,M30] Stopping
L_main15:
;Main.c,148 :: 		Modal_Group_Actions4(1);//implimentation needed
ORI	R25, R0, 1
...
J	L_main6
NOP	
;Main.c,151 :: 		case 64:// [G93,G94] Feed rate mode [not conditioned here]
L_main16:
;Main.c,152 :: 		case 128:// [G20,G21] Units [not conditioned here]
L_main17:
;Main.c,153 :: 		report_status_message(GET_FAIL());
JAL	_GET_FAIL+0
NOP	
SEH	R25, R2
JAL	_report_status_message+0
NOP	
;Main.c,154 :: 		modal_group = Rst_modalgroup();
JAL	_Rst_modalgroup+0
NOP	
;Main.c,155 :: 		break;
J	L_main6
NOP	
;Main.c,156 :: 		case 256://MODAL_GROUP_7 [M3,M4,M5] Spindle turning
L_main18:
;Main.c,157 :: 		Modal_Group_Actions7(1);//implimentation needed
ORI	R25, R0, 1
JAL	Main_Modal_Group_Actions7+0
NOP	
;Main.c,158 :: 		modal_group = Rst_modalgroup();
JAL	_Rst_modalgroup+0
NOP	
;Main.c,159 :: 		break;
J	L_main6
NOP	
;Main.c,160 :: 		case 512:// [G54,G55,G56,G57,G58,G59] Coordinate system selection
L_main19:
;Main.c,161 :: 		Modal_Group_Actions12(gc.coord_select);//implimentation needed
LH	R25, Offset(-1610602226)(GP)
JAL	Main_Modal_Group_Actions12+0
NOP	
;Main.c,162 :: 		modal_group = Rst_modalgroup();
JAL	_Rst_modalgroup+0
NOP	
;Main.c,163 :: 		break;
J	L_main6
NOP	
;Main.c,164 :: 		case 1024: //$H Home all axis
L_main20:
;Main.c,166 :: 		modal_action = Modal_Group_Actions1(ALL_AXIS);
ORI	R25, R0, 31
JAL	Main_Modal_Group_Actions1+0
NOP	
;Main.c,175 :: 		if(modal_action == 0)modal_group = Rst_modalgroup();
SEH	R2, R2
...
;Main.c,179 :: 		}
L_main4:
;Main.c,219 :: 		protocol_system_check();
JAL	_protocol_system_check+0
NOP	
;Main.c,222 :: 		protocol_execute_runtime();
JAL	_protocol_execute_runtime+0
NOP	
;Main.c,225 :: 		if((old_state == 0 || SV.cir == 1) && (SV.mode_complete == 0)){// && (!SV.homed)){
LH	R2, Offset(Main_old_state+0)(GP)
BNE	R2, R0, L__main189
NOP	
J	L__main152
NOP	
L__main189:
...
L__main191:
L__main146:
;Main.c,226 :: 		old_state = 1;
ORI	R2, R0, 1
SH	R2, Offset(Main_old_state+0)(GP)
;Main.c,227 :: 		SV.cir    = 0; //end of circle
LBU	R2, Offset(_SV+0)(GP)
INS	R2, R0, 1, 1
SB	R2, Offset(_SV+0)(GP)
;Main.c,228 :: 		LED2 = false;
_LX	
INS	R2, R0, BitPos(LED2+0), 1
_SX	
;Main.c,231 :: 		report_status_message(status_of_gcode);
LH	R25, 0(SP)
JAL	_report_status_message+0
NOP	
;Main.c,239 :: 		}
...
;Main.c,225 :: 		if((old_state == 0 || SV.cir == 1) && (SV.mode_complete == 0)){// && (!SV.homed)){
L__main153:
;Main.c,240 :: 		if(SV.mode_complete > 0 && old_state != 0){
LH	R2, Offset(_SV+2)(GP)
SLTI	R2, R2, 1
...
L__main194:
L__main145:
;Main.c,241 :: 		old_state = 0;
SH	R0, Offset(Main_old_state+0)(GP)
;Main.c,240 :: 		if(SV.mode_complete > 0 && old_state != 0){
L__main155:
L__main154:
;Main.c,245 :: 		status_of_gcode = Sample_Gocde_Line();
JAL	_Sample_Gocde_Line+0
NOP	
SH	R2, 0(SP)
;Main.c,250 :: 		LED1 = TMR.clock >> 4;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 4
_LX	
INS	R2, R3, BitPos(LED1+0), 1
_SX	
;Main.c,255 :: 		if(disable_steps <= SEC_TO_DISABLE_STEPPERS)
...
NOP	
L__main195:
;Main.c,256 :: 		disable_steps = TMR.Reset(SEC_TO_DISABLE_STEPPERS,disable_steps);
...
;Main.c,268 :: 		static int Modal_Group_Actions0(int action){
ADDIU	SP, SP, -44
SW	RA, 0(SP)
;Main.c,271 :: 		unsigned int home_select = 0;
SW	R26, 4(SP)
SW	R27, 8(SP)
;Main.c,280 :: 		switch(action){
J	L_Main_Modal_Group_Actions031
NOP	
;Main.c,281 :: 		case 2:  //NON_MODAL_DWELL
L_Main_Modal_Group_Actions033:
;Main.c,282 :: 		i = 0;
; i start address is: 20 (R5)
MOVZ	R5, R0, R0
;Main.c,284 :: 		if(gc.S > 0){ //wait in seconds
...
;Main.c,287 :: 		LED2 = TMR.clock >> 1;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 1
_LX	
INS	R2, R3, BitPos(LED2+0), 1
_SX	
;Main.c,288 :: 		Delay_ms(1);
LUI	R24, 1
ORI	R24, R24, 1130
...
;Main.c,291 :: 		}else if(gc.P > 0){ //wait in msec
...
;Main.c,292 :: 		dly_time = (unsigned long)gc.P;
LH	R2, Offset(-1610602116)(GP)
; dly_time start address is: 16 (R4)
MOVZ	R4, R2, R0
; dly_time end address is: 16 (R4)
; i end address is: 20 (R5)
;Main.c,293 :: 		while(i < dly_time){
...
;Main.c,294 :: 		LED2 = TMR.clock >> 1;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 1
_LX	
INS	R2, R3, BitPos(LED2+0), 1
_SX	
;Main.c,295 :: 		Delay_ms(1);
LUI	R24, 1
ORI	R24, R24, 1130
...
NOP	
;Main.c,302 :: 		case 4:  //NON_MODAL_SET_COORDINATE_DATA
L_Main_Modal_Group_Actions045:
;Main.c,315 :: 		if(gc.L != 2 && gc.L != 20)
...
;Main.c,319 :: 		result = settings_write_coord_data((int)gc.P,gc.next_position );
SH	R25, 12(SP)
LUI	R26, 40960
ORI	R26, R26, 10576
...
NOP	
LH	R25, 12(SP)
;Main.c,321 :: 		if(result){ //response if write to flash failed new result
BNE	R2, R0, L_Main_Modal_Group_Actions0208
NOP	
J	L_Main_Modal_Group_Actions050
NOP	
L_Main_Modal_Group_Actions0208:
;Main.c,322 :: 		return NVM_COORDINATE_WRITE_ERROR;
ORI	R2, R0, 1
J	L_end_Modal_Group_Actions0
NOP	
;Main.c,323 :: 		}
L_Main_Modal_Group_Actions050:
;Main.c,326 :: 		if (gc.coord_select > 0) {
...
;Main.c,327 :: 		memcpy(gc.coord_system,gc.next_position,sizeof(gc.next_position));
SH	R25, 12(SP)
ORI	R27, R0, 16
LUI	R26, 40960
ORI	R26, R26, 10576
...
;Main.c,336 :: 		temp = indx = (gc.P-1) & 0xFF;
LH	R2, Offset(-1610602116)(GP)
ADDIU	R2, R2, -1
ANDI	R2, R2, 255
;Main.c,337 :: 		indx *= 4;
...
SEH	R3, R2
;Main.c,338 :: 		axis_cnt = 0;
; axis_cnt start address is: 16 (R4)
MOVZ	R4, R0, R0
;Main.c,342 :: 		axis_words = Get_Axisword();
SH	R4, 12(SP)
SH	R3, 14(SP)
SH	R25, 16(SP)
JAL	_Get_Axisword+0
...
; axis_words end address is: 20 (R5)
;Main.c,344 :: 		temp_axis = (axis_words >> i) & 1;
; axis_words start address is: 20 (R5)
SEH	R3, R5
SEH	R2, R6
SRAV	R2, R3, R2
ANDI	R2, R2, 1
;Main.c,346 :: 		if(temp_axis == 0){
SEH	R2, R2
...
; axis_cnt start address is: 16 (R4)
SEH	R4, R2
;Main.c,348 :: 		if(axis_cnt > 2)break;
SEH	R2, R2
SLTI	R2, R2, 3
...
MOVZ	R8, R2, R0
;Main.c,354 :: 		coord_data[i] = ulong2flt(_flash);
ADDIU	R3, SP, 24
SEH	R2, R6
SLL	R2, R2, 2
ADDU	R2, R3, R2
...
;Main.c,365 :: 		coord_data[i] = gc.next_position[i];
; axis_cnt start address is: 32 (R8)
ADDIU	R3, SP, 24
SEH	R2, R6
SLL	R4, R2, 2
...
;Main.c,377 :: 		result = settings_write_coord_data((int)gc.P,coord_data);
ADDIU	R2, SP, 24
SH	R25, 12(SP)
MOVZ	R26, R2, R0
LH	R25, Offset(-1610602116)(GP)
JAL	_settings_write_coord_data+0
NOP	
;Main.c,380 :: 		memcpy(gc.coord_system,coord_data,sizeof(coord_data));
ADDIU	R2, SP, 24
ORI	R27, R0, 16
MOVZ	R26, R2, R0
LUI	R25, 40960
...
J	L_Main_Modal_Group_Actions032
NOP	
;Main.c,384 :: 		case  8:  //NON_MODAL_GO_HOME_0_BIT
L_Main_Modal_Group_Actions059:
;Main.c,385 :: 		case 32:  //NON_MODAL_GO_HOME_1_BIT
L_Main_Modal_Group_Actions060:
;Main.c,388 :: 		axis_words = Get_Axisword();
SH	R25, 12(SP)
JAL	_Get_Axisword+0
NOP	
LH	R25, 12(SP)
...
;Main.c,401 :: 		if ( bit_istrue(axis_words,bit(i)) ) {
SEH	R3, R5
ORI	R2, R0, 1
SLLV	R2, R2, R3
AND	R2, R6, R2
...
;Main.c,402 :: 		if (gc.absolute_mode) {
...
;Main.c,403 :: 		gc.next_position[i] += gc.coord_system[i] + gc.coord_offset[i];
SEH	R2, R5
SLL	R4, R2, 2
LUI	R2, 40960
ORI	R2, R2, 10576
...
;Main.c,405 :: 		gc.next_position[i] += gc.position[i];
SEH	R2, R5
SLL	R3, R2, 2
LUI	R2, 40960
ORI	R2, R2, 10576
...
;Main.c,408 :: 		gc.next_position[i] = gc.position[i];
SEH	R2, R5
SLL	R4, R2, 2
LUI	R2, 40960
ORI	R2, R2, 10576
...
;Main.c,414 :: 		SingleAxisStep(gc.next_position[i],settings.default_seek_rate,i);
SEH	R2, R5
SLL	R3, R2, 2
LUI	R2, 40960
ORI	R2, R2, 10576
...
SEH	R4, R5
SEH	R3, R6
;Main.c,415 :: 		while(GET_RunState(i));
...
;Main.c,419 :: 		temp = SETTING_INDEX_G28;  //home to zero pos / at limits
; temp start address is: 20 (R5)
ORI	R5, R0, 10
;Main.c,421 :: 		if (action == NON_MODAL_GO_HOME_1_BIT){temp = SETTING_INDEX_G30;}
SEH	R3, R25
ORI	R2, R0, 32
...
;Main.c,422 :: 		i = (temp)*4 ; //place the new data into the correct position
; temp start address is: 20 (R5)
SEH	R2, R5
SLL	R2, R2, 2
; i start address is: 24 (R6)
SEH	R6, R2
;Main.c,425 :: 		for(j = 0;j<4;j++){
...
MOVZ	R7, R2, R0
;Main.c,427 :: 		coord_system[temp].coord[j] = ulong2flt(_data);
SEH	R2, R5
SLL	R3, R2, 5
LUI	R2, 40960
ORI	R2, R2, 13824
...
ADDIU	R2, R6, 1
SEH	R6, R2
;Main.c,435 :: 		SingleAxisStep(coord_system[temp].coord[j],settings.default_seek_rate,j);
SEH	R2, R5
SLL	R3, R2, 5
LUI	R2, 40960
ORI	R2, R2, 13824
...
LH	R6, 12(SP)
SEH	R3, R6
;Main.c,436 :: 		while(GET_RunState(j));
...
;Main.c,442 :: 		home_select = SETTING_INDEX_G28;
; home_select start address is: 16 (R4)
ORI	R4, R0, 10
;Main.c,443 :: 		if (action == NON_MODAL_SET_HOME_1) { home_select = SETTING_INDEX_G30; }
SEH	R3, R25
ORI	R2, R0, 6
...
;Main.c,444 :: 		settings_write_coord_data(home_select,gc.position);
; home_select start address is: 8 (R2)
SH	R25, 12(SP)
LUI	R26, 40960
ORI	R26, R26, 10528
...
;Main.c,447 :: 		axis_words = Get_Axisword();
SH	R25, 12(SP)
JAL	_Get_Axisword+0
NOP	
LH	R25, 12(SP)
...
; axis_words end address is: 20 (R5)
;Main.c,453 :: 		if ( bit_istrue(axis_words,bit(i)) ) {
; axis_words start address is: 20 (R5)
SEH	R3, R6
ORI	R2, R0, 1
SLLV	R2, R2, R3
...
;Main.c,454 :: 		if (!gc.absolute_override) {
...
;Main.c,455 :: 		if (!gc.absolute_mode) { // Do not update target in absolute override mode
LBU	R2, Offset(-1610602235)(GP)
...
;Main.c,456 :: 		gc.next_position[i] += gc.coord_system[i] + gc.coord_offset[i]; // Absolute mode
SEH	R2, R6
SLL	R4, R2, 2
LUI	R2, 40960
ORI	R2, R2, 10576
...
;Main.c,458 :: 		gc.next_position[i] += gc.position[i]; // Incremental mode
SEH	R2, R6
SLL	R3, R2, 2
LUI	R2, 40960
ORI	R2, R2, 10576
...
;Main.c,461 :: 		gc.next_position[i] = gc.position[i]; // No axis word in block. Keep same axis position.
SEH	R2, R6
SLL	R4, R2, 2
LUI	R2, 40960
ORI	R2, R2, 10576
...
J	L_Main_Modal_Group_Actions032
NOP	
;Main.c,466 :: 		case 64:   //NON_MODAL_SET_HOME_1
L_Main_Modal_Group_Actions088:
;Main.c,467 :: 		temp = SETTING_INDEX_G28;
; temp start address is: 16 (R4)
ORI	R4, R0, 10
;Main.c,468 :: 		if (action == NON_MODAL_SET_HOME_1_BIT) { temp = SETTING_INDEX_G30; }
SEH	R3, R25
ORI	R2, R0, 64
BEQ	R3, R2, L_Main_Modal_Group_Actions0232
NOP	
J	L_Main_Modal_Group_Actions0138
NOP	
...
NOP	
L_Main_Modal_Group_Actions0138:
SEH	R2, R4
L_Main_Modal_Group_Actions089:
;Main.c,469 :: 		settings_write_coord_data(temp,gc.position);
; temp start address is: 8 (R2)
SH	R25, 12(SP)
LUI	R26, 40960
ORI	R26, R26, 10528
...
J	L_Main_Modal_Group_Actions032
NOP	
;Main.c,471 :: 		case 128:  //NON_MODAL_SET_COORDINATE_OFFSET NOT WRITTEN TO FLASH LOST ON RESET
L_Main_Modal_Group_Actions090:
;Main.c,472 :: 		axis_words = Get_Axisword();
SH	R25, 12(SP)
JAL	_Get_Axisword+0
NOP	
LH	R25, 12(SP)
; axis_words start address is: 20 (R5)
SEH	R5, R2
;Main.c,474 :: 		if (!axis_words) { // No axis words
...
; axis_words end address is: 20 (R5)
;Main.c,475 :: 		FAIL(STATUS_INVALID_STATEMENT);
SH	R25, 12(SP)
ORI	R25, R0, 6
JAL	_FAIL+0
NOP	
...
;Main.c,480 :: 		for (i=0; i<=2; i++) { // Axes indices are consistent, so loop may be used.
; i start address is: 24 (R6)
; axis_words start address is: 20 (R5)
MOVZ	R6, R0, R0
; i end address is: 24 (R6)
...
; axis_words end address is: 20 (R5)
;Main.c,481 :: 		if (bit_istrue(axis_words,bit(i)) ) {
; axis_words start address is: 20 (R5)
SEH	R3, R6
ORI	R2, R0, 1
SLLV	R2, R2, R3
...
;Main.c,482 :: 		gc.coord_offset[i] = gc.position[i]-gc.coord_system[i]-gc.next_position[i];
SEH	R2, R6
SLL	R4, R2, 2
LUI	R2, 40960
ORI	R2, R2, 10560
...
;Main.c,487 :: 		case 256: //NON_MODAL_RESET_COORDINATE_OFFSET
L_Main_Modal_Group_Actions097:
;Main.c,489 :: 		clear_vector(gc.coord_offset);
SH	R25, 12(SP)
ORI	R27, R0, 16
MOVZ	R26, R0, R0
LUI	R25, 40960
...
J	L_Main_Modal_Group_Actions032
NOP	
;Main.c,491 :: 		default: action = -1; //error in action msg ???
...
;Main.c,500 :: 		static int Modal_Group_Actions1(int action){
ADDIU	SP, SP, -64
SW	RA, 0(SP)
;Main.c,502 :: 		if(action > 0){
SW	R26, 4(SP)
SW	R27, 8(SP)
SEH	R2, R25
SLTI	R2, R2, 1
BEQ	R2, R0, L_Main_Modal_Group_Actions1256
NOP	
J	L_Main_Modal_Group_Actions199
NOP	
L_Main_Modal_Group_Actions1256:
;Main.c,503 :: 		while(DMA_IsOn(1));
...
;Main.c,504 :: 		dma_printf("action:= %d\tgc.frequency:= %l\tgc.feed_rate:= %f\n",action,gc.frequency,gc.feed_rate);
ADDIU	R23, SP, 14
ADDIU	R22, R23, 49
...
NOP	
ADDIU	R3, SP, 14
LW	R2, Offset(-1610602216)(GP)
SH	R25, 12(SP)
ADDIU	SP, SP, -16
SW	R2, 12(SP)
LW	R2, Offset(-1610602220)(GP)
SW	R2, 8(SP)
SH	R25, 4(SP)
SW	R3, 0(SP)
JAL	_dma_printf+0
...
;Main.c,507 :: 		switch(action){
J	L_Main_Modal_Group_Actions1102
NOP	
;Main.c,508 :: 		case 1: //b0000 0001
L_Main_Modal_Group_Actions1104:
;Main.c,509 :: 		SingleAxisStep(gc.next_position[X],gc.feed_rate,X);
SH	R25, 12(SP)
MOVZ	R25, R0, R0
...
NOP	
;Main.c,511 :: 		case 2://b0000 0010
L_Main_Modal_Group_Actions1105:
;Main.c,512 :: 		SingleAxisStep(gc.next_position[Y],gc.feed_rate,Y);
SH	R25, 12(SP)
ORI	R25, R0, 1
LWC1	S13, Offset(-1610602216)(GP)
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,514 :: 		case 3://b0000 0011
L_Main_Modal_Group_Actions1106:
;Main.c,515 :: 		DualAxisStep(gc.next_position[X], gc.next_position[Y],X,Y,gc.feed_rate);
SH	R25, 12(SP)
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,517 :: 		case 4://b0000 0100
L_Main_Modal_Group_Actions1107:
;Main.c,518 :: 		SingleAxisStep(gc.next_position[Z],gc.feed_rate,Z);
SH	R25, 12(SP)
ORI	R25, R0, 2
LWC1	S13, Offset(-1610602216)(GP)
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,520 :: 		case 5://b0000 0101
L_Main_Modal_Group_Actions1108:
;Main.c,521 :: 		DualAxisStep(gc.next_position[X], gc.next_position[Z],X,Z,gc.feed_rate);
SH	R25, 12(SP)
LWC1	S14, Offset(-1610602216)(GP)
ORI	R26, R0, 2
MOVZ	R25, R0, R0
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,523 :: 		case 6://b0000 0110
L_Main_Modal_Group_Actions1109:
;Main.c,524 :: 		DualAxisStep(gc.next_position[Y], gc.next_position[Z],Y,Z,gc.feed_rate);
SH	R25, 12(SP)
LWC1	S14, Offset(-1610602216)(GP)
ORI	R26, R0, 2
ORI	R25, R0, 1
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,526 :: 		case 8://b0000 1000
L_Main_Modal_Group_Actions1110:
;Main.c,527 :: 		SingleAxisStep(gc.next_position[A],gc.feed_rate,A);
SH	R25, 12(SP)
ORI	R25, R0, 3
LWC1	S13, Offset(-1610602216)(GP)
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,529 :: 		case 9://b0000 1001
L_Main_Modal_Group_Actions1111:
;Main.c,530 :: 		DualAxisStep(gc.next_position[X], gc.next_position[A],X,A,gc.feed_rate);
SH	R25, 12(SP)
LWC1	S14, Offset(-1610602216)(GP)
ORI	R26, R0, 3
MOVZ	R25, R0, R0
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,532 :: 		case 10://b0000 1010
L_Main_Modal_Group_Actions1112:
;Main.c,533 :: 		DualAxisStep(gc.next_position[Y], gc.next_position[A],Y,A,gc.feed_rate);
SH	R25, 12(SP)
LWC1	S14, Offset(-1610602216)(GP)
ORI	R26, R0, 3
ORI	R25, R0, 1
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,535 :: 		case 12://b0000 1100
L_Main_Modal_Group_Actions1113:
;Main.c,536 :: 		DualAxisStep(gc.next_position[Z], gc.next_position[A],Z,A,gc.feed_rate);
SH	R25, 12(SP)
LWC1	S14, Offset(-1610602216)(GP)
ORI	R26, R0, 3
ORI	R25, R0, 2
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,538 :: 		case 15://Circle interpolation
L_Main_Modal_Group_Actions1114:
;Main.c,539 :: 		sys_sync_current_position();
SH	R25, 12(SP)
JAL	_sys_sync_current_position+0
NOP	
;Main.c,540 :: 		r_or_ijk(gc.position[X],gc.position[Y],gc.next_position[X],gc.next_position[Y],gc.R,gc.I,gc.J,gc.K,X,Y,gc.DIR);
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,542 :: 		case ALL_AXIS://Homing X axis
L_Main_Modal_Group_Actions1115:
;Main.c,543 :: 		axis_to_home = _Home(axis_to_home);
SH	R25, 12(SP)
...
;Main.c,544 :: 		LED2 = TMR.clock >> 3;
LBU	R3, Offset(_TMR+0)(GP)
SRL	R4, R3, 3
_LX	
INS	R3, R4, BitPos(LED2+0), 1
_SX	
;Main.c,549 :: 		if(axis_to_home < 3){
SEH	R2, R2
SLTI	R2, R2, 3
...
;Main.c,553 :: 		action =(ALARM_ABORT_CYCLE);
ORI	R25, R0, 65534
;Main.c,554 :: 		}
...
;Main.c,560 :: 		action = 0;
MOVZ	R25, R0, R0
;Main.c,561 :: 		for(l=0;l<NoOfAxis;l++){
...
;Main.c,564 :: 		STPS[l].steps_abs_position = 0;
SEH	R3, R5
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
ADDIU	R2, R2, 60
SW	R0, 0(R2)
;Main.c,565 :: 		sys.position[l] = STPS[l].steps_abs_position;
SEH	R2, R5
SLL	R3, R2, 2
LUI	R2, 40960
ORI	R2, R2, 13576
...
LW	R2, 0(R2)
SW	R2, 0(R4)
;Main.c,568 :: 		if(STPS[l].run_state != STOP)
SEH	R3, R5
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
LH	R2, 0(R2)
SEH	R2, R2
BNE	R2, R0, L_Main_Modal_Group_Actions1264
NOP	
J	L_Main_Modal_Group_Actions1122
NOP	
L_Main_Modal_Group_Actions1264:
;Main.c,569 :: 		STPS[l].run_state = STOP;
SEH	R3, R5
ORI	R2, R0, 68
MULTU	R2, R3
MFLO	R3
...
;Main.c,573 :: 		sys_sync_current_position();
SH	R25, 12(SP)
JAL	_sys_sync_current_position+0
NOP	
LH	R25, 12(SP)
;Main.c,576 :: 		while(axis_to_home)
...
;Main.c,577 :: 		axis_to_home = Rst_Axisword();
SH	R25, 12(SP)
JAL	_Rst_Axisword+0
NOP	
LH	R25, 12(SP)
...
;Main.c,580 :: 		sys.state = STATE_IDLE;
SH	R0, Offset(-1610599166)(GP)
;Main.c,581 :: 		SV.mode_complete = 0;
...
J	L_Main_Modal_Group_Actions1103
NOP	
;Main.c,584 :: 		default: return action = 0;
L_Main_Modal_Group_Actions1125:
MOVZ	R25, R0, R0
MOVZ	R2, R0, R0
...
J	L_Main_Modal_Group_Actions1125
NOP	
...
;Main.c,595 :: 		static int Modal_Group_Actions3(int action){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Main.c,597 :: 		if(gc.inches_mode > 1)
LBU	R2, Offset(-1610602237)(GP)
SLTIU	R2, R2, 2
BEQ	R2, R0, L_Main_Modal_Group_Actions3292
NOP	
J	L_Main_Modal_Group_Actions3126
NOP	
L_Main_Modal_Group_Actions3292:
;Main.c,598 :: 		FAIL(STATUS_SETTING_READ_FAIL);
SH	R25, 4(SP)
ORI	R25, R0, 10
JAL	_FAIL+0
NOP	
LH	R25, 4(SP)
L_Main_Modal_Group_Actions3126:
;Main.c,600 :: 		return action;
SEH	R2, R25
;Main.c,601 :: 		}
...
;Main.c,606 :: 		static int Modal_Group_Actions4(int action){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Main.c,612 :: 		gc.program_flow > PROGRAM_FLOW_COMPLETED)
LBU	R2, Offset(-1610602231)(GP)
SLTIU	R2, R2, 0
BEQ	R2, R0, L_Main_Modal_Group_Actions4294
NOP	
J	L_Main_Modal_Group_Actions4141
NOP	
L_Main_Modal_Group_Actions4294:
LBU	R2, Offset(-1610602231)(GP)
SLTIU	R2, R2, 3
...
NOP	
L_Main_Modal_Group_Actions4141:
L_Main_Modal_Group_Actions4140:
;Main.c,613 :: 		FAIL(STATUS_INVALID_STATEMENT);
SH	R25, 4(SP)
ORI	R25, R0, 6
JAL	_FAIL+0
NOP	
...
;Main.c,614 :: 		SV.mode_complete = 1;
ORI	R2, R0, 1
SH	R2, Offset(_SV+2)(GP)
;Main.c,615 :: 		return action;
SEH	R2, R25
;Main.c,616 :: 		}
...
;Main.c,621 :: 		static int Modal_Group_Actions7(int action){
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;Main.c,626 :: 		if(gc.spindle_direction < -1 || gc.spindle_direction > 1)
LBU	R2, Offset(-1610602234)(GP)
SLTI	R2, R2, -1
BEQ	R2, R0, L_Main_Modal_Group_Actions7297
NOP	
J	L_Main_Modal_Group_Actions7144
NOP	
L_Main_Modal_Group_Actions7297:
LBU	R2, Offset(-1610602234)(GP)
SLTIU	R2, R2, 2
BNE	R2, R0, L_Main_Modal_Group_Actions7298
NOP	
J	L_Main_Modal_Group_Actions7143
NOP	
L_Main_Modal_Group_Actions7298:
J	L_Main_Modal_Group_Actions7132
NOP	
L_Main_Modal_Group_Actions7144:
L_Main_Modal_Group_Actions7143:
;Main.c,627 :: 		FAIL(STATUS_INVALID_STATEMENT);
SH	R25, 4(SP)
ORI	R25, R0, 6
JAL	_FAIL+0
NOP	
...
;Main.c,628 :: 		SV.mode_complete = 1;
ORI	R2, R0, 1
SH	R2, Offset(_SV+2)(GP)
;Main.c,629 :: 		return action;
SEH	R2, R25
;Main.c,630 :: 		}
...
;Main.c,635 :: 		static int Modal_Group_Actions12(int action){
;Main.c,640 :: 		return action;
SEH	R2, R25
;Main.c,641 :: 		}
