...
NOP	
L_main30:
;Main.c,182 :: 		(STPS[X].run_state&0xff),STPS[X].step_count,
LHU	R2, Offset(_STPS+6)(GP)
ANDI	R4, R2, 255
;Main.c,181 :: 		dma_printf("run_state:= %d\t%l\t%l\t%l\t%d\t%l\n",
ADDIU	R23, SP, 2
ADDIU	R22, R23, 31
...
NOP	
ADDIU	R3, SP, 2
;Main.c,183 :: 		SV.dA,STPS[Y].step_count,STPS[X].step_delay,gc.frequency);
