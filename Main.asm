...
NOP	
L__main48:
;Main.c,110 :: 		if(STPS[X].homing.home_cnt >= 2){
...
NOP	
L__main49:
;Main.c,111 :: 		STPS[X].homing.home_cnt = 0;
...
;Main.c,114 :: 		}
L_main10:
;Main.c,115 :: 		if(STPS[Y].homing.home_cnt >= 2){
...
NOP	
L__main50:
;Main.c,116 :: 		STPS[Y].homing.home_cnt = 0;
