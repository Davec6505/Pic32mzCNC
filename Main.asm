...
NOP	
L__main47:
;Main.c,83 :: 		LED1 = TMR.clock >> 4;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 4
_LX	
INS	R2, R3, BitPos(LED1+0), 1
_SX	
;Main.c,85 :: 		if(disable_steps <= SEC_TO_DISABLE_STEPPERS)
...
NOP	
L__main48:
;Main.c,86 :: 		disable_steps = TMR.Reset(SEC_TO_DISABLE_STEPPERS,disable_steps);
...
SH	R0, Offset(Main_disable_steps+0)(GP)
;Main.c,93 :: 		disableOCx();
JAL	_disableOCx+0
NOP	
;Main.c,94 :: 		}
L_main7:
;Main.c,96 :: 		if((!SW1)&&(!Toggle)){
_LX	
...
;Main.c,99 :: 		EnStepperX();
JAL	_EnStepperX+0
NOP	
;Main.c,100 :: 		EnStepperY();
JAL	_EnStepperY+0
NOP	
;Main.c,101 :: 		EnStepperZ();
JAL	_EnStepperZ+0
NOP	
;Main.c,102 :: 		EnStepperA();
JAL	_EnStepperA+0
NOP	
;Main.c,103 :: 		ResetHoming();
JAL	_ResetHoming+0
NOP	
;Main.c,104 :: 		a = 0;
SH	R0, Offset(Main_a+0)(GP)
...
NOP	
L__main54:
;Main.c,110 :: 		if(homing[X].home_cnt >= 2){
...
;Main.c,114 :: 		}
L_main13:
;Main.c,115 :: 		if(homing[Y].home_cnt >= 2){
...
NOP	
L__main56:
;Main.c,116 :: 		homing[Y].home_cnt = 0;
...
NOP	
L_main12:
;Main.c,122 :: 		if((!OC5IE_bit && !OC2IE_bit && !OC7IE_bit && !OC3IE_bit)){
...
; end of _main
_Temp_Move:
;Main.c,135 :: 		int Temp_Move(int a){
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;Main.c,136 :: 		switch(a){
SW	R26, 4(SP)
...
;Main.c,137 :: 		case 0:
L_Temp_Move21:
;Main.c,138 :: 		SingleAxisStep(50.00,8000,Y);
LUI	R2, 16968
ORI	R2, R2, 0
SH	R25, 12(SP)
ORI	R26, R0, 1
...
;Main.c,141 :: 		case 1:
L_Temp_Move22:
;Main.c,142 :: 		SingleAxisStep(50.00,8000,X);
LUI	R2, 16968
ORI	R2, R2, 0
SH	R25, 12(SP)
MOVZ	R26, R0, R0
...
;Main.c,145 :: 		case 2:
L_Temp_Move23:
;Main.c,146 :: 		SingleAxisStep(-50.00,8000,Y);
LUI	R2, 49736
ORI	R2, R2, 0
SH	R25, 12(SP)
ORI	R26, R0, 1
...
;Main.c,149 :: 		case 3:
L_Temp_Move24:
;Main.c,150 :: 		SingleAxisStep(-50.00,8000,X);
LUI	R2, 49736
ORI	R2, R2, 0
SH	R25, 12(SP)
MOVZ	R26, R0, R0
...
;Main.c,153 :: 		case 4:
L_Temp_Move25:
;Main.c,154 :: 		DualAxisStep(150.00, 100.00,X,Y,8000);
LUI	R3, 17096
ORI	R3, R3, 0
LUI	R2, 17174
ORI	R2, R2, 0
...
;Main.c,157 :: 		case 5:
L_Temp_Move26:
;Main.c,158 :: 		DualAxisStep(-150.00, -100.00,X,Y,8000);
LUI	R3, 49864
ORI	R3, R3, 0
LUI	R2, 49942
ORI	R2, R2, 0
...
;Main.c,161 :: 		case 6:
L_Temp_Move27:
;Main.c,162 :: 		DualAxisStep(150.00, 30.00,X,Y,8000);
LUI	R3, 16880
ORI	R3, R3, 0
LUI	R2, 17174
ORI	R2, R2, 0
...
;Main.c,165 :: 		case 7:
L_Temp_Move28:
;Main.c,166 :: 		DualAxisStep(-150.00, -30.00,X,Y,8000);
LUI	R3, 49648
ORI	R3, R3, 0
LUI	R2, 49942
ORI	R2, R2, 0
...
;Main.c,169 :: 		case 8:
L_Temp_Move29:
;Main.c,170 :: 		SingleAxisStep(350.00,10000,A);
LUI	R2, 17327
ORI	R2, R2, 0
SH	R25, 12(SP)
ORI	R26, R0, 3
...
;Main.c,173 :: 		case 9:
L_Temp_Move30:
;Main.c,177 :: 		r_or_ijk(150.00, 30.00, 150.00, 30.00, 0.00, -50.00, 50.00,0.00,X,Y,CW);
LUI	R5, 16880
ORI	R5, R5, 0
LUI	R4, 17174
ORI	R4, R4, 0
...
J	L_Temp_Move20
NOP	
;Main.c,180 :: 		case 10://Homing X axis                                                                abcdef
L_Temp_Move31:
;Main.c,181 :: 		Home(X);
SH	R25, 12(SP)
MOVZ	R25, R0, R0
...
J	L_Temp_Move20
NOP	
;Main.c,183 :: 		case 11://Homing Y axis
L_Temp_Move32:
;Main.c,184 :: 		Home(Y);
SH	R25, 12(SP)
ORI	R25, R0, 1
...
J	L_Temp_Move20
NOP	
;Main.c,186 :: 		case 12://Homing Y axis
L_Temp_Move33:
;Main.c,188 :: 		break;
J	L_Temp_Move20
NOP	
