...
SEH	R2, R4
SLT	R2, R3, R2
BNE	R2, R0, L__Modal_Group_Actions0159
NOP	
...
ORI	R2, R0, 2
BNE	R3, R2, L__Modal_Group_Actions0161
NOP	
...
LH	R3, Offset(_gc+16)(GP)
ORI	R2, R0, 20
BNE	R3, R2, L__Modal_Group_Actions0163
NOP	
...
LH	R3, Offset(_gc+16)(GP)
ORI	R2, R0, 20
BEQ	R3, R2, L__Modal_Group_Actions0164
NOP	
...
;Main.c,224 :: 		if(!Save_Row_From_Flash(FLASH_Settings_VAddr_P1))return;
SH	R25, 12(SP)
LUI	R25, 48411
ORI	R25, R25, 49152
JAL	_Save_Row_From_Flash+0
...
SEH	R3, R25
ORI	R2, R0, 32
BEQ	R3, R2, L__Modal_Group_Actions0181
NOP	
...
SEH	R3, R25
ORI	R2, R0, 64
BEQ	R3, R2, L__Modal_Group_Actions0190
NOP	
J	L__Modal_Group_Actions0123
NOP	
...
BEQ	R2, R0, L__Modal_Group_Actions0191
NOP	
...
AND	R2, R5, R2
SEH	R2, R2
BNE	R2, R0, L__Modal_Group_Actions0194
NOP	
...
SEH	R3, R25
ORI	R2, R0, 512
BNE	R3, R2, L__Modal_Group_Actions0214
NOP	
J	L_Modal_Group_Actions088
NOP	
L__Modal_Group_Actions0214:
...
SEH	R3, R25
ORI	R2, R0, 15
BNE	R3, R2, L__Modal_Group_Actions1241
NOP	
J	L_Modal_Group_Actions1104
NOP	
L__Modal_Group_Actions1241:
...
NOP	
J	L__protocol_execute_runtime125
NOP	
...
NOP	
L__protocol_execute_runtime125:
;Main.c,481 :: 		if (rt_exec & (EXEC_ALARM | EXEC_CRIT_EVENT)) {
;Main.c,503 :: 		}
