...
NOP	
;Main.c,75 :: 		cntr = a =  dif = status_of_gcode = modal_group = modal_action = 0;
SH	R0, 0(SP)
;Main.c,77 :: 		while(1){
L_main0:
...
L__main133:
L__main132:
;Main.c,90 :: 		int axis_to_run = 0;
;Main.c,92 :: 		modal_group = Get_modalgroup();
JAL	_Get_modalgroup+0
NOP	
; modal_group start address is: 16 (R4)
SEH	R4, R2
;Main.c,95 :: 		switch(modal_group){
J	L_main5
NOP	
; modal_group end address is: 16 (R4)
;Main.c,96 :: 		case 0:FAIL(STATUS_OK);break;
L_main7:
MOVZ	R25, R0, R0
JAL	_FAIL+0
NOP	
J	L_main6
NOP	
;Main.c,97 :: 		case 2://MODAL_GROUP_0: // [G4,G10,G28,G30,G53,G92,G92.1] Non-modal
L_main8:
;Main.c,98 :: 		modal_action = Modal_Group_Actions0(Get_modalword());
JAL	_Get_modalword+0
NOP	
SEH	R25, R2
JAL	Main_Modal_Group_Actions0+0
NOP	
;Main.c,99 :: 		modal_group = Rst_modalgroup();
JAL	_Rst_modalgroup+0
NOP	
;Main.c,100 :: 		report_status_message(STATUS_OK);
MOVZ	R25, R0, R0
...
NOP	
SH	R2, 2(SP)
;Main.c,113 :: 		EnableSteppers(ALL_AXIS);
ORI	R25, R0, 7
JAL	_EnableSteppers+0
NOP	
;Main.c,114 :: 		Modal_Group_Actions1(axis_to_run);
LH	R25, 2(SP)
JAL	Main_Modal_Group_Actions1+0
NOP	
;Main.c,115 :: 		axis_to_run = Rst_Axisword();
JAL	_Rst_Axisword+0
NOP	
;Main.c,116 :: 		modal_group = Rst_modalgroup();
JAL	_Rst_modalgroup+0
NOP	
;Main.c,117 :: 		break;
J	L_main6
NOP	
;Main.c,120 :: 		case 32://MODAL_GROUP_4 [M0,M1,M2,M30] Stopping
L_main10:
;Main.c,121 :: 		Modal_Group_Actions4(1);//implimentation needed
ORI	R25, R0, 1
JAL	Main_Modal_Group_Actions4+0
NOP	
;Main.c,122 :: 		modal_group = Rst_modalgroup();
JAL	_Rst_modalgroup+0
NOP	
;Main.c,123 :: 		break;
J	L_main6
NOP	
;Main.c,126 :: 		case 256://MODAL_GROUP_7 [M3,M4,M5] Spindle turning
L_main11:
;Main.c,127 :: 		Modal_Group_Actions7(1);//implimentation needed
ORI	R25, R0, 1
JAL	Main_Modal_Group_Actions7+0
NOP	
;Main.c,128 :: 		modal_group = Rst_modalgroup();
JAL	_Rst_modalgroup+0
NOP	
;Main.c,129 :: 		break;
J	L_main6
NOP	
;Main.c,130 :: 		case 512:// [G54,G55,G56,G57,G58,G59] Coordinate system selection
L_main12:
;Main.c,131 :: 		Modal_Group_Actions12(gc.coord_select);//implimentation needed
...
;Main.c,144 :: 		}
L_main4:
;Main.c,146 :: 		if(!Get_Axis_Enable_States() && SV.Tog && !SV.homed){
...
L__main161:
L__main130:
;Main.c,156 :: 		report_status_message(status_of_gcode);
LH	R25, 0(SP)
JAL	_report_status_message+0
NOP	
;Main.c,158 :: 		SV.Tog = 0;
...
L__main135:
L__main134:
;Main.c,174 :: 		protocol_system_check();
JAL	_protocol_system_check+0
NOP	
;Main.c,177 :: 		protocol_execute_runtime();
JAL	_protocol_execute_runtime+0
NOP	
;Main.c,180 :: 		status_of_gcode = Sample_Ringbuffer();
JAL	_Sample_Ringbuffer+0
NOP	
SH	R2, 0(SP)
;Main.c,191 :: 		LED1 = TMR.clock >> 4;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 4
_LX	
INS	R2, R3, BitPos(LED1+0), 1
_SX	
;Main.c,196 :: 		if(disable_steps <= SEC_TO_DISABLE_STEPPERS)
...
NOP	
L__main162:
;Main.c,197 :: 		disable_steps = TMR.Reset(SEC_TO_DISABLE_STEPPERS,disable_steps);
...
;Main.c,209 :: 		static int Modal_Group_Actions0(int action){
ADDIU	SP, SP, -40
SW	RA, 0(SP)
;Main.c,212 :: 		unsigned int home_select = 0;
SW	R26, 4(SP)
SW	R27, 8(SP)
;Main.c,221 :: 		switch(action){
J	L_Main_Modal_Group_Actions019
NOP	
;Main.c,222 :: 		case 2:  //NON_MODAL_DWELL
L_Main_Modal_Group_Actions021:
;Main.c,223 :: 		i = 0;
; i start address is: 20 (R5)
MOVZ	R5, R0, R0
;Main.c,225 :: 		if(gc.S > 0){ //wait in seconds
...
;Main.c,228 :: 		LED2 = TMR.clock >> 1;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 1
_LX	
INS	R2, R3, BitPos(LED2+0), 1
_SX	
;Main.c,229 :: 		Delay_ms(1);
LUI	R24, 1
ORI	R24, R24, 1130
...
;Main.c,232 :: 		}else if(gc.P > 0){ //wait in msec
...
;Main.c,233 :: 		dly_time = (unsigned long)gc.P;
LH	R2, Offset(_gc+88)(GP)
; dly_time start address is: 16 (R4)
MOVZ	R4, R2, R0
; dly_time end address is: 16 (R4)
; i end address is: 20 (R5)
;Main.c,234 :: 		while(i < dly_time){
...
;Main.c,235 :: 		LED2 = TMR.clock >> 1;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 1
_LX	
INS	R2, R3, BitPos(LED2+0), 1
_SX	
;Main.c,236 :: 		Delay_ms(1);
LUI	R24, 1
ORI	R24, R24, 1130
...
NOP	
;Main.c,242 :: 		case 4:  //NON_MODAL_SET_COORDINATE_DATA
L_Main_Modal_Group_Actions033:
;Main.c,255 :: 		if(gc.L != 2 && gc.L != 20)
...
;Main.c,259 :: 		result = settings_write_coord_data((int)gc.P,gc.next_position );
SH	R25, 12(SP)
...
NOP	
LH	R25, 12(SP)
;Main.c,261 :: 		if(result){ //response if write to flash failed new result
BNE	R2, R0, L_Main_Modal_Group_Actions0175
NOP	
J	L_Main_Modal_Group_Actions038
NOP	
L_Main_Modal_Group_Actions0175:
;Main.c,262 :: 		return NVM_COORDINATE_WRITE_ERROR;
ORI	R2, R0, 1
J	L_end_Modal_Group_Actions0
NOP	
;Main.c,263 :: 		}
L_Main_Modal_Group_Actions038:
;Main.c,266 :: 		if (gc.coord_select > 0) {
...
;Main.c,267 :: 		memcpy(gc.coord_system,gc.next_position,sizeof(gc.next_position));
SH	R25, 12(SP)
ORI	R27, R0, 8
LUI	R26, hi_addr(_gc+52)
ORI	R26, R26, lo_addr(_gc+52)
...
;Main.c,276 :: 		temp = indx = (gc.P-1) & 0xFF;
LH	R2, Offset(_gc+88)(GP)
ADDIU	R2, R2, -1
ANDI	R2, R2, 255
;Main.c,277 :: 		indx *= 4;
...
SEH	R3, R2
;Main.c,278 :: 		axis_cnt = 0;
; axis_cnt start address is: 16 (R4)
MOVZ	R4, R0, R0
;Main.c,282 :: 		axis_words = Get_Axisword();
SH	R4, 12(SP)
SH	R3, 14(SP)
SH	R25, 16(SP)
JAL	_Get_Axisword+0
...
; axis_words end address is: 20 (R5)
;Main.c,284 :: 		temp_axis = (axis_words >> i) & 1;
; axis_words start address is: 20 (R5)
SEH	R3, R5
SEH	R2, R6
SRAV	R2, R3, R2
ANDI	R2, R2, 1
;Main.c,286 :: 		if(temp_axis == 0){
SEH	R2, R2
...
; axis_cnt start address is: 16 (R4)
SEH	R4, R2
;Main.c,288 :: 		if(axis_cnt > 2)break;
SEH	R2, R2
SLTI	R2, R2, 3
...
LW	R2, 0(R2)
SW	R2, 24(SP)
;Main.c,294 :: 		coord_data[i] = ulong2flt(_flash);
ADDIU	R3, SP, 28
SEH	R2, R6
SLL	R2, R2, 2
ADDU	R2, R3, R2
...
;Main.c,305 :: 		coord_data[i] = gc.next_position[i];
; axis_cnt start address is: 32 (R8)
ADDIU	R3, SP, 28
SEH	R2, R6
SLL	R4, R2, 2
...
;Main.c,317 :: 		result = settings_write_coord_data((int)gc.P,coord_data);
ADDIU	R2, SP, 28
SH	R25, 12(SP)
MOVZ	R26, R2, R0
LH	R25, Offset(_gc+88)(GP)
JAL	_settings_write_coord_data+0
NOP	
;Main.c,320 :: 		memcpy(gc.coord_system,coord_data,sizeof(coord_data));
ADDIU	R2, SP, 28
ORI	R27, R0, 8
MOVZ	R26, R2, R0
LUI	R25, hi_addr(_gc+36)
...
J	L_Main_Modal_Group_Actions020
NOP	
;Main.c,324 :: 		case  8:  //NON_MODAL_GO_HOME_0_BIT
L_Main_Modal_Group_Actions047:
;Main.c,325 :: 		case 32:  //NON_MODAL_GO_HOME_1_BIT
L_Main_Modal_Group_Actions048:
;Main.c,328 :: 		axis_words = Get_Axisword();
SH	R25, 12(SP)
JAL	_Get_Axisword+0
NOP	
LH	R25, 12(SP)
...
;Main.c,341 :: 		if ( bit_istrue(axis_words,bit(i)) ) {
SEH	R3, R5
ORI	R2, R0, 1
SLLV	R2, R2, R3
AND	R2, R6, R2
...
;Main.c,342 :: 		if (gc.absolute_mode) {
...
;Main.c,343 :: 		gc.next_position[i] += gc.coord_system[i] + gc.coord_offset[i];
SEH	R2, R5
SLL	R4, R2, 2
LUI	R2, hi_addr(_gc+52)
ORI	R2, R2, lo_addr(_gc+52)
...
;Main.c,345 :: 		gc.next_position[i] += gc.position[i];
SEH	R2, R5
SLL	R3, R2, 2
LUI	R2, hi_addr(_gc+52)
ORI	R2, R2, lo_addr(_gc+52)
...
;Main.c,348 :: 		gc.next_position[i] = gc.position[i];
SEH	R2, R5
SLL	R4, R2, 2
LUI	R2, hi_addr(_gc+52)
ORI	R2, R2, lo_addr(_gc+52)
...
;Main.c,354 :: 		SingleAxisStep(gc.next_position[i],settings.default_seek_rate,i);
...
SEH	R4, R5
SEH	R3, R6
;Main.c,355 :: 		while(GET_RunState(i));
...
;Main.c,359 :: 		temp = SETTING_INDEX_G28;  //home to zero pos / at limits
; temp start address is: 24 (R6)
ORI	R6, R0, 10
;Main.c,361 :: 		if (action == NON_MODAL_GO_HOME_1_BIT){temp = SETTING_INDEX_G30;}
SEH	R3, R25
ORI	R2, R0, 32
...
;Main.c,362 :: 		i = (temp)*4 ; //place the new data into the correct position
; temp start address is: 24 (R6)
SEH	R2, R6
SLL	R2, R2, 2
; i start address is: 16 (R4)
SEH	R4, R2
;Main.c,365 :: 		for(j = 0;j<4;j++){
...
MOVZ	R7, R2, R0
;Main.c,367 :: 		coord_system[temp].coord[j] = ulong2flt(_data);
SEH	R2, R6
SLL	R3, R2, 4
...
SEH	R7, R2
;Main.c,375 :: 		SingleAxisStep(coord_system[temp].coord[j],settings.default_seek_rate,j);
LWC1	S0, Offset(_settings+12)(GP)
CVT36.S 	S0, S0
MFC1	R4, S0
SEH	R2, R6
...
SEH	R4, R6
SEH	R3, R7
;Main.c,376 :: 		while(GET_RunState(j));
...
;Main.c,382 :: 		home_select = SETTING_INDEX_G28;
; home_select start address is: 16 (R4)
ORI	R4, R0, 10
;Main.c,383 :: 		if (action == NON_MODAL_SET_HOME_1) { home_select = SETTING_INDEX_G30; }
SEH	R3, R25
ORI	R2, R0, 6
...
;Main.c,384 :: 		settings_write_coord_data(home_select,gc.position);
; home_select start address is: 8 (R2)
SH	R25, 12(SP)
...
;Main.c,387 :: 		axis_words = Get_Axisword();
SH	R25, 12(SP)
JAL	_Get_Axisword+0
NOP	
LH	R25, 12(SP)
...
;Main.c,394 :: 		if (!gc.absolute_override) {
...
;Main.c,395 :: 		if (!gc.absolute_mode) { // Do not update target in absolute override mode
LBU	R2, Offset(_gc+5)(GP)
...
;Main.c,396 :: 		gc.next_position[i] += gc.coord_system[i] + gc.coord_offset[i]; // Absolute mode
SEH	R2, R6
SLL	R4, R2, 2
LUI	R2, hi_addr(_gc+52)
ORI	R2, R2, lo_addr(_gc+52)
...
;Main.c,398 :: 		gc.next_position[i] += gc.position[i]; // Incremental mode
SEH	R2, R6
SLL	R3, R2, 2
LUI	R2, hi_addr(_gc+52)
ORI	R2, R2, lo_addr(_gc+52)
...
;Main.c,401 :: 		gc.next_position[i] = gc.position[i]; // No axis word in block. Keep same axis position.
SEH	R2, R6
SLL	R4, R2, 2
LUI	R2, hi_addr(_gc+52)
ORI	R2, R2, lo_addr(_gc+52)
...
J	L_Main_Modal_Group_Actions020
NOP	
;Main.c,406 :: 		case 64:   //NON_MODAL_SET_HOME_1
L_Main_Modal_Group_Actions076:
;Main.c,407 :: 		temp = SETTING_INDEX_G28;
; temp start address is: 16 (R4)
ORI	R4, R0, 10
;Main.c,408 :: 		if (action == NON_MODAL_SET_HOME_1_BIT) { temp = SETTING_INDEX_G30; }
SEH	R3, R25
ORI	R2, R0, 64
...
;Main.c,409 :: 		settings_write_coord_data(temp,gc.position);
; temp start address is: 8 (R2)
SH	R25, 12(SP)
LUI	R26, hi_addr(_gc+28)
ORI	R26, R26, lo_addr(_gc+28)
...
J	L_Main_Modal_Group_Actions020
NOP	
;Main.c,411 :: 		case 128:  //NON_MODAL_SET_COORDINATE_OFFSET NOT WRITTEN TO FLASH LOST ON RESET
L_Main_Modal_Group_Actions078:
;Main.c,412 :: 		axis_words = Get_Axisword();
SH	R25, 12(SP)
JAL	_Get_Axisword+0
NOP	
LH	R25, 12(SP)
; axis_words start address is: 20 (R5)
SEH	R5, R2
;Main.c,414 :: 		if (!axis_words) { // No axis words
...
; axis_words end address is: 20 (R5)
;Main.c,415 :: 		FAIL(STATUS_INVALID_STATEMENT);
SH	R25, 12(SP)
ORI	R25, R0, 6
JAL	_FAIL+0
NOP	
...
;Main.c,420 :: 		for (i=0; i<=2; i++) { // Axes indices are consistent, so loop may be used.
; i start address is: 24 (R6)
; axis_words start address is: 20 (R5)
MOVZ	R6, R0, R0
; i end address is: 24 (R6)
...
; axis_words end address is: 20 (R5)
;Main.c,421 :: 		if (bit_istrue(axis_words,bit(i)) ) {
; axis_words start address is: 20 (R5)
SEH	R3, R6
ORI	R2, R0, 1
SLLV	R2, R2, R3
...
;Main.c,422 :: 		gc.coord_offset[i] = gc.position[i]-gc.coord_system[i]-gc.next_position[i];
SEH	R2, R6
SLL	R4, R2, 2
LUI	R2, hi_addr(_gc+44)
ORI	R2, R2, lo_addr(_gc+44)
...
;Main.c,427 :: 		case 256: //NON_MODAL_RESET_COORDINATE_OFFSET
L_Main_Modal_Group_Actions085:
;Main.c,429 :: 		clear_vector(gc.coord_offset);
SH	R25, 12(SP)
ORI	R27, R0, 8
MOVZ	R26, R0, R0
...
J	L_Main_Modal_Group_Actions020
NOP	
;Main.c,431 :: 		default: action = -1; //error in action msg ???
...
;Main.c,440 :: 		static int Modal_Group_Actions1(int action){
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;Main.c,445 :: 		switch(action){
SW	R26, 4(SP)
SW	R27, 8(SP)
J	L_Main_Modal_Group_Actions187
NOP	
;Main.c,446 :: 		case 1: //b0000 0001
L_Main_Modal_Group_Actions189:
;Main.c,447 :: 		SingleAxisStep(gc.next_position[X],gc.frequency,X);
SH	R25, 12(SP)
MOVZ	R26, R0, R0
...
NOP	
;Main.c,449 :: 		case 2://b0000 0010
L_Main_Modal_Group_Actions190:
;Main.c,450 :: 		SingleAxisStep(gc.next_position[Y],gc.frequency,Y);
SH	R25, 12(SP)
ORI	R26, R0, 1
LW	R25, Offset(_gc+20)(GP)
...
J	L_Main_Modal_Group_Actions188
NOP	
;Main.c,452 :: 		case 3://b0000 0011
L_Main_Modal_Group_Actions191:
;Main.c,453 :: 		DualAxisStep(gc.next_position[X], gc.next_position[Y],X,Y,gc.frequency);
SH	R25, 12(SP)
...
J	L_Main_Modal_Group_Actions188
NOP	
;Main.c,455 :: 		case 4://b0000 0100
L_Main_Modal_Group_Actions192:
;Main.c,456 :: 		SingleAxisStep(gc.next_position[Z],gc.frequency,Z);
SH	R25, 12(SP)
ORI	R26, R0, 2
LW	R25, Offset(_gc+20)(GP)
...
J	L_Main_Modal_Group_Actions188
NOP	
;Main.c,458 :: 		case 5://b0000 0101
L_Main_Modal_Group_Actions193:
;Main.c,459 :: 		DualAxisStep(gc.next_position[X], gc.next_position[Z],X,Z,gc.frequency);
SH	R25, 12(SP)
LW	R27, Offset(_gc+20)(GP)
ORI	R26, R0, 2
MOVZ	R25, R0, R0
...
J	L_Main_Modal_Group_Actions188
NOP	
;Main.c,461 :: 		case 6://b0000 0110
L_Main_Modal_Group_Actions194:
;Main.c,462 :: 		DualAxisStep(gc.next_position[Y], gc.next_position[Z],Y,Z,gc.frequency);
SH	R25, 12(SP)
LW	R27, Offset(_gc+20)(GP)
ORI	R26, R0, 2
ORI	R25, R0, 1
...
J	L_Main_Modal_Group_Actions188
NOP	
;Main.c,464 :: 		case 8://b0000 1000
L_Main_Modal_Group_Actions195:
;Main.c,465 :: 		SingleAxisStep(gc.next_position[A],gc.frequency,A);
SH	R25, 12(SP)
ORI	R26, R0, 3
LW	R25, Offset(_gc+20)(GP)
...
J	L_Main_Modal_Group_Actions188
NOP	
;Main.c,467 :: 		case 9://b0000 1001
L_Main_Modal_Group_Actions196:
;Main.c,468 :: 		DualAxisStep(gc.next_position[X], gc.next_position[A],X,A,gc.frequency);
SH	R25, 12(SP)
LW	R27, Offset(_gc+20)(GP)
ORI	R26, R0, 3
MOVZ	R25, R0, R0
...
J	L_Main_Modal_Group_Actions188
NOP	
;Main.c,470 :: 		case 10://b0000 1010
L_Main_Modal_Group_Actions197:
;Main.c,471 :: 		DualAxisStep(gc.next_position[Y], gc.next_position[A],Y,A,gc.frequency);
SH	R25, 12(SP)
LW	R27, Offset(_gc+20)(GP)
ORI	R26, R0, 3
ORI	R25, R0, 1
...
J	L_Main_Modal_Group_Actions188
NOP	
;Main.c,473 :: 		case 12://b0000 1100
L_Main_Modal_Group_Actions198:
;Main.c,474 :: 		DualAxisStep(gc.next_position[Z], gc.next_position[A],Z,A,gc.frequency);
SH	R25, 12(SP)
LW	R27, Offset(_gc+20)(GP)
ORI	R26, R0, 3
ORI	R25, R0, 2
...
J	L_Main_Modal_Group_Actions188
NOP	
;Main.c,476 :: 		case 15://Circle interpolation
L_Main_Modal_Group_Actions199:
;Main.c,477 :: 		sys_sync_current_position();
SH	R25, 12(SP)
JAL	_sys_sync_current_position+0
NOP	
;Main.c,478 :: 		r_or_ijk(gc.position[X],gc.position[Y],gc.next_position[X],gc.next_position[Y],gc.R,gc.I,gc.J,gc.K,X,Y,gc.DIR);
