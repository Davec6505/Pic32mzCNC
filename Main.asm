...
>>>>>>> patch2
L_Temp_Move22:
;Main.c,102 :: 		STPS[X].mmToTravel = belt_steps(-50.00);//calcSteps(-125.25,8.06);
LUI	R2, 49736
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
...
>>>>>>> patch1
L_Temp_Move23:
;Main.c,107 :: 		STPS[Y].mmToTravel = belt_steps(50.00);
LUI	R2, 16968
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
...
;Main.c,108 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 5000,Y);
ORI	R27, R0, 1
ORI	R26, R0, 5000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
NOP	
;Main.c,109 :: 		SingleAxisStep(STPS[Y].mmToTravel,Y);
ORI	R26, R0, 1
...
;Main.c,111 :: 		case 2:
L_Temp_Move24:
;Main.c,112 :: 		STPS[X].mmToTravel = belt_steps(50.00);
LUI	R2, 16968
>>>>>>> patch1
ORI	R2, R2, 0
MTC1	R2, S12
...
=======
SW	R2, Offset(_STPS+64)(GP)
;Main.c,113 :: 		speed_cntr_Move(STPS[X].mmToTravel, 5000,X);
MOVZ	R27, R0, R0
<<<<<<< HEAD
>>>>>>> patch1
ORI	R26, R0, 25000
...
JAL	_speed_cntr_Move+0
NOP	
;Main.c,114 :: 		SingleAxisStep(STPS[X].mmToTravel,X);
MOVZ	R26, R0, R0
LW	R25, Offset(_STPS+64)(GP)
JAL	_SingleAxisStep+0
NOP	
...
NOP	
SW	R2, Offset(_STPS+132)(GP)
;Main.c,125 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 5000,Y);
ORI	R27, R0, 1
ORI	R26, R0, 5000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
...
NOP	
SW	R2, Offset(_STPS+64)(GP)
;Main.c,144 :: 		speed_cntr_Move(STPS[X].mmToTravel, 5000,X);
MOVZ	R27, R0, R0
>>>>>>> patch2
ORI	R26, R0, 5000
MOVZ	R25, R2, R0
...
;Main.c,149 :: 		case 8:
L_Temp_Move30:
;Main.c,150 :: 		STPS[A].mmToTravel = belt_steps(150.00);
LUI	R2, 17174
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
NOP	
SW	R2, Offset(_STPS+268)(GP)
;Main.c,151 :: 		speed_cntr_Move(STPS[A].mmToTravel, 15000,A);
ORI	R27, R0, 3
ORI	R26, R0, 15000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
...
JAL	_I2C_LCD_Out+0
NOP	
;Main.c,184 :: 		sprintf(txt,"%d",STPS[0].max_step_lim);
LW	R2, Offset(_STPS+52)(GP)
ADDIU	SP, SP, -12
SW	R2, 8(SP)
...
NOP	
ADDIU	SP, SP, 12
;Main.c,185 :: 		I2C_LCD_Out(LCD_01_ADDRESS,3,1,txt);
LUI	R28, hi_addr(_txt+0)
ORI	R28, R28, lo_addr(_txt+0)
ORI	R27, R0, 1
ORI	R26, R0, 3
...
JAL	_I2C_LCD_Out+0
NOP	
;Main.c,187 :: 		sprintf(txt,"%d",STPS[0].decel_val);
LW	R2, Offset(_STPS+16)(GP)
ADDIU	SP, SP, -12
SW	R2, 8(SP)
