...
NOP	
L__main188:
;Main.c,170 :: 		if(STPS[X].run_state != STOP | STPS[Y].run_state != STOP | STPS[Z].run_state != STOP){
LH	R2, Offset(-1610600188)(GP)
XORI	R3, R2, 0
SLTU	R3, R0, R3
LH	R2, Offset(-1610600108)(GP)
XORI	R2, R2, 0
SLTU	R2, R0, R2
OR	R3, R3, R2
LH	R2, Offset(-1610600028)(GP)
XORI	R2, R2, 0
SLTU	R2, R0, R2
OR	R2, R3, R2
...
LW	R2, Offset(-1610600104)(GP)
SW	R2, 24(SP)
;Main.c,178 :: 		,STPS[Y].accel_count
LW	R2, Offset(-1610600088)(GP)
SW	R2, 20(SP)
;Main.c,177 :: 		,STPS[Y].step_count
LW	R2, Offset(-1610600080)(GP)
SW	R2, 16(SP)
...
BEQ	R2, R0, L__main196
NOP	
J	L__main152
NOP	
L__main196:
LH	R2, Offset(_SV+2)(GP)
BEQ	R2, R0, L__main197
NOP	
J	L__main151
NOP	
L__main197:
...
LH	R2, Offset(_SV+2)(GP)
SLTI	R2, R2, 1
BEQ	R2, R0, L__main200
NOP	
J	L__main154
NOP	
L__main200:
LH	R2, Offset(Main_old_state+0)(GP)
BNE	R2, R0, L__main202
NOP	
J	L__main153
NOP	
L__main202:
...
ADDIU	R24, R24, -1
BNE	R24, R0, L_Main_Modal_Group_Actions041
NOP	
;Main.c,272 :: 		i++;
ADDIU	R2, R5, 1
SEH	R5, R2
...
ADDIU	R24, R24, -1
BNE	R24, R0, L_Main_Modal_Group_Actions047
NOP	
;Main.c,279 :: 		i++;
ADDIU	R2, R5, 1
SEH	R5, R2
...
SEH	R3, R25
ORI	R2, R0, 32
BEQ	R3, R2, L_Main_Modal_Group_Actions0230
NOP	
...
SEH	R3, R25
ORI	R2, R0, 6
BEQ	R3, R2, L_Main_Modal_Group_Actions0234
NOP	
...
LBU	R2, Offset(-1610602235)(GP)
BEQ	R2, R0, L_Main_Modal_Group_Actions0239
NOP	
...
SEH	R3, R25
ORI	R2, R0, 64
BEQ	R3, R2, L_Main_Modal_Group_Actions0240
NOP	
J	L_Main_Modal_Group_Actions0139
NOP	
...
BEQ	R2, R0, L_Main_Modal_Group_Actions0241
NOP	
...
SEH	R2, R6
SLTI	R2, R2, 3
BNE	R2, R0, L_Main_Modal_Group_Actions0242
NOP	
...
AND	R2, R5, R2
SEH	R2, R2
BNE	R2, R0, L_Main_Modal_Group_Actions0244
NOP	
...
L_Main_Modal_Group_Actions0101:
...
L_Main_Modal_Group_Actions0102:
ORI	R25, R0, 65535
;Main.c,475 :: 		break;
J	L_Main_Modal_Group_Actions036
NOP	
...
SEH	R3, R25
ORI	R2, R0, 53
BNE	R3, R2, L_Main_Modal_Group_Actions0256
NOP	
J	L_Main_Modal_Group_Actions083
NOP	
L_Main_Modal_Group_Actions0256:
SEH	R3, R25
ORI	R2, R0, 64
BNE	R3, R2, L_Main_Modal_Group_Actions0258
NOP	
J	L_Main_Modal_Group_Actions092
NOP	
L_Main_Modal_Group_Actions0258:
SEH	R3, R25
ORI	R2, R0, 128
BNE	R3, R2, L_Main_Modal_Group_Actions0260
NOP	
J	L_Main_Modal_Group_Actions094
NOP	
L_Main_Modal_Group_Actions0260:
SEH	R3, R25
ORI	R2, R0, 256
BNE	R3, R2, L_Main_Modal_Group_Actions0262
NOP	
J	L_Main_Modal_Group_Actions0101
NOP	
L_Main_Modal_Group_Actions0262:
J	L_Main_Modal_Group_Actions0102
NOP	
...
SEH	R2, R5
SLTI	R2, R2, 4
BNE	R2, R0, L_Main_Modal_Group_Actions1267
NOP	
...
LH	R2, 0(R2)
SEH	R2, R2
BNE	R2, R0, L_Main_Modal_Group_Actions1269
NOP	
...
BNE	R2, R0, L_Main_Modal_Group_Actions1271
NOP	
...
L_Main_Modal_Group_Actions1126:
MOVZ	R25, R0, R0
MOVZ	R2, R0, R0
...
SEH	R3, R25
ORI	R2, R0, 10
BNE	R3, R2, L_Main_Modal_Group_Actions1289
NOP	
J	L_Main_Modal_Group_Actions1113
NOP	
L_Main_Modal_Group_Actions1289:
SEH	R3, R25
ORI	R2, R0, 12
BNE	R3, R2, L_Main_Modal_Group_Actions1291
NOP	
J	L_Main_Modal_Group_Actions1114
NOP	
L_Main_Modal_Group_Actions1291:
SEH	R3, R25
ORI	R2, R0, 15
BNE	R3, R2, L_Main_Modal_Group_Actions1293
NOP	
J	L_Main_Modal_Group_Actions1115
NOP	
L_Main_Modal_Group_Actions1293:
SEH	R3, R25
ORI	R2, R0, 31
BNE	R3, R2, L_Main_Modal_Group_Actions1295
NOP	
J	L_Main_Modal_Group_Actions1116
NOP	
L_Main_Modal_Group_Actions1295:
J	L_Main_Modal_Group_Actions1126
NOP	
...
SLTIU	R2, R2, 2
BEQ	R2, R0, L_Main_Modal_Group_Actions3297
NOP	
J	L_Main_Modal_Group_Actions3127
NOP	
L_Main_Modal_Group_Actions3297:
...
NOP	
LH	R25, 4(SP)
L_Main_Modal_Group_Actions3127:
...
SLTIU	R2, R2, 0
BEQ	R2, R0, L_Main_Modal_Group_Actions4299
NOP	
J	L_Main_Modal_Group_Actions4142
NOP	
L_Main_Modal_Group_Actions4299:
LBU	R2, Offset(-1610602231)(GP)
SLTIU	R2, R2, 3
BNE	R2, R0, L_Main_Modal_Group_Actions4300
NOP	
...
NOP	
L_Main_Modal_Group_Actions4142:
...
SLTI	R2, R2, -1
BEQ	R2, R0, L_Main_Modal_Group_Actions7302
NOP	
J	L_Main_Modal_Group_Actions7145
NOP	
L_Main_Modal_Group_Actions7302:
LBU	R2, Offset(-1610602234)(GP)
SLTIU	R2, R2, 2
BNE	R2, R0, L_Main_Modal_Group_Actions7303
NOP	
J	L_Main_Modal_Group_Actions7144
NOP	
L_Main_Modal_Group_Actions7303:
J	L_Main_Modal_Group_Actions7133
NOP	
L_Main_Modal_Group_Actions7145:
