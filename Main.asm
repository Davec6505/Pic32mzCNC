...
NOP	
L_main30:
;Main.c,219 :: 		,old_state &0xF,SV.mode_complete,STPS[X].step_count
LBU	R2, Offset(Main_old_state+0)(GP)
ANDI	R4, R2, 15
...
L__main149:
L__main148:
;Main.c,224 :: 		if(!Get_Axis_IEnable_States()){SV.mode_complete = 0;}
JAL	_Get_Axis_IEnable_States+0
NOP	
BEQ	R2, R0, L__main195
NOP	
J	L_main31
NOP	
L__main195:
...
L_main31:
;Main.c,225 :: 		old_state = SV.mode_complete;
LH	R2, Offset(_SV+2)(GP)
SB	R2, Offset(Main_old_state+0)(GP)
