...
JAL	_PinMode+0
NOP	
;Main.c,56 :: 		plan_init(settings.acceleration,settings.acceleration);
...
;Main.c,159 :: 		}
L_main4:
;Main.c,163 :: 		if(!SV.mode_complete){
...
NOP	
L__main180:
;Main.c,164 :: 		if(STPS[X].run_state != STOP | STPS[Y].run_state != STOP){
