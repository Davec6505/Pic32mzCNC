...
NOP	
;Main.c,210 :: 		old_state = SV.mode_complete;
LH	R2, Offset(_SV+2)(GP)
SH	R2, Offset(Main_old_state+0)(GP)
;Main.c,212 :: 		if((old_state > 0) && (SV.mode_complete == 0)){// && (!SV.homed)){
...
L__main191:
L__main143:
;Main.c,213 :: 		old_state = 1;
ORI	R2, R0, 1
SH	R2, Offset(Main_old_state+0)(GP)
;Main.c,214 :: 		LED2 = false;
_LX	
INS	R2, R0, BitPos(LED2+0), 1
_SX	
;Main.c,217 :: 		report_status_message(status_of_gcode);
LH	R25, 0(SP)
JAL	_report_status_message+0
NOP	
;Main.c,220 :: 		while(DMA_IsOn(1));
L_main29:
ORI	R25, R0, 1
JAL	_DMA_IsOn+0
NOP	
...
NOP	
L_main30:
;Main.c,221 :: 		dma_printf("old_state:= %d\tSV.mode_complete:= %d\tstepX:= %l\tstepY:= %l\tstepZ= %l\n"
ADDIU	R23, SP, 35
ADDIU	R22, R23, 70
...
NOP	
ADDIU	R3, SP, 35
;Main.c,223 :: 		,STPS[Y].step_count,STPS[Z].step_count);
LW	R2, Offset(-1610600000)(GP)
ADDIU	SP, SP, -24
SW	R2, 20(SP)
LW	R2, Offset(-1610600080)(GP)
SW	R2, 16(SP)
;Main.c,222 :: 		,old_state ,SV.mode_complete,STPS[X].step_count
LW	R2, Offset(-1610600160)(GP)
SW	R2, 12(SP)
LH	R2, Offset(_SV+2)(GP)
SH	R2, 8(SP)
